; ModuleID = 'tenspiler/dexter/cpp/for_synthesis/linear_burn_8.ll'
source_filename = "tenspiler/dexter/cpp/for_synthesis/linear_burn_8.cc"
...
define void @_Z13linear_burn_8NSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %base, %"class.std::__1::vector"* %active) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
