...
if __name__ == "__main__":
    ...
    darken_blend_8 = driver.analyze(
        llvm_filepath="benchmarks/blend/cpp/darken_blend_8.ll",
        loops_filepath="benchmarks/blend/cpp/darken_blend_8.loops",
    ...
    input_code = Path(f"benchmarks/blend/cpp/darken_blend_8.cc").read_text()
