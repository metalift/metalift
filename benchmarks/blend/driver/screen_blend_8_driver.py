...
if __name__ == "__main__":
    ...
    screen_blend_8 = driver.analyze(
        llvm_filepath="benchmarks/blend/cpp/screen_blend_8.ll",
        loops_filepath="benchmarks/blend/cpp/screen_blend_8.loops",
    ...
    input_code = Path(f"benchmarks/blend/cpp/screen_blend_8.cc").read_text()
