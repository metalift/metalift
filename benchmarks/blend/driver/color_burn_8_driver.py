...
if __name__ == "__main__":
    ...
    color_burn_8 = driver.analyze(
        llvm_filepath="benchmarks/blend/cpp/color_burn_8.ll",
        loops_filepath="benchmarks/blend/cpp/color_burn_8.loops",
    ...
    input_code = Path(f"benchmarks/blend/cpp/color_burn_8.cc").read_text()
