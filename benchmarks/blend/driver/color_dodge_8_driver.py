...
if __name__ == "__main__":
    ...
    color_dodge_8 = driver.analyze(
        llvm_filepath="benchmarks/blend/cpp/color_dodge_8.ll",
        loops_filepath="benchmarks/blend/cpp/color_dodge_8.loops",
    ...
    input_code = Path(f"benchmarks/blend/cpp/color_dodge_8.cc").read_text()
