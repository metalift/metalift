...
if __name__ == "__main__":
    ...
    linear_dodge_8 = driver.analyze(
        llvm_filepath="benchmarks/blend/cpp/linear_dodge_8.ll",
        loops_filepath="benchmarks/blend/cpp/linear_dodge_8.loops",
    ...
    input_code = Path(f"benchmarks/blend/cpp/linear_dodge_8.cc").read_text()
