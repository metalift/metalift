...
void main(tensor base, tensor active, tensor darken_blend_8_ps_rv) {
    ...
    for(int i = index_space_start[0]; i < index_space_end[0]; i++) {
        ...
        for (int j = index_space_start[1]; j < index_space_end[1]; j++) {
            ...
            uchar256 v4 = v_u8_sel_grt_u8_b(v0, v1, v1, v0);

            v_u8_st_tnsr(outputCoord, darken_blend_8_ps_rv, v4);
        }
    }
