; ModuleID = 'tests/tutorial/conv_1d/conv_1d_smt.ll'
source_filename = "tests/tutorial/conv_1d/conv_1d_smt.cc"
...
define void @_Z11conv_1d_smtNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %input, %"class.std::__1::vector"* %filter) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  ...
  %call = call i64 @_ZNKSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEE4sizeEv(%"class.std::__1::vector"* %input) #11
  %conv = trunc i64 %call to i32
  store i32 %conv, i32* %C, align 4
  %call1 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %input, i64 0) #11
  %call2 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector.0"* %call1) #11
  %conv3 = trunc i64 %call2 to i32
  store i32 %conv3, i32* %W, align 4
  store i32 0, i32* %c, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc35, %entry
  %i1 = load i32, i32* %c, align 4
  %i2 = load i32, i32* %C, align 4
...
for.cond4:                                        ; preds = %for.inc, %for.body
  %i3 = load i32, i32* %w, align 4
  %i4 = load i32, i32* %W, align 4
  %sub = sub nsw i32 %i4, 2
  %cmp5 = icmp slt i32 %i3, %sub
  br i1 %cmp5, label %for.body6, label %for.end

for.body6:                                        ; preds = %for.cond4
  %i5 = load i32, i32* %c, align 4
  %conv7 = sext i32 %i5 to i64
  %call8 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %input, i64 %conv7) #11
  %i6 = load i32, i32* %w, align 4
  %add = add nsw i32 %i6, 0
  ...
  %call12 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %filter, i64 %conv11) #11
  %call13 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call12, i64 0) #11
  %i9 = load i32, i32* %call13, align 4
  %mul = mul nsw i32 %i7, %i9
  %i10 = load i32, i32* %c, align 4
  %conv14 = sext i32 %i10 to i64
  %call15 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %input, i64 %conv14) #11
  %i11 = load i32, i32* %w, align 4
  %add16 = add nsw i32 %i11, 1
  %conv17 = sext i32 %add16 to i64
  %call18 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call15, i64 %conv17) #11
  %i12 = load i32, i32* %call18, align 4
  %i13 = load i32, i32* %c, align 4
  %conv19 = sext i32 %i13 to i64
  %call20 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %filter, i64 %conv19) #11
  %call21 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call20, i64 1) #11
  %i14 = load i32, i32* %call21, align 4
  %mul22 = mul nsw i32 %i12, %i14
  %add23 = add nsw i32 %mul, %mul22
  %i15 = load i32, i32* %c, align 4
  %conv24 = sext i32 %i15 to i64
  %call25 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %input, i64 %conv24) #11
  %i16 = load i32, i32* %w, align 4
  %add26 = add nsw i32 %i16, 2
  %conv27 = sext i32 %add26 to i64
  %call28 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call25, i64 %conv27) #11
  %i17 = load i32, i32* %call28, align 4
  %i18 = load i32, i32* %c, align 4
  %conv29 = sext i32 %i18 to i64
  %call30 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %filter, i64 %conv29) #11
  %call31 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call30, i64 2) #11
  %i19 = load i32, i32* %call31, align 4
  %mul32 = mul nsw i32 %i17, %i19
  %add33 = add nsw i32 %add23, %mul32
  store i32 %add33, i32* %ref.tmp, align 4
...
for.inc35:                                        ; preds = %invoke.cont34
  %i21 = load i32, i32* %c, align 4
  %inc36 = add nsw i32 %i21, 1
...
; Function Attrs: noinline optnone ssp uwtable
define linkonce_odr hidden void @_ZNSt3__16vectorIiNS_9allocatorIiEEE9push_backEOi(%"class.std::__1::vector.0"* %this, i32* nonnull align 4 dereferenceable(4) %__x) #0 align 2 {
entry:
  %this.addr = alloca %"class.std::__1::vector.0"*, align 8
...
; Function Attrs: noinline optnone ssp uwtable
define linkonce_odr void @_ZNSt3__16vectorIiNS_9allocatorIiEEE22__construct_one_at_endIJiEEEvDpOT_(%"class.std::__1::vector.0"* %this, i32* nonnull align 4 dereferenceable(4) %__args) #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::__1::vector.0"*, align 8
...
; Function Attrs: noinline optnone ssp uwtable
define linkonce_odr void @_ZNSt3__16vectorIiNS_9allocatorIiEEE21__push_back_slow_pathIiEEvOT_(%"class.std::__1::vector.0"* %this, i32* nonnull align 4 dereferenceable(4) %__x) #0 align 2 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
  %this.addr = alloca %"class.std::__1::vector.0"*, align 8
  %__x.addr = alloca i32*, align 8
