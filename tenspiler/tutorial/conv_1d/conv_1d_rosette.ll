; ModuleID = 'tests/tutorial/conv_1d/conv_1d_rosette.ll'
source_filename = "tests/tutorial/conv_1d/conv_1d_rosette.cc"
...
define void @_Z15conv_1d_rosetteNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %input, %"class.std::__1::vector"* %filter) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body6:                                        ; preds = %for.cond4
  ...
  %i5 = load i32, i32* %w, align 4
  %add = add nsw i32 %i5, 2
  %i6 = load i32, i32* %W, align 4
  %cmp7 = icmp slt i32 %add, %i6
  br i1 %cmp7, label %if.then, label %if.end

if.then:                                          ; preds = %for.body6
  %i7 = load i32, i32* %c, align 4
  %conv8 = sext i32 %i7 to i64
  %call9 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %input, i64 %conv8) #11
  %i8 = load i32, i32* %w, align 4
  %add10 = add nsw i32 %i8, 0
  %conv11 = sext i32 %add10 to i64
  %call12 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call9, i64 %conv11) #11
  %i9 = load i32, i32* %call12, align 4
  %i10 = load i32, i32* %c, align 4
  %conv13 = sext i32 %i10 to i64
  %call14 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %filter, i64 %conv13) #11
  %call15 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call14, i64 0) #11
  %i11 = load i32, i32* %call15, align 4
  %mul = mul nsw i32 %i9, %i11
  %i12 = load i32, i32* %c, align 4
  %conv16 = sext i32 %i12 to i64
  %call17 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %input, i64 %conv16) #11
  %i13 = load i32, i32* %w, align 4
  %add18 = add nsw i32 %i13, 1
  %conv19 = sext i32 %add18 to i64
  %call20 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call17, i64 %conv19) #11
  %i14 = load i32, i32* %call20, align 4
  %i15 = load i32, i32* %c, align 4
  %conv21 = sext i32 %i15 to i64
  %call22 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %filter, i64 %conv21) #11
  %call23 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call22, i64 1) #11
  %i16 = load i32, i32* %call23, align 4
  %mul24 = mul nsw i32 %i14, %i16
  %add25 = add nsw i32 %mul, %mul24
  %i17 = load i32, i32* %c, align 4
  %conv26 = sext i32 %i17 to i64
  %call27 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %input, i64 %conv26) #11
  %i18 = load i32, i32* %w, align 4
  %add28 = add nsw i32 %i18, 2
  %conv29 = sext i32 %add28 to i64
  %call30 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call27, i64 %conv29) #11
  %i19 = load i32, i32* %call30, align 4
  %i20 = load i32, i32* %c, align 4
  %conv31 = sext i32 %i20 to i64
  %call32 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector"* %filter, i64 %conv31) #11
  %call33 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.0"* %call32, i64 2) #11
  %i21 = load i32, i32* %call33, align 4
  %mul34 = mul nsw i32 %i19, %i21
  %add35 = add nsw i32 %add25, %mul34
  store i32 %add35, i32* %val, align 4
  br label %if.end
...
for.inc:                                          ; preds = %invoke.cont
  %i22 = load i32, i32* %w, align 4
  %inc = add nsw i32 %i22, 1
...
for.inc37:                                        ; preds = %invoke.cont36
  %i23 = load i32, i32* %c, align 4
  %inc38 = add nsw i32 %i23, 1
