; ModuleID = 'tests/tutorial/conv_1d/conv_1d.ll'
source_filename = "tests/tutorial/conv_1d/conv_1d.cc"
...
define void @_Z7conv_1dNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %input, %"class.std::__1::vector"* %filter) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
