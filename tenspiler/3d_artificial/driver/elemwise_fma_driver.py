...
def inv0_grammar_fn(
    ...
    return and_objects(
        ...
        result
        == call_elemwise_add(
            call_elemwise_mul(tensor3d[:i], tensor3d[:i]),
            tensor3d[:i],
        ),
    )
...
def inv1_grammar_fn(
    ...
    return and_objects(
        ...
        matrix
        == call_elemwise_add(
            call_elemwise_mul(tensor3d[i][:j], tensor3d[i][:j]),
            tensor3d[i][:j],
        ),
        result
        == call_elemwise_add(
...
def ps_grammar_fn(
    ...
    tensor3d_x, tensor3d_y = reads
    tensor3d = choose(tensor3d_x, tensor3d_y)
    return result == call_elemwise_add(call_elemwise_mul(tensor3d, tensor3d), tensor3d)
...
if __name__ == "__main__":
    ...
    elemwise_fma = driver.analyze(
        llvm_filepath="tenspiler/3d_artificial/cpp/elemwise_fma.ll",
        loops_filepath="tenspiler/3d_artificial/cpp/elemwise_fma.loops",
        fn_name="elemwise_fma",
        target_lang_fn=target_lang,
        inv_grammars={
            "elemwise_fma_inv0": inv0_grammar,
            "elemwise_fma_inv1": inv1_grammar,
            "elemwise_fma_inv2": inv2_grammar,
        },
    ...
    elemwise_fma(tensor3d_x, tensor3d_y)
    driver.synthesize(
