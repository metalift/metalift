; ModuleID = 'tenspiler/3d_artificial/cpp/elemwise_depth4.ll'
source_filename = "tenspiler/3d_artificial/cpp/elemwise_depth4.cc"
...
define void @_Z15elemwise_depth4NSt3__16vectorINS0_INS0_IiNS_9allocatorIiEEEENS1_IS3_EEEENS1_IS5_EEEES7_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %tensor3d_x, %"class.std::__1::vector"* %tensor3d_y) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.cond8:                                        ; preds = %for.inc40, %for.body
...
for.body13:                                       ; preds = %for.cond11
  ...
  %add = add nsw i32 %i15, %i19
  %i20 = load i32, i32* %i, align 4
  %conv32 = sext i32 %i20 to i64
  %call33 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_INS0_IiNS_9allocatorIiEEEENS1_IS3_EEEENS1_IS5_EEEixEm(%"class.std::__1::vector"* %tensor3d_y, i64 %conv32) #11
  ...
  %mul = mul nsw i32 %add, %i23
  %add38 = add nsw i32 %i11, %mul
  store i32 %add38, i32* %ref.tmp, align 4
...
for.inc:                                          ; preds = %invoke.cont
  %i24 = load i32, i32* %k, align 4
  %inc = add nsw i32 %i24, 1
...
nrvo.skipdtor:                                    ; preds = %nrvo.unused, %for.end47
  ret void
}
