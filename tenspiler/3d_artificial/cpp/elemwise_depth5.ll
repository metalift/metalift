; ModuleID = 'tenspiler/3d_artificial/cpp/elemwise_depth5.ll'
source_filename = "tenspiler/3d_artificial/cpp/elemwise_depth5.cc"
...
define void @_Z15elemwise_depth5NSt3__16vectorINS0_INS0_IiNS_9allocatorIiEEEENS1_IS3_EEEENS1_IS5_EEEES7_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %tensor3d_x, %"class.std::__1::vector"* %tensor3d_y) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.cond8:                                        ; preds = %for.inc47, %for.body
  ...
  br i1 %cmp9, label %for.body10, label %for.end49
...
for.body13:                                       ; preds = %for.cond11
  ...
  %call21 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_INS0_IiNS_9allocatorIiEEEENS1_IS3_EEEENS1_IS5_EEEixEm(%"class.std::__1::vector"* %tensor3d_x, i64 %conv20) #11
  ...
  %call27 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_INS0_IiNS_9allocatorIiEEEENS1_IS3_EEEENS1_IS5_EEEixEm(%"class.std::__1::vector"* %tensor3d_y, i64 %conv26) #11
  ...
  %conv32 = sext i32 %i20 to i64
  %call33 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_INS0_IiNS_9allocatorIiEEEENS1_IS3_EEEENS1_IS5_EEEixEm(%"class.std::__1::vector"* %tensor3d_x, i64 %conv32) #11
  %i21 = load i32, i32* %j, align 4
  %conv34 = sext i32 %i21 to i64
  %call35 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.2"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector.0"* %call33, i64 %conv34) #11
  %i22 = load i32, i32* %k, align 4
  %conv36 = sext i32 %i22 to i64
  %call37 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.2"* %call35, i64 %conv36) #11
  %i23 = load i32, i32* %call37, align 4
  %mul = mul nsw i32 %i19, %i23
  %add = add nsw i32 %i15, %mul
  %i24 = load i32, i32* %i, align 4
  %conv38 = sext i32 %i24 to i64
  %call39 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.0"* @_ZNSt3__16vectorINS0_INS0_IiNS_9allocatorIiEEEENS1_IS3_EEEENS1_IS5_EEEixEm(%"class.std::__1::vector"* %tensor3d_y, i64 %conv38) #11
  %i25 = load i32, i32* %j, align 4
  %conv40 = sext i32 %i25 to i64
  %call41 = call nonnull align 8 dereferenceable(24) %"class.std::__1::vector.2"* @_ZNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEixEm(%"class.std::__1::vector.0"* %call39, i64 %conv40) #11
  %i26 = load i32, i32* %k, align 4
  %conv42 = sext i32 %i26 to i64
  %call43 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector.2"* %call41, i64 %conv42) #11
  %i27 = load i32, i32* %call43, align 4
  %mul44 = mul nsw i32 %add, %i27
  %add45 = add nsw i32 %i11, %mul44
...
for.inc:                                          ; preds = %invoke.cont
  %i28 = load i32, i32* %k, align 4
  %inc = add nsw i32 %i28, 1
...
for.inc47:                                        ; preds = %invoke.cont46
  %i29 = load i32, i32* %j, align 4
  %inc48 = add nsw i32 %i29, 1
  store i32 %inc48, i32* %j, align 4
  br label %for.cond8

for.end49:                                        ; preds = %for.cond8
