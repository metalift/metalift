...
(ite (= int_x 32) 32 (div int_y (- 32 int_x))))
...
(define-fun-rec color_dodge_8_inv0 ((active (MLList (MLList Int))) (agg.result (MLList (MLList Int))) (base (MLList (MLList Int))) (col Int) (pixel Int) (row Int) (row_vec (MLList Int))) Bool
(and (and (>= row 0) (<= row (matrix_length base))) (= agg.result (matrix_selection_two_args (ite OUTER_LOOP_INDEX_FIRST (matrix_take active row) (matrix_col_slice active 0 row)) (ite OUTER_LOOP_INDEX_FIRST (matrix_take base row) (matrix_col_slice base 0 row))))))



(define-fun-rec color_dodge_8_inv1 ((active (MLList (MLList Int))) (base (MLList (MLList Int))) (col Int) (pixel Int) (row_vec (MLList Int)) (agg.result (MLList (MLList Int))) (row Int)) Bool
(and (and (and (and (and (>= row 0) (<= row (matrix_length base))) (>= col 0)) (<= col (list_length (matrix_get base 0)))) (= row_vec (selection_two_args (ite OUTER_LOOP_INDEX_FIRST (list_take (matrix_get active row) col) (matrix_get (matrix_transpose (matrix_col_slice_with_length (matrix_take base col) row 1)) 0)) (ite OUTER_LOOP_INDEX_FIRST (list_take (matrix_get base row) col) (matrix_get (matrix_transpose (matrix_col_slice_with_length (matrix_take base col) row 1)) 0))))) (= agg.result (matrix_selection_two_args (ite OUTER_LOOP_INDEX_FIRST (matrix_take active row) (matrix_col_slice base 0 row)) (ite OUTER_LOOP_INDEX_FIRST (matrix_take base row) (matrix_col_slice base 0 row))))))



(define-fun-rec color_dodge_8_ps ((base (MLList (MLList Int))) (active (MLList (MLList Int))) (color_dodge_8_rv (MLList (MLList Int)))) Bool
(= color_dodge_8_rv (matrix_selection_two_args active base)))
...
(declare-const color_dodge_8_rv (MLList Int))



(assert (not (and (and (and (and (=> (and (and (> (matrix_length base) 1) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (color_dodge_8_inv0 active matrix_empty base 0 0 0 list_empty)) (=> (and (and (and (and (< row (matrix_length base)) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (color_dodge_8_inv0 active agg.result base col pixel row row_vec)) (color_dodge_8_inv1 active base 0 pixel list_empty agg.result row))) (=> (or (and (and (and (and (and (and (and (= (list_get (matrix_get active row) col) 32) (< col (list_length (matrix_get base 0)))) (< row (matrix_length base))) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (color_dodge_8_inv0 active agg.result base col pixel row row_vec)) (color_dodge_8_inv1 active base col pixel row_vec agg.result row)) (and (and (and (and (and (and (and (not (= (list_get (matrix_get active row) col) 32)) (< col (list_length (matrix_get base 0)))) (< row (matrix_length base))) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (color_dodge_8_inv0 active agg.result base col pixel row row_vec)) (color_dodge_8_inv1 active base col pixel row_vec agg.result row))) (color_dodge_8_inv1 active base (+ col 1) (ite (and (and (and (and (and (and (and (not (= (list_get (matrix_get active row) col) 32)) (< col (list_length (matrix_get base 0)))) (< row (matrix_length base))) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (color_dodge_8_inv0 active agg.result base col pixel row row_vec)) (color_dodge_8_inv1 active base col pixel row_vec agg.result row)) (div (list_get (matrix_get base row) col) (- 32 (list_get (matrix_get active row) col))) 32) (list_append row_vec (ite (and (and (and (and (and (and (and (not (= (list_get (matrix_get active row) col) 32)) (< col (list_length (matrix_get base 0)))) (< row (matrix_length base))) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (color_dodge_8_inv0 active agg.result base col pixel row row_vec)) (color_dodge_8_inv1 active base col pixel row_vec agg.result row)) (div (list_get (matrix_get base row) col) (- 32 (list_get (matrix_get active row) col))) 32)) agg.result row))) (=> (and (and (and (and (and (and (not (< col (list_length (matrix_get base 0)))) (< row (matrix_length base))) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (color_dodge_8_inv0 active agg.result base col pixel row row_vec)) (color_dodge_8_inv1 active base col pixel row_vec agg.result row)) (color_dodge_8_inv0 active (matrix_append agg.result row_vec) base col pixel (+ row 1) row_vec))) (=> (or (and (and (and (and (not (< row (matrix_length base))) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (color_dodge_8_inv0 active agg.result base col pixel row row_vec)) (and (and (and (and (and (not true) (not (< row (matrix_length base)))) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (color_dodge_8_inv0 active agg.result base col pixel row row_vec))) (color_dodge_8_ps base active agg.result)))))
