...
(and (and (>= row 0) (<= row (matrix_length base))) (= agg.result (matrix_scalar_div 32 (matrix_elemwise_mul (ite OUTER_LOOP_INDEX_FIRST (matrix_take base row) (matrix_col_slice base 0 row)) (ite OUTER_LOOP_INDEX_FIRST (matrix_take active row) (matrix_col_slice base 0 row)))))))
...
(and (and (and (and (and (>= row 0) (<= row (matrix_length base))) (>= col 0)) (<= col (list_length (matrix_get base 0)))) (= row_vec (vec_scalar_div 32 (vec_elemwise_mul (ite OUTER_LOOP_INDEX_FIRST (list_take (matrix_get base row) col) (matrix_get (matrix_transpose (matrix_col_slice_with_length (matrix_take base col) row 1)) 0)) (ite OUTER_LOOP_INDEX_FIRST (list_take (matrix_get active row) col) (matrix_get (matrix_transpose (matrix_col_slice_with_length (matrix_take base col) row 1)) 0)))))) (= agg.result (matrix_scalar_div 32 (matrix_elemwise_mul (ite OUTER_LOOP_INDEX_FIRST (matrix_take base row) (matrix_col_slice base 0 row)) (ite OUTER_LOOP_INDEX_FIRST (matrix_take active row) (matrix_col_slice base 0 row)))))))
...
(assert (not (and (and (and (and (=> (and (and (> (matrix_length base) 1) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (multiply_blend_8_inv0 active matrix_empty base 0 0 0 list_empty)) (=> (and (and (and (and (< row (matrix_length base)) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (multiply_blend_8_inv0 active agg.result base col pixel row row_vec)) (multiply_blend_8_inv1 active base 0 pixel list_empty agg.result row))) (=> (and (and (and (and (and (and (< col (list_length (matrix_get base 0))) (< row (matrix_length base))) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (multiply_blend_8_inv0 active agg.result base col pixel row row_vec)) (multiply_blend_8_inv1 active base col pixel row_vec agg.result row)) (multiply_blend_8_inv1 active base (+ col 1) (div (* (list_get (matrix_get base row) col) (list_get (matrix_get active row) col)) 32) (list_append row_vec (div (* (list_get (matrix_get base row) col) (list_get (matrix_get active row) col)) 32)) agg.result row))) (=> (and (and (and (and (and (and (not (< col (list_length (matrix_get base 0)))) (< row (matrix_length base))) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (multiply_blend_8_inv0 active agg.result base col pixel row row_vec)) (multiply_blend_8_inv1 active base col pixel row_vec agg.result row)) (multiply_blend_8_inv0 active (matrix_append agg.result row_vec) base col pixel (+ row 1) row_vec))) (=> (or (and (and (and (and (not (< row (matrix_length base))) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (multiply_blend_8_inv0 active agg.result base col pixel row row_vec)) (and (and (and (and (and (not true) (not (< row (matrix_length base)))) (> (matrix_length base) 1)) (= (matrix_length base) (matrix_length active))) (= (list_length (matrix_get base 0)) (list_length (matrix_get active 0)))) (multiply_blend_8_inv0 active agg.result base col pixel row row_vec))) (multiply_blend_8_ps base active agg.result)))))
