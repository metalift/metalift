...
(define-grammar (color_dodge_8_ps_gram base active color_dodge_8_rv)
 [rv (choose (equal? color_dodge_8_rv (matrix_selection_two_args (matrix-col-slice-noerr (matrix-row-slice-noerr (v0) (v2) (v2) ) (v2) (v2) ) (matrix-col-slice-noerr (matrix-row-slice-noerr (v0) (v2) (v2) ) (v2) (v2) ) select_two_args ) ))]
...
(define-symbolic color_dodge_8_rv_BOUNDEDSET-4 integer?)
(define color_dodge_8_rv (take (list color_dodge_8_rv_BOUNDEDSET-0 color_dodge_8_rv_BOUNDEDSET-1 color_dodge_8_rv_BOUNDEDSET-2 color_dodge_8_rv_BOUNDEDSET-3 color_dodge_8_rv_BOUNDEDSET-4) color_dodge_8_rv_BOUNDEDSET-len))
...
(current-bitwidth 6)
(define (assertions)
 (assert (&& (&& (&& (&& (=> (&& (&& (> (matrix-length base ) 1 ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active (matrix-empty ) base 0 0 0 (list-empty )) ) (=> (&& (&& (&& (&& (< row (matrix-length base ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active agg.result base col pixel row row_vec) ) (color_dodge_8_inv1 active base 0 pixel (list-empty ) agg.result row) ) ) (=> (or (&& (&& (&& (&& (&& (&& (&& (equal? (list-ref-noerr (matrix-ref-noerr active row ) col ) 32 ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active agg.result base col pixel row row_vec) ) (color_dodge_8_inv1 active base col pixel row_vec agg.result row) ) (&& (&& (&& (&& (&& (&& (&& (! (equal? (list-ref-noerr (matrix-ref-noerr active row ) col ) 32 ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active agg.result base col pixel row row_vec) ) (color_dodge_8_inv1 active base col pixel row_vec agg.result row) ) ) (color_dodge_8_inv1 active base (+ col 1 ) (if (&& (&& (&& (&& (&& (&& (&& (! (equal? (list-ref-noerr (matrix-ref-noerr active row ) col ) 32 ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active agg.result base col pixel row row_vec) ) (color_dodge_8_inv1 active base col pixel row_vec agg.result row) ) (quotient-noerr (list-ref-noerr (matrix-ref-noerr base row ) col ) (- 32 (list-ref-noerr (matrix-ref-noerr active row ) col ) ) ) 32 ) (list-append row_vec (if (&& (&& (&& (&& (&& (&& (&& (! (equal? (list-ref-noerr (matrix-ref-noerr active row ) col ) 32 ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active agg.result base col pixel row row_vec) ) (color_dodge_8_inv1 active base col pixel row_vec agg.result row) ) (quotient-noerr (list-ref-noerr (matrix-ref-noerr base row ) col ) (- 32 (list-ref-noerr (matrix-ref-noerr active row ) col ) ) ) 32 ) ) agg.result row) ) ) (=> (&& (&& (&& (&& (&& (&& (! (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active agg.result base col pixel row row_vec) ) (color_dodge_8_inv1 active base col pixel row_vec agg.result row) ) (color_dodge_8_inv0 active (matrix-append agg.result row_vec ) base col pixel (+ row 1 ) row_vec) ) ) (=> (or (&& (&& (&& (&& (! (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active agg.result base col pixel row row_vec) ) (&& (&& (&& (&& (&& (! true ) (! (< row (matrix-length base ) ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active agg.result base col pixel row row_vec) ) ) (color_dodge_8_ps base active agg.result) ) )))


    (define sol0
        (synthesize
            #:forall (list active_BOUNDEDSET-len active_BOUNDEDSET-0 active_BOUNDEDSET-1 active_BOUNDEDSET-2 active_BOUNDEDSET-3 active_BOUNDEDSET-4 active_BOUNDEDSET-5 active_BOUNDEDSET-6 active_BOUNDEDSET-7 active_BOUNDEDSET-8 active_BOUNDEDSET-9 active_BOUNDEDSET-10 active_BOUNDEDSET-11 active_BOUNDEDSET-12 active_BOUNDEDSET-13 active_BOUNDEDSET-14 active_BOUNDEDSET-15 active_BOUNDEDSET-16 active_BOUNDEDSET-17 active_BOUNDEDSET-18 active_BOUNDEDSET-19 active_BOUNDEDSET-20 active_BOUNDEDSET-21 active_BOUNDEDSET-22 active_BOUNDEDSET-23 active_BOUNDEDSET-24 agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 agg.result_BOUNDEDSET-4 agg.result_BOUNDEDSET-5 agg.result_BOUNDEDSET-6 agg.result_BOUNDEDSET-7 agg.result_BOUNDEDSET-8 agg.result_BOUNDEDSET-9 agg.result_BOUNDEDSET-10 agg.result_BOUNDEDSET-11 agg.result_BOUNDEDSET-12 agg.result_BOUNDEDSET-13 agg.result_BOUNDEDSET-14 agg.result_BOUNDEDSET-15 agg.result_BOUNDEDSET-16 agg.result_BOUNDEDSET-17 agg.result_BOUNDEDSET-18 agg.result_BOUNDEDSET-19 agg.result_BOUNDEDSET-20 agg.result_BOUNDEDSET-21 agg.result_BOUNDEDSET-22 agg.result_BOUNDEDSET-23 agg.result_BOUNDEDSET-24 base_BOUNDEDSET-len base_BOUNDEDSET-0 base_BOUNDEDSET-1 base_BOUNDEDSET-2 base_BOUNDEDSET-3 base_BOUNDEDSET-4 base_BOUNDEDSET-5 base_BOUNDEDSET-6 base_BOUNDEDSET-7 base_BOUNDEDSET-8 base_BOUNDEDSET-9 base_BOUNDEDSET-10 base_BOUNDEDSET-11 base_BOUNDEDSET-12 base_BOUNDEDSET-13 base_BOUNDEDSET-14 base_BOUNDEDSET-15 base_BOUNDEDSET-16 base_BOUNDEDSET-17 base_BOUNDEDSET-18 base_BOUNDEDSET-19 base_BOUNDEDSET-20 base_BOUNDEDSET-21 base_BOUNDEDSET-22 base_BOUNDEDSET-23 base_BOUNDEDSET-24 col color_dodge_8_rv_BOUNDEDSET-len color_dodge_8_rv_BOUNDEDSET-0 color_dodge_8_rv_BOUNDEDSET-1 color_dodge_8_rv_BOUNDEDSET-2 color_dodge_8_rv_BOUNDEDSET-3 color_dodge_8_rv_BOUNDEDSET-4 int_x int_y pixel row row_vec_BOUNDEDSET-len row_vec_BOUNDEDSET-0 row_vec_BOUNDEDSET-1 row_vec_BOUNDEDSET-2 row_vec_BOUNDEDSET-3 row_vec_BOUNDEDSET-4)
