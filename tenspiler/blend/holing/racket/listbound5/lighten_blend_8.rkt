...
(define-grammar (lighten_blend_8_ps_gram base active lighten_blend_8_rv)
 [rv (choose (equal? lighten_blend_8_rv (matrix_selection_two_args (matrix-col-slice-noerr (matrix-slice-noerr (v0) (v2) (v2) ) (v2) (v2) ) (matrix-col-slice-noerr (matrix-slice-noerr (v0) (v2) (v2) ) (v2) (v2) ) select_two_args ) ))]
...
(define-symbolic lighten_blend_8_rv_BOUNDEDSET-4 integer?)
(define lighten_blend_8_rv (take (list lighten_blend_8_rv_BOUNDEDSET-0 lighten_blend_8_rv_BOUNDEDSET-1 lighten_blend_8_rv_BOUNDEDSET-2 lighten_blend_8_rv_BOUNDEDSET-3 lighten_blend_8_rv_BOUNDEDSET-4) lighten_blend_8_rv_BOUNDEDSET-len))
