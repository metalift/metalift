; ModuleID = 'tenspiler/dexter/cpp/for_synthesis/normal_blend_f.ll'
source_filename = "tenspiler/dexter/cpp/for_synthesis/normal_blend_f.cc"
...
define void @_Z14normal_blend_fNSt3__16vectorIiNS_9allocatorIiEEEES3_i(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %base, %"class.std::__1::vector"* %active, i32 %opacity) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
