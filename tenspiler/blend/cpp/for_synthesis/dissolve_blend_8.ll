; ModuleID = 'tenspiler/dexter/cpp/for_synthesis/dissolve_blend_8.ll'
source_filename = "tenspiler/dexter/cpp/for_synthesis/dissolve_blend_8.cc"
...
define void @_Z16dissolve_blend_8NSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_ii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %base, %"class.std::__1::vector"* %active, i32 %opacity, i32 %rand_cons) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
