...
def ol_l2_cpu1_target_lang() -> List[Union[FnDecl, FnDeclRecursive]]:
    return [
        *vec_vec_to_vec_target_lang,
        *scalar_vec_to_vec_target_lang,
        *vec_to_vec_target_lang,
...
if __name__ == "__main__":
    ...
    ol_l2_cpu1 = driver.analyze(
        ...
        "ol_l2_cpu1",
        ol_l2_cpu1_target_lang,
        defaultdict(lambda: InvGrammar(ol_l2_cpu1_inv0_grammar, [])),
        ol_l2_cpu1_ps_grammar,
    )
    ...
    driver.synthesize(filename=f"ol_l2_cpu1{depth_suffix}{relaxed_suffix}")
    end_time = time.time()
