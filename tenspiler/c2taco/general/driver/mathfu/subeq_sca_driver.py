...
def subeq_sca_target_lang() -> List[Union[FnDecl, FnDeclRecursive]]:
    return [
        *vec_vec_to_vec_target_lang,
        *scalar_vec_to_vec_target_lang,
        *vec_to_vec_target_lang,
...
if __name__ == "__main__":
    ...
    subeq_sca = driver.analyze(
        ...
        "subeq_sca",
        subeq_sca_target_lang,
        defaultdict(lambda: InvGrammar(subeq_sca_inv0_grammar, [])),
        subeq_sca_ps_grammar,
    )
    ...
    driver.synthesize(filename=f"subeq_sca{depth_suffix}{relaxed_suffix}")
    end_time = time.time()
