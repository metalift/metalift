...
def diveq_sca_target_lang() -> List[Union[FnDecl, FnDeclRecursive]]:
    return [
        *vec_vec_to_vec_target_lang,
        *scalar_vec_to_vec_target_lang,
        *vec_to_vec_target_lang,
...
if __name__ == "__main__":
    ...
    diveq_sca = driver.analyze(
        ...
        "diveq_sca",
        diveq_sca_target_lang,
        defaultdict(lambda: InvGrammar(diveq_sca_inv0_grammar, [])),
        diveq_sca_ps_grammar,
    )
    ...
    driver.synthesize(filename=f"diveq_sca{depth_suffix}{relaxed_suffix}")
    end_time = time.time()
