...
def diveq_target_lang() -> List[Union[FnDecl, FnDeclRecursive]]:
    return [
        *vec_vec_to_vec_target_lang,
        *scalar_vec_to_vec_target_lang,
        *vec_to_vec_target_lang,
...
if __name__ == "__main__":
    ...
    diveq = driver.analyze(
        ...
        "diveq",
        diveq_target_lang,
        defaultdict(lambda: InvGrammar(diveq_inv0_grammar, [])),
        diveq_ps_grammar,
    )
    ...
    driver.synthesize(filename=f"diveq{depth_suffix}{relaxed_suffix}")
    end_time = time.time()
