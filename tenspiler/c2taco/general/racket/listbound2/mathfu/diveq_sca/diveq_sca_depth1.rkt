...
(define-grammar (diveq_sca_ps_gram a b n diveq_sca_rv)
 [rv (choose (equal? diveq_sca_rv (v0) ))]
[v0 (choose (vec-slice-noerr a (v1) (v1) ) (v4))]
[v1 (choose (v2) (v3))]
[v2 (choose 0 n b)]
[v3 (choose (integer-sqrt-noerr (v2) ) (integer-exp-noerr (v2) ) (+ (v2) (v2) ) (- (v2) (v2) ) (* (v2) (v2) ) (quotient-noerr (v2) (v2) ))]
...
(define diveq_sca_rv (take (list diveq_sca_rv_BOUNDEDSET-0 diveq_sca_rv_BOUNDEDSET-1) diveq_sca_rv_BOUNDEDSET-len))
...
(define (assertions)
 (assert (&& (&& (=> (&& (>= n 1 ) (>= (length a ) n ) ) (diveq_sca_inv0 a (list-empty ) b 0 n 0) ) (=> (&& (&& (&& (< i n ) (>= n 1 ) ) (>= (length a ) n ) ) (diveq_sca_inv0 a agg.result b i n ref.tmp) ) (diveq_sca_inv0 a (list-append agg.result (quotient-noerr (list-ref-noerr a i ) b ) ) b (+ i 1 ) n (quotient-noerr (list-ref-noerr a i ) b )) ) ) (=> (or (&& (&& (&& (! (< i n ) ) (>= n 1 ) ) (>= (length a ) n ) ) (diveq_sca_inv0 a agg.result b i n ref.tmp) ) (&& (&& (&& (&& (! true ) (! (< i n ) ) ) (>= n 1 ) ) (>= (length a ) n ) ) (diveq_sca_inv0 a agg.result b i n ref.tmp) ) ) (diveq_sca_ps a b n agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list a_BOUNDEDSET-len a_BOUNDEDSET-0 a_BOUNDEDSET-1 agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 b diveq_sca_rv_BOUNDEDSET-len diveq_sca_rv_BOUNDEDSET-0 diveq_sca_rv_BOUNDEDSET-1 i n ref.tmp)
