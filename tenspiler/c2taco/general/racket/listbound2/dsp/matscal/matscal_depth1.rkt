...
[v0 (choose (v1) (v5))]
[v1 (choose (matrix-col-slice-noerr (matrix-row-slice-noerr mat (v2) (v2) ) (v2) (v2) ) (matrix-transpose-noerr (matrix-col-slice-noerr (matrix-row-slice-noerr mat (v2) (v2) ) (v2) (v2) ) ))]
[v2 (choose (v3) (v4))]
[v3 (choose 0 m n i val)]
[v4 (choose (integer-sqrt-noerr (v3) ) (integer-exp-noerr (v3) ) (+ (v3) (v3) ) (- (v3) (v3) ) (* (v3) (v3) ) (quotient-noerr (v3) (v3) ))]
[v5 (choose (matrix_elemwise_add (v1) (v1) ) (matrix_elemwise_sub (v1) (v1) ) (matrix_elemwise_mul (v1) (v1) ) (matrix_elemwise_div (v1) (v1) ) (matrix_scalar_add (v3) (v1) ) (matrix_scalar_sub (v3) (v1) ) (matrix_scalar_mul (v3) (v1) ) (matrix_scalar_div (v3) (v1) ) (scalar_matrix_sub (v3) (v1)) (scalar_matrix_div (v3) (v1)))]
)

(define-grammar (matscal_inv1_gram j m mat n ref.tmp row_vec val agg.result i)
 [rv (choose (&& (&& (&& (&& (&& (>= i 0 ) (< i m ) ) (>= j 0 ) ) (<= j n ) ) (equal? row_vec (v0) ) ) (equal? agg.result (v7) ) ))]
[v0 (choose (matrix-ref-noerr (v1) (v2) ) (v5))]
[v1 (choose (matrix-col-slice-noerr (matrix-row-slice-noerr mat (v2) (v2) ) (v2) (v2) ) (matrix-transpose-noerr (matrix-col-slice-noerr (matrix-row-slice-noerr mat (v2) (v2) ) (v2) (v2) ) ))]
[v2 (choose (v3) (v4))]
[v3 (choose 0 m n i j val)]
[v4 (choose (integer-sqrt-noerr (v3) ) (integer-exp-noerr (v3) ) (+ (v3) (v3) ) (- (v3) (v3) ) (* (v3) (v3) ) (quotient-noerr (v3) (v3) ))]
[v5 (choose (v6) (vec_elemwise_add (matrix-ref-noerr (v1) (v2) ) (matrix-ref-noerr (v1) (v2) ) ) (vec_elemwise_sub (matrix-ref-noerr (v1) (v2) ) (matrix-ref-noerr (v1) (v2) ) ) (vec_elemwise_mul (matrix-ref-noerr (v1) (v2) ) (matrix-ref-noerr (v1) (v2) ) ) (vec_elemwise_div (matrix-ref-noerr (v1) (v2) ) (matrix-ref-noerr (v1) (v2) ) ) (vec_scalar_add (v3) (matrix-ref-noerr (v1) (v2) ) ) (vec_scalar_sub (v3) (matrix-ref-noerr (v1) (v2) ) ) (vec_scalar_mul (v3) (matrix-ref-noerr (v1) (v2) ) ) (vec_scalar_div (v3) (matrix-ref-noerr (v1) (v2) ) ) (scalar_vec_sub (v3) (matrix-ref-noerr (v1) (v2) )) (scalar_vec_div (v3) (matrix-ref-noerr (v1) (v2) )) (matrix_vec_mul (v1) (matrix-ref-noerr (v1) (v2) ) ))]
[v6 (choose (vec_map (matrix-ref-noerr (v1) (v2) ) map_int_to_int ))]
[v7 (choose (v1) (v8))]
[v8 (choose (matrix_elemwise_add (v1) (v1) ) (matrix_elemwise_sub (v1) (v1) ) (matrix_elemwise_mul (v1) (v1) ) (matrix_elemwise_div (v1) (v1) ) (matrix_scalar_add (v3) (v1) ) (matrix_scalar_sub (v3) (v1) ) (matrix_scalar_mul (v3) (v1) ) (matrix_scalar_div (v3) (v1) ) (scalar_matrix_sub (v3) (v1)) (scalar_matrix_div (v3) (v1)))]
)

(define-grammar (matscal_ps_gram mat val m n matscal_rv)
 [rv (choose (equal? matscal_rv (v0) ))]
[v0 (choose (v1) (v5))]
[v1 (choose (matrix-col-slice-noerr (matrix-row-slice-noerr mat (v2) (v2) ) (v2) (v2) ) (matrix-transpose-noerr (matrix-col-slice-noerr (matrix-row-slice-noerr mat (v2) (v2) ) (v2) (v2) ) ))]
[v2 (choose (v3) (v4))]
[v3 (choose 0 m n val)]
...
(define mat (take (list (list mat_BOUNDEDSET-0 mat_BOUNDEDSET-1) (list mat_BOUNDEDSET-2 mat_BOUNDEDSET-3)) mat_BOUNDEDSET-len))
...
(define matscal_rv (take (list (list matscal_rv_BOUNDEDSET-0 matscal_rv_BOUNDEDSET-1) (list matscal_rv_BOUNDEDSET-2 matscal_rv_BOUNDEDSET-3)) matscal_rv_BOUNDEDSET-len))
...
(define (assertions)
 (assert (&& (&& (&& (&& (=> (&& (&& (&& (>= m 1 ) (>= n 1 ) ) (>= (matrix-length mat ) m ) ) (>= (length (matrix-ref-noerr mat 0 ) ) n ) ) (matscal_inv0 (matrix-empty ) 0 0 m mat n 0 (list-empty ) val) ) (=> (&& (&& (&& (&& (&& (< i m ) (>= m 1 ) ) (>= n 1 ) ) (>= (matrix-length mat ) m ) ) (>= (length (matrix-ref-noerr mat 0 ) ) n ) ) (matscal_inv0 agg.result i j m mat n ref.tmp row_vec val) ) (matscal_inv1 0 m mat n ref.tmp (list-empty ) val agg.result i) ) ) (=> (&& (&& (&& (&& (&& (&& (&& (< j n ) (< i m ) ) (>= m 1 ) ) (>= n 1 ) ) (>= (matrix-length mat ) m ) ) (>= (length (matrix-ref-noerr mat 0 ) ) n ) ) (matscal_inv0 agg.result i j m mat n ref.tmp row_vec val) ) (matscal_inv1 j m mat n ref.tmp row_vec val agg.result i) ) (matscal_inv1 (+ j 1 ) m mat n (* (list-ref-noerr (matrix-ref-noerr mat i ) j ) val ) (list-append row_vec (* (list-ref-noerr (matrix-ref-noerr mat i ) j ) val ) ) val agg.result i) ) ) (=> (&& (&& (&& (&& (&& (&& (&& (! (< j n ) ) (< i m ) ) (>= m 1 ) ) (>= n 1 ) ) (>= (matrix-length mat ) m ) ) (>= (length (matrix-ref-noerr mat 0 ) ) n ) ) (matscal_inv0 agg.result i j m mat n ref.tmp row_vec val) ) (matscal_inv1 j m mat n ref.tmp row_vec val agg.result i) ) (matscal_inv0 (matrix-append agg.result row_vec ) (+ i 1 ) j m mat n ref.tmp row_vec val) ) ) (=> (or (&& (&& (&& (&& (&& (! (< i m ) ) (>= m 1 ) ) (>= n 1 ) ) (>= (matrix-length mat ) m ) ) (>= (length (matrix-ref-noerr mat 0 ) ) n ) ) (matscal_inv0 agg.result i j m mat n ref.tmp row_vec val) ) (&& (&& (&& (&& (&& (&& (! true ) (! (< i m ) ) ) (>= m 1 ) ) (>= n 1 ) ) (>= (matrix-length mat ) m ) ) (>= (length (matrix-ref-noerr mat 0 ) ) n ) ) (matscal_inv0 agg.result i j m mat n ref.tmp row_vec val) ) ) (matscal_ps mat val m n agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 i j m mat_BOUNDEDSET-len mat_BOUNDEDSET-0 mat_BOUNDEDSET-1 mat_BOUNDEDSET-2 mat_BOUNDEDSET-3 matscal_rv_BOUNDEDSET-len matscal_rv_BOUNDEDSET-0 matscal_rv_BOUNDEDSET-1 matscal_rv_BOUNDEDSET-2 matscal_rv_BOUNDEDSET-3 n ref.tmp row_vec_BOUNDEDSET-len row_vec_BOUNDEDSET-0 row_vec_BOUNDEDSET-1 val)
