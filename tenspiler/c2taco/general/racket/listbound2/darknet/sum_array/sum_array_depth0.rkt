...
(define-grammar (sum_array_ps_gram a n sum_array_rv)
 [rv (choose (equal? sum_array_rv (v0) ))]
[v0 (choose (reduce_sum (v1)) (reduce_mul (v1)) (reduce_max (v1)))]
[v1 (choose (vec-slice-noerr a (v2) (v2) ))]
[v2 (choose (v3))]
[v3 (choose 0 n)]
...
(define a (take (list a_BOUNDEDSET-0 a_BOUNDEDSET-1 a_BOUNDEDSET-2) a_BOUNDEDSET-len))
...
(define (assertions)
 (assert (&& (&& (=> (&& (&& (>= n 1 ) (> (length a ) 0 ) ) (>= (length a ) n ) ) (sum_array_inv0 a 0 n 0) ) (=> (&& (&& (&& (&& (< i n ) (>= n 1 ) ) (> (length a ) 0 ) ) (>= (length a ) n ) ) (sum_array_inv0 a i n sum) ) (sum_array_inv0 a (+ i 1 ) n (+ sum (list-ref-noerr a i ) )) ) ) (=> (&& (&& (&& (&& (! (< i n ) ) (>= n 1 ) ) (> (length a ) 0 ) ) (>= (length a ) n ) ) (sum_array_inv0 a i n sum) ) (sum_array_ps a n sum) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list a_BOUNDEDSET-len a_BOUNDEDSET-0 a_BOUNDEDSET-1 a_BOUNDEDSET-2 i n sum sum_array_rv)
