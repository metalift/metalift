...
(define-grammar (matrix_add_matrix_inv0_gram agg.result from_matrix i j ref.tmp row_vec to_matrix)
 [rv (choose (&& (&& (>= i 0 ) (<= i (matrix-length from_matrix ) ) ) (equal? agg.result (v0) ) ))]
[v0 (choose (v1) (v6))]
...
[v3 (choose (v4) (v5))]
[v4 (choose 0 (matrix-length from_matrix ) (length (matrix-ref-noerr from_matrix 0 ) ) i)]
...
(define-grammar (matrix_add_matrix_inv1_gram from_matrix j ref.tmp row_vec to_matrix agg.result i)
 [rv (choose (&& (&& (&& (&& (&& (>= i 0 ) (< i (matrix-length from_matrix ) ) ) (>= j 0 ) ) (<= j (length (matrix-ref-noerr from_matrix 0 ) ) ) ) (equal? row_vec (v0) ) ) (equal? agg.result (v8) ) ))]
[v0 (choose (matrix-ref-noerr (v1) (v3) ) (v6))]
[v1 (choose (matrix-col-slice-noerr (matrix-row-slice-noerr (v2) (v3) (v3) ) (v3) (v3) ) (matrix-transpose-noerr (matrix-col-slice-noerr (matrix-row-slice-noerr (v2) (v3) (v3) ) (v3) (v3) ) ))]
[v2 (choose from_matrix to_matrix)]
[v3 (choose (v4) (v5))]
[v4 (choose 0 (matrix-length from_matrix ) (length (matrix-ref-noerr from_matrix 0 ) ) i j)]
[v5 (choose (integer-sqrt-noerr (v4) ) (integer-exp-noerr (v4) ) (+ (v4) (v4) ) (- (v4) (v4) ) (* (v4) (v4) ) (quotient-noerr (v4) (v4) ))]
...
[v2 (choose from_matrix to_matrix)]
[v3 (choose (v4) (v5))]
[v4 (choose 0 (matrix-length from_matrix ) (length (matrix-ref-noerr from_matrix 0 ) ))]
[v5 (choose (integer-sqrt-noerr (v4) ) (integer-exp-noerr (v4) ) (+ (v4) (v4) ) (- (v4) (v4) ) (* (v4) (v4) ) (quotient-noerr (v4) (v4) ))]
[v6 (choose (matrix_elemwise_add (v1) (v1) ) (matrix_elemwise_sub (v1) (v1) ) (matrix_elemwise_mul (v1) (v1) ) (matrix_elemwise_div (v1) (v1) ) (matrix_scalar_add (v4) (v1) ) (matrix_scalar_sub (v4) (v1) ) (matrix_scalar_mul (v4) (v1) ) (matrix_scalar_div (v4) (v1) ) (scalar_matrix_sub (v4) (v1)) (scalar_matrix_div (v4) (v1)))]
)
