...
if __name__ == "__main__":
    driver, input_vars, ol_l2_cpu1 = analyze_single_loop(
        file_path="tenspiler/c2taco/cpp/for_synthesis/darknet/ol_l2_cpu1.cc",
        func_name="ol_l2_cpu1",
        axioms=[vec_elemwise_add_axiom, vec_elemwise_sub_axiom, vec_elemwise_mul_axiom],
    )
