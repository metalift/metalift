; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/simpl_array/cube_in_place.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/simpl_array/cube_in_place.cc"
...
define void @_Z13cube_in_placeNSt3__16vectorIiNS_9allocatorIiEEEEi(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %arr, i32 %n) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
