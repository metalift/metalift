; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/utdsp/lmsfir2.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/utdsp/lmsfir2.cc"
...
define void @_Z7lmsfir2iNSt3__16vectorIiNS_9allocatorIiEEEES3_i(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %NTAPS, %"class.std::__1::vector"* %input, %"class.std::__1::vector"* %coefficient, i32 %error) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
