; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/blas/gemv.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/blas/gemv.cc"
...
define void @_Z4gemviiNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES3_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %M, i32 %N, %"class.std::__1::vector.1"* %A, %"class.std::__1::vector"* %x) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
