; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/dsp/matadd.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/dsp/matadd.cc"
...
define void @_Z6mataddNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_ii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %matA, %"class.std::__1::vector"* %matB, i32 %m, i32 %n) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
