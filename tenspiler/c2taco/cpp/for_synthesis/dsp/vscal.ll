; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/dsp/vscal.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/dsp/vscal.cc"
...
define void @_Z5vscalNSt3__16vectorIiNS_9allocatorIiEEEEii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %arr, i32 %v, i32 %n) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
