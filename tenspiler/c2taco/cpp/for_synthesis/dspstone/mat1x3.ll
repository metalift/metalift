; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/dspstone/mat1x3.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/dspstone/mat1x3.cc"
...
define void @_Z6mat1x3iNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES3_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %N, %"class.std::__1::vector.1"* %h, %"class.std::__1::vector"* %x) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
