; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/dspstone/n_real_updates.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/dspstone/n_real_updates.cc"
...
define void @_Z14n_real_updatesiNSt3__16vectorIiNS_9allocatorIiEEEES3_S3_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %N, %"class.std::__1::vector"* %A, %"class.std::__1::vector"* %B, %"class.std::__1::vector"* %C) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
