; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/darknet/mult_add_into_cpu.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/darknet/mult_add_into_cpu.cc"
...
define void @_Z17mult_add_into_cpuiNSt3__16vectorIiNS_9allocatorIiEEEES3_S3_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %N, %"class.std::__1::vector"* %X, %"class.std::__1::vector"* %Y, %"class.std::__1::vector"* %Z) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
