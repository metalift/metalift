; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/darknet/scale_matrix.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/darknet/scale_matrix.cc"
...
define void @_Z12scale_matrixNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEEi(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %m, i32 %scale) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
