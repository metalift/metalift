; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/darknet/scale_array.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/darknet/scale_array.cc"
...
define void @_Z11scale_arrayNSt3__16vectorIiNS_9allocatorIiEEEEii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %a, i32 %n, i32 %s) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
