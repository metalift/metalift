; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/darknet/ol_l2_cpu2.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/darknet/ol_l2_cpu2.cc"
...
define void @_Z10ol_l2_cpu2iNSt3__16vectorIiNS_9allocatorIiEEEES3_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, i32 %n, %"class.std::__1::vector"* %pred, %"class.std::__1::vector"* %truth) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
