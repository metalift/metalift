; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/darknet/matrix_add_matrix.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/darknet/matrix_add_matrix.cc"
...
define void @_Z17matrix_add_matrixNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %from_matrix, %"class.std::__1::vector"* %to_matrix) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
