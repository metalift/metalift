; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/mathfu/matmul_sca.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/mathfu/matmul_sca.cc"
...
define void @_Z10matmul_scaNSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEEiii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %matA, i32 %val, i32 %m, i32 %n) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
