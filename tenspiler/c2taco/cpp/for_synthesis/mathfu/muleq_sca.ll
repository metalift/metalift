; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/mathfu/muleq_sca.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/mathfu/muleq_sca.cc"
...
define void @_Z9muleq_scaNSt3__16vectorIiNS_9allocatorIiEEEEii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %a, i32 %b, i32 %n) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
