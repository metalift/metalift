; ModuleID = 'tenspiler/c2taco/cpp/for_synthesis/mathfu/muleq.ll'
source_filename = "tenspiler/c2taco/cpp/for_synthesis/mathfu/muleq.cc"
...
define void @_Z5muleqNSt3__16vectorIiNS_9allocatorIiEEEES3_i(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %a, %"class.std::__1::vector"* %b, i32 %n) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
