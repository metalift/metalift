...
(define-symbolic lmsfir2_rv_BOUNDEDSET-2 integer?)
(define-symbolic lmsfir2_rv_BOUNDEDSET-3 integer?)
(define lmsfir2_rv (take (list lmsfir2_rv_BOUNDEDSET-0 lmsfir2_rv_BOUNDEDSET-1 lmsfir2_rv_BOUNDEDSET-2 lmsfir2_rv_BOUNDEDSET-3) lmsfir2_rv_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
 (assert (&& (&& (=> (&& (&& (>= NTAPS 1 ) (>= (length input ) NTAPS ) ) (>= (length coefficient ) NTAPS ) ) (lmsfir2_inv0 NTAPS (list-empty ) coefficient 0 error 0 input) ) (=> (&& (&& (&& (&& (< i (- NTAPS 1 ) ) (>= NTAPS 1 ) ) (>= (length input ) NTAPS ) ) (>= (length coefficient ) NTAPS ) ) (lmsfir2_inv0 NTAPS agg.result coefficient curr error i input) ) (lmsfir2_inv0 NTAPS (list-append agg.result (+ (list-ref-noerr coefficient i ) (* (list-ref-noerr input i ) error ) ) ) coefficient (+ (list-ref-noerr coefficient i ) (* (list-ref-noerr input i ) error ) ) error (+ i 1 ) input) ) ) (=> (or (&& (&& (&& (&& (! (< i (- NTAPS 1 ) ) ) (>= NTAPS 1 ) ) (>= (length input ) NTAPS ) ) (>= (length coefficient ) NTAPS ) ) (lmsfir2_inv0 NTAPS agg.result coefficient curr error i input) ) (&& (&& (&& (&& (&& (! true ) (! (< i (- NTAPS 1 ) ) ) ) (>= NTAPS 1 ) ) (>= (length input ) NTAPS ) ) (>= (length coefficient ) NTAPS ) ) (lmsfir2_inv0 NTAPS agg.result coefficient curr error i input) ) ) (lmsfir2_ps NTAPS input coefficient error agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list NTAPS agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 coefficient_BOUNDEDSET-len coefficient_BOUNDEDSET-0 coefficient_BOUNDEDSET-1 coefficient_BOUNDEDSET-2 coefficient_BOUNDEDSET-3 curr error i input_BOUNDEDSET-len input_BOUNDEDSET-0 input_BOUNDEDSET-1 input_BOUNDEDSET-2 input_BOUNDEDSET-3 lmsfir2_rv_BOUNDEDSET-len lmsfir2_rv_BOUNDEDSET-0 lmsfir2_rv_BOUNDEDSET-1 lmsfir2_rv_BOUNDEDSET-2 lmsfir2_rv_BOUNDEDSET-3)
