...
(define-symbolic fourth_in_place_rv_BOUNDEDSET-2 integer?)
(define-symbolic fourth_in_place_rv_BOUNDEDSET-3 integer?)
(define fourth_in_place_rv (take (list fourth_in_place_rv_BOUNDEDSET-0 fourth_in_place_rv_BOUNDEDSET-1 fourth_in_place_rv_BOUNDEDSET-2 fourth_in_place_rv_BOUNDEDSET-3) fourth_in_place_rv_BOUNDEDSET-len))
...
(define (assertions)
 (assert (&& (&& (=> (&& (>= n 1 ) (>= (length arr ) n ) ) (fourth_in_place_inv0 (list-empty ) arr 0 0 n 0) ) (=> (&& (&& (&& (< i n ) (>= n 1 ) ) (>= (length arr ) n ) ) (fourth_in_place_inv0 agg.result arr fourth i n sq) ) (fourth_in_place_inv0 (list-append agg.result (* (* (list-ref-noerr arr i ) (list-ref-noerr arr i ) ) (* (list-ref-noerr arr i ) (list-ref-noerr arr i ) ) ) ) arr (* (* (list-ref-noerr arr i ) (list-ref-noerr arr i ) ) (* (list-ref-noerr arr i ) (list-ref-noerr arr i ) ) ) (+ i 1 ) n (* (list-ref-noerr arr i ) (list-ref-noerr arr i ) )) ) ) (=> (or (&& (&& (&& (! (< i n ) ) (>= n 1 ) ) (>= (length arr ) n ) ) (fourth_in_place_inv0 agg.result arr fourth i n sq) ) (&& (&& (&& (&& (! true ) (! (< i n ) ) ) (>= n 1 ) ) (>= (length arr ) n ) ) (fourth_in_place_inv0 agg.result arr fourth i n sq) ) ) (fourth_in_place_ps arr n agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 arr_BOUNDEDSET-len arr_BOUNDEDSET-0 arr_BOUNDEDSET-1 arr_BOUNDEDSET-2 arr_BOUNDEDSET-3 fourth fourth_in_place_rv_BOUNDEDSET-len fourth_in_place_rv_BOUNDEDSET-0 fourth_in_place_rv_BOUNDEDSET-1 fourth_in_place_rv_BOUNDEDSET-2 fourth_in_place_rv_BOUNDEDSET-3 i n sq)
