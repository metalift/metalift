...
(define-symbolic cube_in_place_rv_BOUNDEDSET-2 integer?)
(define-symbolic cube_in_place_rv_BOUNDEDSET-3 integer?)
(define cube_in_place_rv (take (list cube_in_place_rv_BOUNDEDSET-0 cube_in_place_rv_BOUNDEDSET-1 cube_in_place_rv_BOUNDEDSET-2 cube_in_place_rv_BOUNDEDSET-3) cube_in_place_rv_BOUNDEDSET-len))
...
(define (assertions)
 (assert (&& (&& (=> (&& (>= n 1 ) (>= (length arr ) n ) ) (cube_in_place_inv0 (list-empty ) arr 0 n 0) ) (=> (&& (&& (&& (< i n ) (>= n 1 ) ) (>= (length arr ) n ) ) (cube_in_place_inv0 agg.result arr i n ref.tmp) ) (cube_in_place_inv0 (list-append agg.result (* (* (list-ref-noerr arr i ) (list-ref-noerr arr i ) ) (list-ref-noerr arr i ) ) ) arr (+ i 1 ) n (* (* (list-ref-noerr arr i ) (list-ref-noerr arr i ) ) (list-ref-noerr arr i ) )) ) ) (=> (or (&& (&& (&& (! (< i n ) ) (>= n 1 ) ) (>= (length arr ) n ) ) (cube_in_place_inv0 agg.result arr i n ref.tmp) ) (&& (&& (&& (&& (! true ) (! (< i n ) ) ) (>= n 1 ) ) (>= (length arr ) n ) ) (cube_in_place_inv0 agg.result arr i n ref.tmp) ) ) (cube_in_place_ps arr n agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 arr_BOUNDEDSET-len arr_BOUNDEDSET-0 arr_BOUNDEDSET-1 arr_BOUNDEDSET-2 arr_BOUNDEDSET-3 cube_in_place_rv_BOUNDEDSET-len cube_in_place_rv_BOUNDEDSET-0 cube_in_place_rv_BOUNDEDSET-1 cube_in_place_rv_BOUNDEDSET-2 cube_in_place_rv_BOUNDEDSET-3 i n ref.tmp)
