...
[v0 (choose (list-take-noerr truth i ) (list-take-noerr pred i ))]
)

(define-grammar (ol_l2_cpu2_ps_gram n pred truth ol_l2_cpu2_rv)
 [rv (choose (equal? ol_l2_cpu2_rv (vec_elemwise_sub (v0) (v0) ) ))]
[v0 (choose (list-take-noerr truth n ) (list-take-noerr pred n ))]
)
...
(define-symbolic ol_l2_cpu2_rv_BOUNDEDSET-2 integer?)
(define-symbolic ol_l2_cpu2_rv_BOUNDEDSET-3 integer?)
(define ol_l2_cpu2_rv (take (list ol_l2_cpu2_rv_BOUNDEDSET-0 ol_l2_cpu2_rv_BOUNDEDSET-1 ol_l2_cpu2_rv_BOUNDEDSET-2 ol_l2_cpu2_rv_BOUNDEDSET-3) ol_l2_cpu2_rv_BOUNDEDSET-len))
...
(define (assertions)
 (assert (&& (&& (=> (&& (&& (>= n 1 ) (>= (length pred ) n ) ) (>= (length truth ) n ) ) (ol_l2_cpu2_inv0 (list-empty ) 0 0 n pred truth) ) (=> (&& (&& (&& (&& (< i n ) (>= n 1 ) ) (>= (length pred ) n ) ) (>= (length truth ) n ) ) (ol_l2_cpu2_inv0 agg.result diff i n pred truth) ) (ol_l2_cpu2_inv0 (list-append agg.result (- (list-ref-noerr truth i ) (list-ref-noerr pred i ) ) ) (- (list-ref-noerr truth i ) (list-ref-noerr pred i ) ) (+ i 1 ) n pred truth) ) ) (=> (or (&& (&& (&& (&& (! (< i n ) ) (>= n 1 ) ) (>= (length pred ) n ) ) (>= (length truth ) n ) ) (ol_l2_cpu2_inv0 agg.result diff i n pred truth) ) (&& (&& (&& (&& (&& (! true ) (! (< i n ) ) ) (>= n 1 ) ) (>= (length pred ) n ) ) (>= (length truth ) n ) ) (ol_l2_cpu2_inv0 agg.result diff i n pred truth) ) ) (ol_l2_cpu2_ps n pred truth agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 diff i n ol_l2_cpu2_rv_BOUNDEDSET-len ol_l2_cpu2_rv_BOUNDEDSET-0 ol_l2_cpu2_rv_BOUNDEDSET-1 ol_l2_cpu2_rv_BOUNDEDSET-2 ol_l2_cpu2_rv_BOUNDEDSET-3 pred_BOUNDEDSET-len pred_BOUNDEDSET-0 pred_BOUNDEDSET-1 pred_BOUNDEDSET-2 pred_BOUNDEDSET-3 truth_BOUNDEDSET-len truth_BOUNDEDSET-0 truth_BOUNDEDSET-1 truth_BOUNDEDSET-2 truth_BOUNDEDSET-3)
