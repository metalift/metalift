...
(define-symbolic translate_array_rv_BOUNDEDSET-2 integer?)
(define-symbolic translate_array_rv_BOUNDEDSET-3 integer?)
(define translate_array_rv (take (list translate_array_rv_BOUNDEDSET-0 translate_array_rv_BOUNDEDSET-1 translate_array_rv_BOUNDEDSET-2 translate_array_rv_BOUNDEDSET-3) translate_array_rv_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
 (assert (&& (&& (=> (&& (>= n 1 ) (>= (length a ) n ) ) (translate_array_inv0 a (list-empty ) 0 n 0 s) ) (=> (&& (&& (&& (< i n ) (>= n 1 ) ) (>= (length a ) n ) ) (translate_array_inv0 a agg.result i n ref.tmp s) ) (translate_array_inv0 a (list-append agg.result (+ (list-ref-noerr a i ) s ) ) (+ i 1 ) n (+ (list-ref-noerr a i ) s ) s) ) ) (=> (or (&& (&& (&& (! (< i n ) ) (>= n 1 ) ) (>= (length a ) n ) ) (translate_array_inv0 a agg.result i n ref.tmp s) ) (&& (&& (&& (&& (! true ) (! (< i n ) ) ) (>= n 1 ) ) (>= (length a ) n ) ) (translate_array_inv0 a agg.result i n ref.tmp s) ) ) (translate_array_ps a n s agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list a_BOUNDEDSET-len a_BOUNDEDSET-0 a_BOUNDEDSET-1 a_BOUNDEDSET-2 a_BOUNDEDSET-3 agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 i n ref.tmp s translate_array_rv_BOUNDEDSET-len translate_array_rv_BOUNDEDSET-0 translate_array_rv_BOUNDEDSET-1 translate_array_rv_BOUNDEDSET-2 translate_array_rv_BOUNDEDSET-3)
