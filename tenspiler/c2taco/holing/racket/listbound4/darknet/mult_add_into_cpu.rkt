...
(define-symbolic Y_BOUNDEDSET-2 integer?)
(define-symbolic Y_BOUNDEDSET-3 integer?)
(define Y (take (list Y_BOUNDEDSET-0 Y_BOUNDEDSET-1 Y_BOUNDEDSET-2 Y_BOUNDEDSET-3) Y_BOUNDEDSET-len))
(define-symbolic Z_BOUNDEDSET-len integer?)
(define-symbolic Z_BOUNDEDSET-0 integer?)
(define-symbolic Z_BOUNDEDSET-1 integer?)
(define-symbolic Z_BOUNDEDSET-2 integer?)
(define-symbolic Z_BOUNDEDSET-3 integer?)
(define Z (take (list Z_BOUNDEDSET-0 Z_BOUNDEDSET-1 Z_BOUNDEDSET-2 Z_BOUNDEDSET-3) Z_BOUNDEDSET-len))
...
(define-symbolic mult_add_into_cpu_rv_BOUNDEDSET-2 integer?)
(define-symbolic mult_add_into_cpu_rv_BOUNDEDSET-3 integer?)
(define mult_add_into_cpu_rv (take (list mult_add_into_cpu_rv_BOUNDEDSET-0 mult_add_into_cpu_rv_BOUNDEDSET-1 mult_add_into_cpu_rv_BOUNDEDSET-2 mult_add_into_cpu_rv_BOUNDEDSET-3) mult_add_into_cpu_rv_BOUNDEDSET-len))
...
(define (assertions)
 (assert (&& (&& (=> (&& (&& (&& (>= N 1 ) (>= (length X ) N ) ) (>= (length Y ) N ) ) (>= (length Z ) N ) ) (mult_add_into_cpu_inv0 N X Y Z (list-empty ) 0 0) ) (=> (&& (&& (&& (&& (&& (< i N ) (>= N 1 ) ) (>= (length X ) N ) ) (>= (length Y ) N ) ) (>= (length Z ) N ) ) (mult_add_into_cpu_inv0 N X Y Z agg.result i ref.tmp) ) (mult_add_into_cpu_inv0 N X Y Z (list-append agg.result (+ (list-ref-noerr Z i ) (* (list-ref-noerr X i ) (list-ref-noerr Y i ) ) ) ) (+ i 1 ) (+ (list-ref-noerr Z i ) (* (list-ref-noerr X i ) (list-ref-noerr Y i ) ) )) ) ) (=> (or (&& (&& (&& (&& (&& (! (< i N ) ) (>= N 1 ) ) (>= (length X ) N ) ) (>= (length Y ) N ) ) (>= (length Z ) N ) ) (mult_add_into_cpu_inv0 N X Y Z agg.result i ref.tmp) ) (&& (&& (&& (&& (&& (&& (! true ) (! (< i N ) ) ) (>= N 1 ) ) (>= (length X ) N ) ) (>= (length Y ) N ) ) (>= (length Z ) N ) ) (mult_add_into_cpu_inv0 N X Y Z agg.result i ref.tmp) ) ) (mult_add_into_cpu_ps N X Y Z agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list N X_BOUNDEDSET-len X_BOUNDEDSET-0 X_BOUNDEDSET-1 X_BOUNDEDSET-2 X_BOUNDEDSET-3 Y_BOUNDEDSET-len Y_BOUNDEDSET-0 Y_BOUNDEDSET-1 Y_BOUNDEDSET-2 Y_BOUNDEDSET-3 Z_BOUNDEDSET-len Z_BOUNDEDSET-0 Z_BOUNDEDSET-1 Z_BOUNDEDSET-2 Z_BOUNDEDSET-3 agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 i mult_add_into_cpu_rv_BOUNDEDSET-len mult_add_into_cpu_rv_BOUNDEDSET-0 mult_add_into_cpu_rv_BOUNDEDSET-1 mult_add_into_cpu_rv_BOUNDEDSET-2 mult_add_into_cpu_rv_BOUNDEDSET-3 ref.tmp)
