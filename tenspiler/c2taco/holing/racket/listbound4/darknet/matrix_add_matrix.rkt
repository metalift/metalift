...
(define-symbolic from_matrix_BOUNDEDSET-4 integer?)
(define-symbolic from_matrix_BOUNDEDSET-5 integer?)
(define-symbolic from_matrix_BOUNDEDSET-6 integer?)
(define-symbolic from_matrix_BOUNDEDSET-7 integer?)
(define-symbolic from_matrix_BOUNDEDSET-8 integer?)
(define-symbolic from_matrix_BOUNDEDSET-9 integer?)
(define-symbolic from_matrix_BOUNDEDSET-10 integer?)
(define-symbolic from_matrix_BOUNDEDSET-11 integer?)
(define-symbolic from_matrix_BOUNDEDSET-12 integer?)
(define-symbolic from_matrix_BOUNDEDSET-13 integer?)
(define-symbolic from_matrix_BOUNDEDSET-14 integer?)
(define-symbolic from_matrix_BOUNDEDSET-15 integer?)
(define from_matrix (take (list (list from_matrix_BOUNDEDSET-0 from_matrix_BOUNDEDSET-1 from_matrix_BOUNDEDSET-2 from_matrix_BOUNDEDSET-3) (list from_matrix_BOUNDEDSET-4 from_matrix_BOUNDEDSET-5 from_matrix_BOUNDEDSET-6 from_matrix_BOUNDEDSET-7) (list from_matrix_BOUNDEDSET-8 from_matrix_BOUNDEDSET-9 from_matrix_BOUNDEDSET-10 from_matrix_BOUNDEDSET-11) (list from_matrix_BOUNDEDSET-12 from_matrix_BOUNDEDSET-13 from_matrix_BOUNDEDSET-14 from_matrix_BOUNDEDSET-15)) from_matrix_BOUNDEDSET-len))
...
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-4 integer?)
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-5 integer?)
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-6 integer?)
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-7 integer?)
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-8 integer?)
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-9 integer?)
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-10 integer?)
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-11 integer?)
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-12 integer?)
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-13 integer?)
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-14 integer?)
(define-symbolic matrix_add_matrix_rv_BOUNDEDSET-15 integer?)
(define matrix_add_matrix_rv (take (list (list matrix_add_matrix_rv_BOUNDEDSET-0 matrix_add_matrix_rv_BOUNDEDSET-1 matrix_add_matrix_rv_BOUNDEDSET-2 matrix_add_matrix_rv_BOUNDEDSET-3) (list matrix_add_matrix_rv_BOUNDEDSET-4 matrix_add_matrix_rv_BOUNDEDSET-5 matrix_add_matrix_rv_BOUNDEDSET-6 matrix_add_matrix_rv_BOUNDEDSET-7) (list matrix_add_matrix_rv_BOUNDEDSET-8 matrix_add_matrix_rv_BOUNDEDSET-9 matrix_add_matrix_rv_BOUNDEDSET-10 matrix_add_matrix_rv_BOUNDEDSET-11) (list matrix_add_matrix_rv_BOUNDEDSET-12 matrix_add_matrix_rv_BOUNDEDSET-13 matrix_add_matrix_rv_BOUNDEDSET-14 matrix_add_matrix_rv_BOUNDEDSET-15)) matrix_add_matrix_rv_BOUNDEDSET-len))
...
(define-symbolic to_matrix_BOUNDEDSET-4 integer?)
(define-symbolic to_matrix_BOUNDEDSET-5 integer?)
(define-symbolic to_matrix_BOUNDEDSET-6 integer?)
(define-symbolic to_matrix_BOUNDEDSET-7 integer?)
(define-symbolic to_matrix_BOUNDEDSET-8 integer?)
(define-symbolic to_matrix_BOUNDEDSET-9 integer?)
(define-symbolic to_matrix_BOUNDEDSET-10 integer?)
(define-symbolic to_matrix_BOUNDEDSET-11 integer?)
(define-symbolic to_matrix_BOUNDEDSET-12 integer?)
(define-symbolic to_matrix_BOUNDEDSET-13 integer?)
(define-symbolic to_matrix_BOUNDEDSET-14 integer?)
(define-symbolic to_matrix_BOUNDEDSET-15 integer?)
(define to_matrix (take (list (list to_matrix_BOUNDEDSET-0 to_matrix_BOUNDEDSET-1 to_matrix_BOUNDEDSET-2 to_matrix_BOUNDEDSET-3) (list to_matrix_BOUNDEDSET-4 to_matrix_BOUNDEDSET-5 to_matrix_BOUNDEDSET-6 to_matrix_BOUNDEDSET-7) (list to_matrix_BOUNDEDSET-8 to_matrix_BOUNDEDSET-9 to_matrix_BOUNDEDSET-10 to_matrix_BOUNDEDSET-11) (list to_matrix_BOUNDEDSET-12 to_matrix_BOUNDEDSET-13 to_matrix_BOUNDEDSET-14 to_matrix_BOUNDEDSET-15)) to_matrix_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
 (assert (&& (&& (&& (&& (=> (&& (&& (> (matrix-length from_matrix ) 1 ) (equal? (matrix-length from_matrix ) (matrix-length to_matrix ) ) ) (equal? (length (matrix-ref-noerr from_matrix 0 ) ) (length (matrix-ref-noerr to_matrix 0 ) ) ) ) (matrix_add_matrix_inv0 (matrix-empty ) from_matrix 0 0 0 (list-empty ) to_matrix ) ) (=> (&& (&& (&& (&& (< i (matrix-length from_matrix ) ) (> (matrix-length from_matrix ) 1 ) ) (equal? (matrix-length from_matrix ) (matrix-length to_matrix ) ) ) (equal? (length (matrix-ref-noerr from_matrix 0 ) ) (length (matrix-ref-noerr to_matrix 0 ) ) ) ) (matrix_add_matrix_inv0 agg.result from_matrix i j ref.tmp row_vec to_matrix ) ) (matrix_add_matrix_inv1 from_matrix 0 ref.tmp (list-empty ) to_matrix agg.result i ) ) ) (=> (&& (&& (&& (&& (&& (&& (< j (length (matrix-ref-noerr from_matrix 0 ) ) ) (< i (matrix-length from_matrix ) ) ) (> (matrix-length from_matrix ) 1 ) ) (equal? (matrix-length from_matrix ) (matrix-length to_matrix ) ) ) (equal? (length (matrix-ref-noerr from_matrix 0 ) ) (length (matrix-ref-noerr to_matrix 0 ) ) ) ) (matrix_add_matrix_inv0 agg.result from_matrix i j ref.tmp row_vec to_matrix ) ) (matrix_add_matrix_inv1 from_matrix j ref.tmp row_vec to_matrix agg.result i ) ) (matrix_add_matrix_inv1 from_matrix (+ j 1 ) (+ (list-ref-noerr (matrix-ref-noerr from_matrix i ) j ) (list-ref-noerr (matrix-ref-noerr to_matrix i ) j ) ) (list-append row_vec (+ (list-ref-noerr (matrix-ref-noerr from_matrix i ) j ) (list-ref-noerr (matrix-ref-noerr to_matrix i ) j ) ) ) to_matrix agg.result i ) ) ) (=> (&& (&& (&& (&& (&& (&& (! (< j (length (matrix-ref-noerr from_matrix 0 ) ) ) ) (< i (matrix-length from_matrix ) ) ) (> (matrix-length from_matrix ) 1 ) ) (equal? (matrix-length from_matrix ) (matrix-length to_matrix ) ) ) (equal? (length (matrix-ref-noerr from_matrix 0 ) ) (length (matrix-ref-noerr to_matrix 0 ) ) ) ) (matrix_add_matrix_inv0 agg.result from_matrix i j ref.tmp row_vec to_matrix ) ) (matrix_add_matrix_inv1 from_matrix j ref.tmp row_vec to_matrix agg.result i ) ) (matrix_add_matrix_inv0 (matrix-append agg.result row_vec ) from_matrix (+ i 1 ) j ref.tmp row_vec to_matrix ) ) ) (=> (or (&& (&& (&& (&& (! (< i (matrix-length from_matrix ) ) ) (> (matrix-length from_matrix ) 1 ) ) (equal? (matrix-length from_matrix ) (matrix-length to_matrix ) ) ) (equal? (length (matrix-ref-noerr from_matrix 0 ) ) (length (matrix-ref-noerr to_matrix 0 ) ) ) ) (matrix_add_matrix_inv0 agg.result from_matrix i j ref.tmp row_vec to_matrix ) ) (&& (&& (&& (&& (&& (! true ) (! (< i (matrix-length from_matrix ) ) ) ) (> (matrix-length from_matrix ) 1 ) ) (equal? (matrix-length from_matrix ) (matrix-length to_matrix ) ) ) (equal? (length (matrix-ref-noerr from_matrix 0 ) ) (length (matrix-ref-noerr to_matrix 0 ) ) ) ) (matrix_add_matrix_inv0 agg.result from_matrix i j ref.tmp row_vec to_matrix ) ) ) (matrix_add_matrix_ps from_matrix to_matrix agg.result ) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 agg.result_BOUNDEDSET-4 agg.result_BOUNDEDSET-5 agg.result_BOUNDEDSET-6 agg.result_BOUNDEDSET-7 agg.result_BOUNDEDSET-8 agg.result_BOUNDEDSET-9 agg.result_BOUNDEDSET-10 agg.result_BOUNDEDSET-11 agg.result_BOUNDEDSET-12 agg.result_BOUNDEDSET-13 agg.result_BOUNDEDSET-14 agg.result_BOUNDEDSET-15 from_matrix_BOUNDEDSET-len from_matrix_BOUNDEDSET-0 from_matrix_BOUNDEDSET-1 from_matrix_BOUNDEDSET-2 from_matrix_BOUNDEDSET-3 from_matrix_BOUNDEDSET-4 from_matrix_BOUNDEDSET-5 from_matrix_BOUNDEDSET-6 from_matrix_BOUNDEDSET-7 from_matrix_BOUNDEDSET-8 from_matrix_BOUNDEDSET-9 from_matrix_BOUNDEDSET-10 from_matrix_BOUNDEDSET-11 from_matrix_BOUNDEDSET-12 from_matrix_BOUNDEDSET-13 from_matrix_BOUNDEDSET-14 from_matrix_BOUNDEDSET-15 i j matrix_add_matrix_rv_BOUNDEDSET-len matrix_add_matrix_rv_BOUNDEDSET-0 matrix_add_matrix_rv_BOUNDEDSET-1 matrix_add_matrix_rv_BOUNDEDSET-2 matrix_add_matrix_rv_BOUNDEDSET-3 matrix_add_matrix_rv_BOUNDEDSET-4 matrix_add_matrix_rv_BOUNDEDSET-5 matrix_add_matrix_rv_BOUNDEDSET-6 matrix_add_matrix_rv_BOUNDEDSET-7 matrix_add_matrix_rv_BOUNDEDSET-8 matrix_add_matrix_rv_BOUNDEDSET-9 matrix_add_matrix_rv_BOUNDEDSET-10 matrix_add_matrix_rv_BOUNDEDSET-11 matrix_add_matrix_rv_BOUNDEDSET-12 matrix_add_matrix_rv_BOUNDEDSET-13 matrix_add_matrix_rv_BOUNDEDSET-14 matrix_add_matrix_rv_BOUNDEDSET-15 ref.tmp row_vec_BOUNDEDSET-len row_vec_BOUNDEDSET-0 row_vec_BOUNDEDSET-1 row_vec_BOUNDEDSET-2 row_vec_BOUNDEDSET-3 to_matrix_BOUNDEDSET-len to_matrix_BOUNDEDSET-0 to_matrix_BOUNDEDSET-1 to_matrix_BOUNDEDSET-2 to_matrix_BOUNDEDSET-3 to_matrix_BOUNDEDSET-4 to_matrix_BOUNDEDSET-5 to_matrix_BOUNDEDSET-6 to_matrix_BOUNDEDSET-7 to_matrix_BOUNDEDSET-8 to_matrix_BOUNDEDSET-9 to_matrix_BOUNDEDSET-10 to_matrix_BOUNDEDSET-11 to_matrix_BOUNDEDSET-12 to_matrix_BOUNDEDSET-13 to_matrix_BOUNDEDSET-14 to_matrix_BOUNDEDSET-15)
