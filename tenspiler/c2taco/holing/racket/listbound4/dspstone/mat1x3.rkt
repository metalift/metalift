...
(define-symbolic h_BOUNDEDSET-4 integer?)
(define-symbolic h_BOUNDEDSET-5 integer?)
(define-symbolic h_BOUNDEDSET-6 integer?)
(define-symbolic h_BOUNDEDSET-7 integer?)
(define-symbolic h_BOUNDEDSET-8 integer?)
(define-symbolic h_BOUNDEDSET-9 integer?)
(define-symbolic h_BOUNDEDSET-10 integer?)
(define-symbolic h_BOUNDEDSET-11 integer?)
(define-symbolic h_BOUNDEDSET-12 integer?)
(define-symbolic h_BOUNDEDSET-13 integer?)
(define-symbolic h_BOUNDEDSET-14 integer?)
(define-symbolic h_BOUNDEDSET-15 integer?)
(define h (take (list (list h_BOUNDEDSET-0 h_BOUNDEDSET-1 h_BOUNDEDSET-2 h_BOUNDEDSET-3) (list h_BOUNDEDSET-4 h_BOUNDEDSET-5 h_BOUNDEDSET-6 h_BOUNDEDSET-7) (list h_BOUNDEDSET-8 h_BOUNDEDSET-9 h_BOUNDEDSET-10 h_BOUNDEDSET-11) (list h_BOUNDEDSET-12 h_BOUNDEDSET-13 h_BOUNDEDSET-14 h_BOUNDEDSET-15)) h_BOUNDEDSET-len))
...
(define-symbolic mat1x3_rv_BOUNDEDSET-2 integer?)
(define-symbolic mat1x3_rv_BOUNDEDSET-3 integer?)
(define mat1x3_rv (take (list mat1x3_rv_BOUNDEDSET-0 mat1x3_rv_BOUNDEDSET-1 mat1x3_rv_BOUNDEDSET-2 mat1x3_rv_BOUNDEDSET-3) mat1x3_rv_BOUNDEDSET-len))
...
(define (assertions)
 (assert (&& (&& (&& (&& (=> (&& (&& (&& (>= N 1 ) (>= (matrix-length h ) N ) ) (>= (length (matrix-ref-noerr h 0 ) ) N ) ) (>= (length x ) N ) ) (mat1x3_inv0 N (list-empty ) 0 h 0 0 x) ) (=> (&& (&& (&& (&& (&& (< i N ) (>= N 1 ) ) (>= (matrix-length h ) N ) ) (>= (length (matrix-ref-noerr h 0 ) ) N ) ) (>= (length x ) N ) ) (mat1x3_inv0 N agg.result f h i sum x) ) (mat1x3_inv1 N 0 h 0 x agg.result i) ) ) (=> (&& (&& (&& (&& (&& (&& (&& (< f N ) (< i N ) ) (>= N 1 ) ) (>= (matrix-length h ) N ) ) (>= (length (matrix-ref-noerr h 0 ) ) N ) ) (>= (length x ) N ) ) (mat1x3_inv0 N agg.result f h i sum x) ) (mat1x3_inv1 N f h sum x agg.result i) ) (mat1x3_inv1 N (+ f 1 ) h (+ sum (* (list-ref-noerr (matrix-ref-noerr h i ) f ) (list-ref-noerr x f ) ) ) x agg.result i) ) ) (=> (&& (&& (&& (&& (&& (&& (&& (! (< f N ) ) (< i N ) ) (>= N 1 ) ) (>= (matrix-length h ) N ) ) (>= (length (matrix-ref-noerr h 0 ) ) N ) ) (>= (length x ) N ) ) (mat1x3_inv0 N agg.result f h i sum x) ) (mat1x3_inv1 N f h sum x agg.result i) ) (mat1x3_inv0 N (list-append agg.result sum ) f h (+ i 1 ) sum x) ) ) (=> (or (&& (&& (&& (&& (&& (! (< i N ) ) (>= N 1 ) ) (>= (matrix-length h ) N ) ) (>= (length (matrix-ref-noerr h 0 ) ) N ) ) (>= (length x ) N ) ) (mat1x3_inv0 N agg.result f h i sum x) ) (&& (&& (&& (&& (&& (&& (! true ) (! (< i N ) ) ) (>= N 1 ) ) (>= (matrix-length h ) N ) ) (>= (length (matrix-ref-noerr h 0 ) ) N ) ) (>= (length x ) N ) ) (mat1x3_inv0 N agg.result f h i sum x) ) ) (mat1x3_ps N h x agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list N agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 f h_BOUNDEDSET-len h_BOUNDEDSET-0 h_BOUNDEDSET-1 h_BOUNDEDSET-2 h_BOUNDEDSET-3 h_BOUNDEDSET-4 h_BOUNDEDSET-5 h_BOUNDEDSET-6 h_BOUNDEDSET-7 h_BOUNDEDSET-8 h_BOUNDEDSET-9 h_BOUNDEDSET-10 h_BOUNDEDSET-11 h_BOUNDEDSET-12 h_BOUNDEDSET-13 h_BOUNDEDSET-14 h_BOUNDEDSET-15 i mat1x3_rv_BOUNDEDSET-len mat1x3_rv_BOUNDEDSET-0 mat1x3_rv_BOUNDEDSET-1 mat1x3_rv_BOUNDEDSET-2 mat1x3_rv_BOUNDEDSET-3 sum x_BOUNDEDSET-len x_BOUNDEDSET-0 x_BOUNDEDSET-1 x_BOUNDEDSET-2 x_BOUNDEDSET-3)
