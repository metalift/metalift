...
(define-symbolic C_BOUNDEDSET-2 integer?)
(define-symbolic C_BOUNDEDSET-3 integer?)
(define C (take (list C_BOUNDEDSET-0 C_BOUNDEDSET-1 C_BOUNDEDSET-2 C_BOUNDEDSET-3) C_BOUNDEDSET-len))
...
(define-symbolic n_real_updates_rv_BOUNDEDSET-2 integer?)
(define-symbolic n_real_updates_rv_BOUNDEDSET-3 integer?)
(define n_real_updates_rv (take (list n_real_updates_rv_BOUNDEDSET-0 n_real_updates_rv_BOUNDEDSET-1 n_real_updates_rv_BOUNDEDSET-2 n_real_updates_rv_BOUNDEDSET-3) n_real_updates_rv_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
 (assert (&& (&& (=> (&& (&& (&& (>= N 1 ) (>= (length A ) N ) ) (>= (length B ) N ) ) (>= (length C ) N ) ) (n_real_updates_inv0 A B C N (list-empty ) 0 0) ) (=> (&& (&& (&& (&& (&& (< i N ) (>= N 1 ) ) (>= (length A ) N ) ) (>= (length B ) N ) ) (>= (length C ) N ) ) (n_real_updates_inv0 A B C N agg.result curr i) ) (n_real_updates_inv0 A B C N (list-append agg.result (+ (list-ref-noerr C i ) (* (list-ref-noerr A i ) (list-ref-noerr B i ) ) ) ) (+ (list-ref-noerr C i ) (* (list-ref-noerr A i ) (list-ref-noerr B i ) ) ) (+ i 1 )) ) ) (=> (or (&& (&& (&& (&& (&& (! (< i N ) ) (>= N 1 ) ) (>= (length A ) N ) ) (>= (length B ) N ) ) (>= (length C ) N ) ) (n_real_updates_inv0 A B C N agg.result curr i) ) (&& (&& (&& (&& (&& (&& (! true ) (! (< i N ) ) ) (>= N 1 ) ) (>= (length A ) N ) ) (>= (length B ) N ) ) (>= (length C ) N ) ) (n_real_updates_inv0 A B C N agg.result curr i) ) ) (n_real_updates_ps N A B C agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list A_BOUNDEDSET-len A_BOUNDEDSET-0 A_BOUNDEDSET-1 A_BOUNDEDSET-2 A_BOUNDEDSET-3 B_BOUNDEDSET-len B_BOUNDEDSET-0 B_BOUNDEDSET-1 B_BOUNDEDSET-2 B_BOUNDEDSET-3 C_BOUNDEDSET-len C_BOUNDEDSET-0 C_BOUNDEDSET-1 C_BOUNDEDSET-2 C_BOUNDEDSET-3 N agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 curr i n_real_updates_rv_BOUNDEDSET-len n_real_updates_rv_BOUNDEDSET-0 n_real_updates_rv_BOUNDEDSET-1 n_real_updates_rv_BOUNDEDSET-2 n_real_updates_rv_BOUNDEDSET-3)
