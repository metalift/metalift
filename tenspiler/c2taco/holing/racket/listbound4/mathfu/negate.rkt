...
(define-symbolic negate_rv_BOUNDEDSET-2 integer?)
(define-symbolic negate_rv_BOUNDEDSET-3 integer?)
(define negate_rv (take (list negate_rv_BOUNDEDSET-0 negate_rv_BOUNDEDSET-1 negate_rv_BOUNDEDSET-2 negate_rv_BOUNDEDSET-3) negate_rv_BOUNDEDSET-len))
