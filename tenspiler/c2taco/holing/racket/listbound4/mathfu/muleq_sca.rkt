...
(define-symbolic muleq_sca_rv_BOUNDEDSET-2 integer?)
(define-symbolic muleq_sca_rv_BOUNDEDSET-3 integer?)
(define muleq_sca_rv (take (list muleq_sca_rv_BOUNDEDSET-0 muleq_sca_rv_BOUNDEDSET-1 muleq_sca_rv_BOUNDEDSET-2 muleq_sca_rv_BOUNDEDSET-3) muleq_sca_rv_BOUNDEDSET-len))
...
(define (assertions)
 (assert (&& (&& (=> (&& (>= n 1 ) (>= (length a ) n ) ) (muleq_sca_inv0 a (list-empty ) b 0 n 0) ) (=> (&& (&& (&& (< i n ) (>= n 1 ) ) (>= (length a ) n ) ) (muleq_sca_inv0 a agg.result b i n ref.tmp) ) (muleq_sca_inv0 a (list-append agg.result (* (list-ref-noerr a i ) b ) ) b (+ i 1 ) n (* (list-ref-noerr a i ) b )) ) ) (=> (or (&& (&& (&& (! (< i n ) ) (>= n 1 ) ) (>= (length a ) n ) ) (muleq_sca_inv0 a agg.result b i n ref.tmp) ) (&& (&& (&& (&& (! true ) (! (< i n ) ) ) (>= n 1 ) ) (>= (length a ) n ) ) (muleq_sca_inv0 a agg.result b i n ref.tmp) ) ) (muleq_sca_ps a b n agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list a_BOUNDEDSET-len a_BOUNDEDSET-0 a_BOUNDEDSET-1 a_BOUNDEDSET-2 a_BOUNDEDSET-3 agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 b i muleq_sca_rv_BOUNDEDSET-len muleq_sca_rv_BOUNDEDSET-0 muleq_sca_rv_BOUNDEDSET-1 muleq_sca_rv_BOUNDEDSET-2 muleq_sca_rv_BOUNDEDSET-3 n ref.tmp)
