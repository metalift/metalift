...
(define-grammar (diveq_inv0_gram a agg.result b i n ref.tmp)
 [rv (choose (&& (&& (>= i 0 ) (<= i n ) ) (equal? agg.result (vec_elemwise_div (v0) (v0) ) ) ))]
[v0 (choose (list-take-noerr a i ) (list-take-noerr b i ))]
)

(define-grammar (diveq_ps_gram a b n diveq_rv)
 [rv (choose (equal? diveq_rv (vec_elemwise_div (v0) (v0) ) ))]
...
(define-symbolic diveq_rv_BOUNDEDSET-2 integer?)
(define-symbolic diveq_rv_BOUNDEDSET-3 integer?)
(define diveq_rv (take (list diveq_rv_BOUNDEDSET-0 diveq_rv_BOUNDEDSET-1 diveq_rv_BOUNDEDSET-2 diveq_rv_BOUNDEDSET-3) diveq_rv_BOUNDEDSET-len))
