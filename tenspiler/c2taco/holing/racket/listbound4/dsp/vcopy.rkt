...
(define-symbolic vcopy_rv_BOUNDEDSET-2 integer?)
(define-symbolic vcopy_rv_BOUNDEDSET-3 integer?)
(define vcopy_rv (take (list vcopy_rv_BOUNDEDSET-0 vcopy_rv_BOUNDEDSET-1 vcopy_rv_BOUNDEDSET-2 vcopy_rv_BOUNDEDSET-3) vcopy_rv_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
 (assert (&& (&& (=> (&& (>= n 1 ) (>= (length a ) n ) ) (vcopy_inv0 a (list-empty ) 0 n) ) (=> (&& (&& (&& (< i n ) (>= n 1 ) ) (>= (length a ) n ) ) (vcopy_inv0 a agg.result i n) ) (vcopy_inv0 a (list-append agg.result (list-ref-noerr a i ) ) (+ i 1 ) n) ) ) (=> (or (&& (&& (&& (! (< i n ) ) (>= n 1 ) ) (>= (length a ) n ) ) (vcopy_inv0 a agg.result i n) ) (&& (&& (&& (&& (! true ) (! (< i n ) ) ) (>= n 1 ) ) (>= (length a ) n ) ) (vcopy_inv0 a agg.result i n) ) ) (vcopy_ps a n agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list a_BOUNDEDSET-len a_BOUNDEDSET-0 a_BOUNDEDSET-1 a_BOUNDEDSET-2 a_BOUNDEDSET-3 agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 i n vcopy_rv_BOUNDEDSET-len vcopy_rv_BOUNDEDSET-0 vcopy_rv_BOUNDEDSET-1 vcopy_rv_BOUNDEDSET-2 vcopy_rv_BOUNDEDSET-3)
