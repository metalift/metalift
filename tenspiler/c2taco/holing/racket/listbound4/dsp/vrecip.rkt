...
(define-symbolic vrecip_rv_BOUNDEDSET-2 integer?)
(define-symbolic vrecip_rv_BOUNDEDSET-3 integer?)
(define vrecip_rv (take (list vrecip_rv_BOUNDEDSET-0 vrecip_rv_BOUNDEDSET-1 vrecip_rv_BOUNDEDSET-2 vrecip_rv_BOUNDEDSET-3) vrecip_rv_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
