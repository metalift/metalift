...
(define-grammar (vsub_ps_gram a b n vsub_rv)
 [rv (choose (equal? vsub_rv (vec_elemwise_sub (v0) (v0) ) ))]
...
(define-symbolic vsub_rv_BOUNDEDSET-2 integer?)
(define-symbolic vsub_rv_BOUNDEDSET-3 integer?)
(define vsub_rv (take (list vsub_rv_BOUNDEDSET-0 vsub_rv_BOUNDEDSET-1 vsub_rv_BOUNDEDSET-2 vsub_rv_BOUNDEDSET-3) vsub_rv_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
