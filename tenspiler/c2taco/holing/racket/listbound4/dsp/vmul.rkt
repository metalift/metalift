...
(define-symbolic vmul_rv_BOUNDEDSET-2 integer?)
(define-symbolic vmul_rv_BOUNDEDSET-3 integer?)
(define vmul_rv (take (list vmul_rv_BOUNDEDSET-0 vmul_rv_BOUNDEDSET-1 vmul_rv_BOUNDEDSET-2 vmul_rv_BOUNDEDSET-3) vmul_rv_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
