...
(define-symbolic voffset_rv_BOUNDEDSET-2 integer?)
(define-symbolic voffset_rv_BOUNDEDSET-3 integer?)
(define voffset_rv (take (list voffset_rv_BOUNDEDSET-0 voffset_rv_BOUNDEDSET-1 voffset_rv_BOUNDEDSET-2 voffset_rv_BOUNDEDSET-3) voffset_rv_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
