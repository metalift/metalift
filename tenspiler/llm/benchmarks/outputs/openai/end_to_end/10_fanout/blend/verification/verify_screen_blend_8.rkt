...
(list-tail-noerr (list-take-noerr lst end ) start )) 
 ...
 (define-bounded (screen_blend_8_ps active base out) 
(equal? out (matrix_elemwise_add (matrix_elemwise_sub base (matrix_scalar_div 32 (matrix_elemwise_mul base active ) ) ) active ) )) 


 (define-bounded (screen_blend_8_inv0 active base out row) 
(&& (>= row 0 ) (&& (<= row (matrix-length base ) ) (equal? out (matrix_elemwise_add (matrix_elemwise_sub (matrix-take-noerr base row ) (matrix_scalar_div 32 (matrix_elemwise_mul (matrix-take-noerr base row ) (matrix-take-noerr active row ) ) ) ) (matrix-take-noerr active row ) ) ) ) )) 


 (define-bounded (screen_blend_8_inv1 active base col out row row_vec) 
(&& (>= col 0 ) (&& (<= col (length (matrix-ref-noerr base 0 ) ) ) (&& (>= row 0 ) (&& (<= row (matrix-length base ) ) (&& (equal? out (matrix_elemwise_add (matrix_elemwise_sub (matrix-take-noerr base row ) (matrix_scalar_div 32 (matrix_elemwise_mul (matrix-take-noerr base row ) (matrix-take-noerr active row ) ) ) ) (matrix-take-noerr active row ) ) ) (equal? row_vec (vec_elemwise_add (vec_elemwise_sub (list-take-noerr (matrix-ref-noerr base row ) col ) (vec_scalar_div 32 (vec_elemwise_mul (list-take-noerr (matrix-ref-noerr base row ) col ) (list-take-noerr (matrix-ref-noerr active row ) col )))) (list-take-noerr (matrix-ref-noerr active row ) col )) ) ) ) ) ) )) 
...
(current-bitwidth 6)
(define vc (verify (assert (&& (&& (&& (&& (=> (&& (&& (> (matrix-length base ) 1 ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (screen_blend_8_inv0 active base (matrix-empty ) 0) ) (=> (&& (&& (&& (&& (< row (matrix-length base ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (screen_blend_8_inv0 active base agg.result row) ) (screen_blend_8_inv1 active base 0 agg.result row (list-empty )) ) ) (=> (&& (&& (&& (&& (&& (&& (< col (length (matrix-ref-noerr base 0 ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (screen_blend_8_inv0 active base agg.result row) ) (screen_blend_8_inv1 active base col agg.result row row_vec) ) (screen_blend_8_inv1 active base (+ col 1 ) agg.result row (list-append row_vec (- (+ (list-ref-noerr (matrix-ref-noerr base row ) col ) (list-ref-noerr (matrix-ref-noerr active row ) col ) ) (quotient-noerr (* (list-ref-noerr (matrix-ref-noerr base row ) col ) (list-ref-noerr (matrix-ref-noerr active row ) col ) ) 32 ) ) )) ) ) (=> (&& (&& (&& (&& (&& (&& (! (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (screen_blend_8_inv0 active base agg.result row) ) (screen_blend_8_inv1 active base col agg.result row row_vec) ) (screen_blend_8_inv0 active base (matrix-append agg.result row_vec ) (+ row 1 )) ) ) (=> (or (&& (&& (&& (&& (! (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (screen_blend_8_inv0 active base agg.result row) ) (&& (&& (&& (&& (&& (! true ) (! (< row (matrix-length base ) ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (screen_blend_8_inv0 active base agg.result row) ) ) (screen_blend_8_ps active base agg.result) ) ))))
