...
(if (or (< (length x ) 1 ) (! (equal? (length x ) (length y ) ) ) ) (list-empty ) (list-prepend (select_two_args_arg (list-ref-noerr x 0 ) (list-ref-noerr y 0 )) (vector_where (list-tail-noerr x 1 ) (list-tail-noerr y 1 ) select_two_args_arg) ) )) 
 ...
 (define-bounded (condition_d0d5b00c x y) 
(if (equal? y 32 ) 32 (quotient-noerr x (- 32 y ) ) )) 


 (define-bounded (color_dodge_8_ps active base out) 
(equal? out (matrix_where base active condition_d0d5b00c ) )) 


 (define-bounded (condition_70037777 x y) 
(if (equal? y 32 ) 32 (quotient-noerr x (- 32 y ) ) )) 


 (define-bounded (color_dodge_8_inv0 active base out row) 
(&& (>= row 0 ) (&& (<= row (matrix-length base ) ) (equal? out (matrix_where (matrix-take-noerr base row ) (matrix-take-noerr active row ) condition_70037777 ) ) ) )) 


 (define-bounded (condition_be0ad1a5 x y) 
(if (equal? y 32 ) 32 (quotient-noerr x (- 32 y ) ) )) 


 (define-bounded (condition_eb864dad x y) 
(if (equal? y 32 ) 32 (quotient-noerr x (- 32 y ) ) )) 


 (define-bounded (color_dodge_8_inv1 active base col out row row_vec) 
(&& (>= row 0 ) (&& (< row (matrix-length base ) ) (&& (>= col 0 ) (&& (<= col (length (matrix-ref-noerr base 0 ) ) ) (&& (equal? row_vec (vector_where (list-take-noerr (matrix-ref-noerr base row ) col ) (list-take-noerr (matrix-ref-noerr active row ) col ) condition_be0ad1a5) ) (equal? out (matrix_where (matrix-take-noerr base row ) (matrix-take-noerr active row ) condition_eb864dad ) ) ) ) ) ) )) 
...
(current-bitwidth 6)
(define vc (verify (assert (&& (&& (&& (&& (=> (&& (&& (> (matrix-length base ) 1 ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active base (matrix-empty ) 0) ) (=> (&& (&& (&& (&& (< row (matrix-length base ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active base agg.result row) ) (color_dodge_8_inv1 active base 0 agg.result row (list-empty )) ) ) (=> (or (&& (&& (&& (&& (&& (&& (&& (equal? (list-ref-noerr (matrix-ref-noerr active row ) col ) 32 ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active base agg.result row) ) (color_dodge_8_inv1 active base col agg.result row row_vec) ) (&& (&& (&& (&& (&& (&& (&& (! (equal? (list-ref-noerr (matrix-ref-noerr active row ) col ) 32 ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active base agg.result row) ) (color_dodge_8_inv1 active base col agg.result row row_vec) ) ) (color_dodge_8_inv1 active base (+ col 1 ) agg.result row (list-append row_vec (if (&& (&& (&& (&& (&& (&& (&& (! (equal? (list-ref-noerr (matrix-ref-noerr active row ) col ) 32 ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active base agg.result row) ) (color_dodge_8_inv1 active base col agg.result row row_vec) ) (quotient-noerr (list-ref-noerr (matrix-ref-noerr base row ) col ) (- 32 (list-ref-noerr (matrix-ref-noerr active row ) col ) ) ) 32 ) )) ) ) (=> (&& (&& (&& (&& (&& (&& (! (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active base agg.result row) ) (color_dodge_8_inv1 active base col agg.result row row_vec) ) (color_dodge_8_inv0 active base (matrix-append agg.result row_vec ) (+ row 1 )) ) ) (=> (or (&& (&& (&& (&& (! (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active base agg.result row) ) (&& (&& (&& (&& (&& (! true ) (! (< row (matrix-length base ) ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (color_dodge_8_inv0 active base agg.result row) ) ) (color_dodge_8_ps active base agg.result) ) ))))
