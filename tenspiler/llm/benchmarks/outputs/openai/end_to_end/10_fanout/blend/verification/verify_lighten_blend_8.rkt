...
(list-tail-noerr (list-take-noerr lst end ) start )) 
 ...
 (define-bounded (select_two_args_arg_461009ee x y) 
(if (> x y ) x y )) 


 (define-bounded (lighten_blend_8_ps active base out) 
(equal? out (matrix_selection_two_args base active select_two_args_arg_461009ee ) )) 


 (define-bounded (select_two_args_arg_1c289305 x y) 
(if (> x y ) x y )) 


 (define-bounded (lighten_blend_8_inv0 active base out row) 
(&& (>= row 0 ) (&& (<= row (matrix-length base ) ) (equal? out (matrix_selection_two_args (matrix-take-noerr base row ) (matrix-take-noerr active row ) select_two_args_arg_1c289305 ) ) ) )) 


 (define-bounded (select_two_args_arg_efb3d90c x y) 
(if (> x y ) x y )) 


 (define-bounded (select_two_args_arg_bcbda36e x y) 
(if (> x y ) x y )) 


 (define-bounded (lighten_blend_8_inv1 active base col out row row_vec) 
(&& (>= col 0 ) (&& (<= col (length (matrix-ref-noerr base 0 ) ) ) (&& (>= row 0 ) (&& (<= row (matrix-length base ) ) (&& (equal? out (matrix_selection_two_args (matrix-take-noerr base row ) (matrix-take-noerr active row ) select_two_args_arg_efb3d90c ) ) (equal? row_vec (selection_two_args (list-take-noerr (matrix-ref-noerr base row ) col ) (list-take-noerr (matrix-ref-noerr active row ) col ) select_two_args_arg_bcbda36e) ) ) ) ) ) )) 
...
(current-bitwidth 6)
(define vc (verify (assert (&& (&& (&& (&& (=> (&& (&& (> (matrix-length base ) 1 ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (lighten_blend_8_inv0 active base (matrix-empty ) 0) ) (=> (&& (&& (&& (&& (< row (matrix-length base ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (lighten_blend_8_inv0 active base agg.result row) ) (lighten_blend_8_inv1 active base 0 agg.result row (list-empty )) ) ) (=> (or (&& (&& (&& (&& (&& (&& (&& (< (list-ref-noerr (matrix-ref-noerr base row ) col ) (list-ref-noerr (matrix-ref-noerr active row ) col ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (lighten_blend_8_inv0 active base agg.result row) ) (lighten_blend_8_inv1 active base col agg.result row row_vec) ) (&& (&& (&& (&& (&& (&& (&& (! (< (list-ref-noerr (matrix-ref-noerr base row ) col ) (list-ref-noerr (matrix-ref-noerr active row ) col ) ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (lighten_blend_8_inv0 active base agg.result row) ) (lighten_blend_8_inv1 active base col agg.result row row_vec) ) ) (lighten_blend_8_inv1 active base (+ col 1 ) agg.result row (list-append row_vec (if (&& (&& (&& (&& (&& (&& (&& (! (< (list-ref-noerr (matrix-ref-noerr base row ) col ) (list-ref-noerr (matrix-ref-noerr active row ) col ) ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (lighten_blend_8_inv0 active base agg.result row) ) (lighten_blend_8_inv1 active base col agg.result row row_vec) ) (list-ref-noerr (matrix-ref-noerr base row ) col ) (list-ref-noerr (matrix-ref-noerr active row ) col ) ) )) ) ) (=> (&& (&& (&& (&& (&& (&& (! (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (lighten_blend_8_inv0 active base agg.result row) ) (lighten_blend_8_inv1 active base col agg.result row row_vec) ) (lighten_blend_8_inv0 active base (matrix-append agg.result row_vec ) (+ row 1 )) ) ) (=> (or (&& (&& (&& (&& (! (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (lighten_blend_8_inv0 active base agg.result row) ) (&& (&& (&& (&& (&& (! true ) (! (< row (matrix-length base ) ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (lighten_blend_8_inv0 active base agg.result row) ) ) (lighten_blend_8_ps active base agg.result) ) ))))
