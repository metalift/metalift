...
(list-tail-noerr (list-take-noerr lst end ) start )) 
 ...
 (define-bounded (select_two_args_arg_7b1a3429 x y) 
(if (< x y ) x y )) 


 (define-bounded (darken_blend_8_ps active base out) 
(equal? out (matrix_selection_two_args base active select_two_args_arg_7b1a3429 ) )) 


 (define-bounded (select_two_args_arg_c67465be x y) 
(if (< x y ) x y )) 


 (define-bounded (darken_blend_8_inv0 active base out row) 
(&& (>= row 0 ) (&& (<= row (matrix-length base ) ) (equal? out (matrix_selection_two_args (matrix-take-noerr base row ) (matrix-take-noerr active row ) select_two_args_arg_c67465be ) ) ) )) 


 (define-bounded (select_two_args_arg_5639e7dc x y) 
(if (< x y ) x y )) 


 (define-bounded (select_two_args_arg_ed8d7300 x y) 
(if (< x y ) x y )) 


 (define-bounded (darken_blend_8_inv1 active base col out row row_vec) 
(&& (>= col 0 ) (&& (<= col (length (matrix-ref-noerr base row ) ) ) (&& (>= row 0 ) (&& (< row (matrix-length base ) ) (&& (equal? out (matrix_selection_two_args (matrix-take-noerr base row ) (matrix-take-noerr active row ) select_two_args_arg_5639e7dc ) ) (equal? row_vec (selection_two_args (list-take-noerr (matrix-ref-noerr base row ) col ) (list-take-noerr (matrix-ref-noerr active row ) col ) select_two_args_arg_ed8d7300) ) ) ) ) ) )) 
...
(current-bitwidth 6)
(define vc (verify (assert (&& (&& (&& (&& (=> (&& (&& (> (matrix-length base ) 1 ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (darken_blend_8_inv0 active base (matrix-empty ) 0) ) (=> (&& (&& (&& (&& (< row (matrix-length base ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (darken_blend_8_inv0 active base agg.result row) ) (darken_blend_8_inv1 active base 0 agg.result row (list-empty )) ) ) (=> (or (&& (&& (&& (&& (&& (&& (&& (> (list-ref-noerr (matrix-ref-noerr base row ) col ) (list-ref-noerr (matrix-ref-noerr active row ) col ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (darken_blend_8_inv0 active base agg.result row) ) (darken_blend_8_inv1 active base col agg.result row row_vec) ) (&& (&& (&& (&& (&& (&& (&& (! (> (list-ref-noerr (matrix-ref-noerr base row ) col ) (list-ref-noerr (matrix-ref-noerr active row ) col ) ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (darken_blend_8_inv0 active base agg.result row) ) (darken_blend_8_inv1 active base col agg.result row row_vec) ) ) (darken_blend_8_inv1 active base (+ col 1 ) agg.result row (list-append row_vec (if (&& (&& (&& (&& (&& (&& (&& (! (> (list-ref-noerr (matrix-ref-noerr base row ) col ) (list-ref-noerr (matrix-ref-noerr active row ) col ) ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (darken_blend_8_inv0 active base agg.result row) ) (darken_blend_8_inv1 active base col agg.result row row_vec) ) (list-ref-noerr (matrix-ref-noerr base row ) col ) (list-ref-noerr (matrix-ref-noerr active row ) col ) ) )) ) ) (=> (&& (&& (&& (&& (&& (&& (! (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (darken_blend_8_inv0 active base agg.result row) ) (darken_blend_8_inv1 active base col agg.result row row_vec) ) (darken_blend_8_inv0 active base (matrix-append agg.result row_vec ) (+ row 1 )) ) ) (=> (or (&& (&& (&& (&& (! (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (darken_blend_8_inv0 active base agg.result row) ) (&& (&& (&& (&& (&& (! true ) (! (< row (matrix-length base ) ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (darken_blend_8_inv0 active base agg.result row) ) ) (darken_blend_8_ps active base agg.result) ) ))))
