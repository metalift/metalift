...
(if (or (< (length x ) 1 ) (! (equal? (length x ) (length y ) ) ) ) (list-empty ) (list-prepend (select_two_args_arg (list-ref-noerr x 0 ) (list-ref-noerr y 0 )) (vector_where (list-tail-noerr x 1 ) (list-tail-noerr y 1 ) select_two_args_arg) ) ))
 ...
 (define-bounded (condition_791d1ef0 b a)
(if (>= b 16 ) (- (- (+ (* 2 b ) b ) (quotient-noerr (* (* 2 b ) b ) 32 ) ) 32 ) (quotient-noerr (* (* 2 b ) b ) 32 ) ))


 (define-bounded (overlay_blend_8_ps active base out)
(equal? out (matrix_where base active condition_791d1ef0 ) ))


 (define-bounded (condition_f02a51b9 b a)
(if (>= b 16 ) (- (- (+ (* 2 b ) b ) (quotient-noerr (* (* 2 b ) b ) 32 ) ) 32 ) (quotient-noerr (* (* 2 b ) b ) 32 ) ))


 (define-bounded (overlay_blend_8_inv0 active base out row)
(&& (>= row 0 ) (&& (<= row (matrix-length base ) ) (equal? out (matrix_where (matrix-take-noerr base row ) (matrix-take-noerr active row ) condition_f02a51b9 ) ) ) ))


 (define-bounded (condition_5d3e16c1 b a)
(if (>= b 16 ) (- (- (+ (* 2 b ) b ) (quotient-noerr (* (* 2 b ) b ) 32 ) ) 32 ) (quotient-noerr (* (* 2 b ) b ) 32 ) ))


 (define-bounded (condition_5db074d8 b a)
(if (>= b 16 ) (- (- (+ (* 2 b ) b ) (quotient-noerr (* (* 2 b ) b ) 32 ) ) 32 ) (quotient-noerr (* (* 2 b ) b ) 32 ) ))


 (define-bounded (overlay_blend_8_inv1 active base col out row row_vec)
(&& (>= row 0 ) (&& (< row (matrix-length base ) ) (&& (>= col 0 ) (&& (<= col (length (matrix-ref-noerr base 0 ) ) ) (&& (equal? row_vec (vector_where (list-take-noerr (matrix-ref-noerr base row ) col ) (list-take-noerr (matrix-ref-noerr active row ) col ) condition_5d3e16c1) ) (equal? out (matrix_where (matrix-take-noerr base row ) (matrix-take-noerr active row ) condition_5db074d8 ) ) ) ) ) ) ))
...
(current-bitwidth 6)
(define vc (verify (assert (&& (&& (&& (&& (=> (&& (&& (> (matrix-length base ) 1 ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active base (matrix-empty ) 0) ) (=> (&& (&& (&& (&& (< row (matrix-length base ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active base agg.result row) ) (overlay_blend_8_inv1 active base 0 agg.result row (list-empty )) ) ) (=> (or (&& (&& (&& (&& (&& (&& (&& (>= (list-ref-noerr (matrix-ref-noerr base row ) col ) 16 ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active base agg.result row) ) (overlay_blend_8_inv1 active base col agg.result row row_vec) ) (&& (&& (&& (&& (&& (&& (&& (! (>= (list-ref-noerr (matrix-ref-noerr base row ) col ) 16 ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active base agg.result row) ) (overlay_blend_8_inv1 active base col agg.result row row_vec) ) ) (overlay_blend_8_inv1 active base (+ col 1 ) agg.result row (list-append row_vec (if (&& (&& (&& (&& (&& (&& (&& (! (>= (list-ref-noerr (matrix-ref-noerr base row ) col ) 16 ) ) (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active base agg.result row) ) (overlay_blend_8_inv1 active base col agg.result row row_vec) ) (quotient-noerr (* (* 2 (list-ref-noerr (matrix-ref-noerr base row ) col ) ) (list-ref-noerr (matrix-ref-noerr base row ) col ) ) 32 ) (- (- (+ (* 2 (list-ref-noerr (matrix-ref-noerr base row ) col ) ) (list-ref-noerr (matrix-ref-noerr base row ) col ) ) (quotient-noerr (* (* 2 (list-ref-noerr (matrix-ref-noerr base row ) col ) ) (list-ref-noerr (matrix-ref-noerr base row ) col ) ) 32 ) ) 32 ) ) )) ) ) (=> (&& (&& (&& (&& (&& (&& (! (< col (length (matrix-ref-noerr base 0 ) ) ) ) (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active base agg.result row) ) (overlay_blend_8_inv1 active base col agg.result row row_vec) ) (overlay_blend_8_inv0 active base (matrix-append agg.result row_vec ) (+ row 1 )) ) ) (=> (or (&& (&& (&& (&& (! (< row (matrix-length base ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active base agg.result row) ) (&& (&& (&& (&& (&& (! true ) (! (< row (matrix-length base ) ) ) ) (> (matrix-length base ) 1 ) ) (equal? (matrix-length base ) (matrix-length active ) ) ) (equal? (length (matrix-ref-noerr base 0 ) ) (length (matrix-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active base agg.result row) ) ) (overlay_blend_8_ps active base agg.result) ) ))))
