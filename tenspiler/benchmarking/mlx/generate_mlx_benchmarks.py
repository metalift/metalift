...
stored_path = "./tenspiler/benchmarking/mlx/"
...
for script_path in driver_files:
    ...
    mlx_code = mlx_codegen(driver.get_actual_ps_fn_decl(), driver.synthesized_fns, DataType.FULL_INT)
...
"""
    ...
    mlx_code_timing_kernel = mlx_code_timing + f"""
...
"""
    ...
    # NOTE: no need for mlx
    # with kernel_filepath.open('w') as file:
    #     file.write(mlx_code_timing_kernel)
