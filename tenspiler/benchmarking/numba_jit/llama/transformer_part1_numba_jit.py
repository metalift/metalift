...
def transformer_part1_numba_jit (token_position, head, head_size, key_cache_layer, q):
    # attention = []
    attention = np.empty(token_position)
...
transformer_part1_numba_jit(token_position, head, head_size, key_cache_layer, q)
...
print("transformer_part1_numba_jit")
