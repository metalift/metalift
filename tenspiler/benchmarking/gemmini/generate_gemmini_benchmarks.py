...
for script_path in driver_files:
    ...
    gemmini_code = gemmini_codegen(driver.get_actual_ps_fn_decl(), driver.synthesized_fns, DataType.FULL_INT)
...
blend_func_names = [normal_blend_8, normal_blend_f, linear_burn_8, 
