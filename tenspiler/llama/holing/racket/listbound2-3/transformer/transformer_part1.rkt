...
[v1 (choose (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 timestep ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) head_size ) ) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 head_size ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) timestep ) ) ) (matrix-transpose-noerr (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 timestep ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) head_size ) ) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 head_size ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) timestep ) ) ) ))]
)

(define-grammar (transformer_part1_inv1_gram head head_size i key_cache_layer q score token_position agg.result timestep)
 [rv (choose (&& (&& (&& (&& (&& (>= timestep 0 ) (< timestep token_position ) ) (>= i 0 ) ) (<= i head_size ) ) (equal? score (reduce_sum (if (VECTOR_OUTER_LOOP_INDEX) (vec_scalar_mul (list-ref-noerr q (+ (VEC_COMPOSED_INDEX_FN token_position head head_size) timestep ) ) (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (list-slice-noerr (matrix-ref-noerr key_cache_layer timestep ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) i ) ) (matrix-ref-noerr (matrix-transpose-noerr (matrix-col-slice-with-length-noerr (matrix-slice-noerr key_cache_layer 0 i ) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) timestep ) 1 ) ) 0 ) )) (vec_elemwise_mul (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (list-slice-noerr (matrix-ref-noerr key_cache_layer timestep ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) i ) ) (matrix-ref-noerr (matrix-transpose-noerr (matrix-col-slice-with-length-noerr (matrix-slice-noerr key_cache_layer 0 i ) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) timestep ) 1 ) ) 0 ) ) (list-slice-noerr q (VEC_COMPOSED_INDEX_FN token_position head head_size) (+ (VEC_COMPOSED_INDEX_FN token_position head head_size) i ) )) )) ) ) (equal? agg.result (vec_scalar_div (SQRT_ARG_FN token_position head head_size) (v0)) ) ))]
...
[v1 (choose (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 token_position ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) head_size ) ) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 head_size ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) token_position ) ) ) (matrix-transpose-noerr (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 token_position ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) head_size ) ) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 head_size ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) token_position ) ) ) ))]
)
