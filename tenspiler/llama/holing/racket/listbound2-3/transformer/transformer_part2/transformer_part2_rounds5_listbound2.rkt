...
[v0 (choose (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 i ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) token_position ) 1 ) ) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 (+ token_position 1 ) ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) i ) ) ) (matrix-transpose-noerr (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 i ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) token_position ) 1 ) ) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 (+ token_position 1 ) ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) i ) ) ) ))]
)
...
(define-grammar (transformer_part2_inv1_gram attention curr head head_size key_cache_layer timestep token_position agg.result i)
 [rv (choose (&& (&& (&& (&& (&& (>= i 0 ) (< i head_size ) ) (>= timestep 0 ) ) (<= timestep (+ token_position 1 ) ) ) (equal? curr (reduce_sum (if (VECTOR_OUTER_LOOP_INDEX) (vec_scalar_mul (list-ref-noerr attention i ) (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (list-slice-noerr (matrix-ref-noerr key_cache_layer i ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) timestep ) ) (matrix-ref-noerr (matrix-transpose-noerr (matrix-col-slice-with-length-noerr (matrix-slice-noerr key_cache_layer 0 timestep ) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) i ) 1 ) ) 0 ) )) (vec_elemwise_mul (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (list-slice-noerr (matrix-ref-noerr key_cache_layer i ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) timestep ) ) (matrix-ref-noerr (matrix-transpose-noerr (matrix-col-slice-with-length-noerr (matrix-slice-noerr key_cache_layer 0 timestep ) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) i ) 1 ) ) 0 ) ) (list-slice-noerr attention 0 timestep )) )) ) ) (equal? agg.result (matrix_vec_mul (v0) (if (VECTOR_OUTER_LOOP_INDEX) (list-slice-noerr attention 0 i ) (list-slice-noerr attention 0 (+ token_position 1 ) ) ) ) ) ))]
[v0 (choose (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 i ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) token_position ) 1 ) ) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 (+ token_position 1 ) ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) i ) ) ) (matrix-transpose-noerr (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 i ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) token_position ) 1 ) ) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 (+ token_position 1 ) ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) i ) ) ) ))]
)
...
[v0 (choose (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 head_size ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) token_position ) 1 ) ) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 (+ token_position 1 ) ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) head_size ) ) ) (matrix-transpose-noerr (if (MATRIX_OUTER_LOOP_INDEX_FIRST) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 head_size ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) token_position ) 1 ) ) (matrix-col-slice-noerr (matrix-slice-noerr key_cache_layer 0 (+ token_position 1 ) ) (MATRIX_COMPOSED_INDEX_FN token_position head head_size) (+ (MATRIX_COMPOSED_INDEX_FN token_position head head_size) head_size ) ) ) ))]
)
