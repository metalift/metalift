...
[v2 (choose (vec-slice-noerr input (v3) (v3) ) (v5))]
[v3 (choose (v4) (- (v4) 1 ) (+ (v4) 1 ))]
[v4 (choose 0 max_pos i max_val)]
[v5 (choose (v6) (vec_elemwise_add (vec-slice-noerr input (v3) (v3) ) (vec-slice-noerr input (v3) (v3) )) (vec_elemwise_sub (vec-slice-noerr input (v3) (v3) ) (vec-slice-noerr input (v3) (v3) )) (vec_elemwise_mul (vec-slice-noerr input (v3) (v3) ) (vec-slice-noerr input (v3) (v3) )) (vec_elemwise_div (vec-slice-noerr input (v3) (v3) ) (vec-slice-noerr input (v3) (v3) )) (vec_scalar_add (v7) (vec-slice-noerr input (v3) (v3) )) (vec_scalar_sub (v7) (vec-slice-noerr input (v3) (v3) )) (vec_scalar_mul (v7) (vec-slice-noerr input (v3) (v3) )) (vec_scalar_div (v7) (vec-slice-noerr input (v3) (v3) )) (scalar_vec_sub (v7) (vec-slice-noerr input (v3) (v3) )) (scalar_vec_div (v7) (vec-slice-noerr input (v3) (v3) )))]
[v6 (choose (vec_map (vec-slice-noerr input (v3) (v3) ) map_int_to_int))]
...
[v0 (choose (vec-slice-noerr input (v1) (v1) ) (v3))]
[v1 (choose (v2) (- (v2) 1 ) (+ (v2) 1 ))]
[v2 (choose 0 max_pos max_val)]
[v3 (choose (v4) (vec_elemwise_add (vec-slice-noerr input (v1) (v1) ) (vec-slice-noerr input (v1) (v1) )) (vec_elemwise_sub (vec-slice-noerr input (v1) (v1) ) (vec-slice-noerr input (v1) (v1) )) (vec_elemwise_mul (vec-slice-noerr input (v1) (v1) ) (vec-slice-noerr input (v1) (v1) )) (vec_elemwise_div (vec-slice-noerr input (v1) (v1) ) (vec-slice-noerr input (v1) (v1) )) (vec_scalar_add (v5) (vec-slice-noerr input (v1) (v1) )) (vec_scalar_sub (v5) (vec-slice-noerr input (v1) (v1) )) (vec_scalar_mul (v5) (vec-slice-noerr input (v1) (v1) )) (vec_scalar_div (v5) (vec-slice-noerr input (v1) (v1) )) (scalar_vec_sub (v5) (vec-slice-noerr input (v1) (v1) )) (scalar_vec_div (v5) (vec-slice-noerr input (v1) (v1) )))]
[v4 (choose (vec_map (vec-slice-noerr input (v1) (v1) ) map_int_to_int))]
