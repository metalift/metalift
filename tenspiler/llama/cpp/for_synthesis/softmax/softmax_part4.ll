; ModuleID = 'tenspiler/llama/cpp/for_synthesis/softmax/softmax_part4.ll'
source_filename = "tenspiler/llama/cpp/for_synthesis/softmax/softmax_part4.cc"
...
define void @_Z13softmax_part4NSt3__16vectorIiNS_9allocatorIiEEEEii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %unnormalized_output, i32 %max_pos, i32 %sum) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
