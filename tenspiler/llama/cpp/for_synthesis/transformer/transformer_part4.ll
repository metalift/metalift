; ModuleID = 'tenspiler/llama/cpp/for_synthesis/transformer/transformer_part4.ll'
source_filename = "tenspiler/llama/cpp/for_synthesis/transformer/transformer_part4.cc"
...
define void @_Z17transformer_part4NSt3__16vectorIiNS_9allocatorIiEEEES3_i(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %input1, %"class.std::__1::vector"* %input2, i32 %hidden_dim) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
