...
(constraint (=> (and (= bb (and bb3 (inv0 2 0 1 arg))) (= bb3 (=> (and (and (= tmp4 tmp2_1) (= tmp6 (< tmp2_1 arg)) (= tmp5 arg)) (inv0 2 tmp1_0 tmp2_1 arg)) (and bb13 bb7))) (= bb7 (=> (and (and (= tmp8 tmp1_0) (= tmp11 tmp2_1) (= tmp9 tmp2_1)) (and (inv0 2 tmp1_0 tmp2_1 arg) (< tmp2_1 arg))) (inv0 2 (+ tmp1_0 tmp2_1) (+ tmp2_1 1) arg))) (= bb13 (=> (and (= tmp14 tmp1_0) (and (inv0 2 tmp1_0 tmp2_1 arg) (not (< tmp2_1 arg)))) (ps tmp1_0 arg)))) bb))
