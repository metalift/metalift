...
(current-bitwidth 6)
(define (assertions)
 (assert (&& (&& (&& (&& (=> (&& (&& (> (length base ) 1 ) (equal? (length base ) (length active ) ) ) (equal? (length (list-list-ref-noerr base 0 ) ) (length (list-list-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active (list-empty ) base 0 0 0 0 0 (list-empty )) ) (=> (&& (&& (&& (&& (< row (length base ) ) (> (length base ) 1 ) ) (equal? (length base ) (length active ) ) ) (equal? (length (list-list-ref-noerr base 0 ) ) (length (list-list-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active agg.result base col div32 double_base pixel row row_vec) ) (overlay_blend_8_inv1 active base 0 div32 double_base pixel (list-empty ) agg.result row) ) ) (=> (or (&& (&& (&& (&& (&& (&& (&& (>= (list-ref-noerr (list-list-ref-noerr base row ) col ) 16 ) (< col (length (list-list-ref-noerr base 0 ) ) ) ) (< row (length base ) ) ) (> (length base ) 1 ) ) (equal? (length base ) (length active ) ) ) (equal? (length (list-list-ref-noerr base 0 ) ) (length (list-list-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active agg.result base col div32 double_base pixel row row_vec) ) (overlay_blend_8_inv1 active base col div32 double_base pixel row_vec agg.result row) ) (&& (&& (&& (&& (&& (&& (&& (! (>= (list-ref-noerr (list-list-ref-noerr base row ) col ) 16 ) ) (< col (length (list-list-ref-noerr base 0 ) ) ) ) (< row (length base ) ) ) (> (length base ) 1 ) ) (equal? (length base ) (length active ) ) ) (equal? (length (list-list-ref-noerr base 0 ) ) (length (list-list-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active agg.result base col div32 double_base pixel row row_vec) ) (overlay_blend_8_inv1 active base col div32 double_base pixel row_vec agg.result row) ) ) (overlay_blend_8_inv1 active base (+ col 1 ) (quotient-noerr (* (* 2 (list-ref-noerr (list-list-ref-noerr base row ) col ) ) (list-ref-noerr (list-list-ref-noerr base row ) col ) ) 32 ) (* 2 (list-ref-noerr (list-list-ref-noerr base row ) col ) ) (if (&& (&& (&& (&& (&& (&& (&& (! (>= (list-ref-noerr (list-list-ref-noerr base row ) col ) 16 ) ) (< col (length (list-list-ref-noerr base 0 ) ) ) ) (< row (length base ) ) ) (> (length base ) 1 ) ) (equal? (length base ) (length active ) ) ) (equal? (length (list-list-ref-noerr base 0 ) ) (length (list-list-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active agg.result base col div32 double_base pixel row row_vec) ) (overlay_blend_8_inv1 active base col div32 double_base pixel row_vec agg.result row) ) (quotient-noerr (* (* 2 (list-ref-noerr (list-list-ref-noerr base row ) col ) ) (list-ref-noerr (list-list-ref-noerr base row ) col ) ) 32 ) (- (- (+ (* 2 (list-ref-noerr (list-list-ref-noerr base row ) col ) ) (list-ref-noerr (list-list-ref-noerr base row ) col ) ) (quotient-noerr (* (* 2 (list-ref-noerr (list-list-ref-noerr base row ) col ) ) (list-ref-noerr (list-list-ref-noerr base row ) col ) ) 32 ) ) 32 ) ) (list-list-append row_vec (if (&& (&& (&& (&& (&& (&& (&& (! (>= (list-ref-noerr (list-list-ref-noerr base row ) col ) 16 ) ) (< col (length (list-list-ref-noerr base 0 ) ) ) ) (< row (length base ) ) ) (> (length base ) 1 ) ) (equal? (length base ) (length active ) ) ) (equal? (length (list-list-ref-noerr base 0 ) ) (length (list-list-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active agg.result base col div32 double_base pixel row row_vec) ) (overlay_blend_8_inv1 active base col div32 double_base pixel row_vec agg.result row) ) (quotient-noerr (* (* 2 (list-ref-noerr (list-list-ref-noerr base row ) col ) ) (list-ref-noerr (list-list-ref-noerr base row ) col ) ) 32 ) (- (- (+ (* 2 (list-ref-noerr (list-list-ref-noerr base row ) col ) ) (list-ref-noerr (list-list-ref-noerr base row ) col ) ) (quotient-noerr (* (* 2 (list-ref-noerr (list-list-ref-noerr base row ) col ) ) (list-ref-noerr (list-list-ref-noerr base row ) col ) ) 32 ) ) 32 ) ) ) agg.result row) ) ) (=> (&& (&& (&& (&& (&& (&& (! (< col (length (list-list-ref-noerr base 0 ) ) ) ) (< row (length base ) ) ) (> (length base ) 1 ) ) (equal? (length base ) (length active ) ) ) (equal? (length (list-list-ref-noerr base 0 ) ) (length (list-list-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active agg.result base col div32 double_base pixel row row_vec) ) (overlay_blend_8_inv1 active base col div32 double_base pixel row_vec agg.result row) ) (overlay_blend_8_inv0 active (list-list-append agg.result row_vec ) base col div32 double_base pixel (+ row 1 ) row_vec) ) ) (=> (or (&& (&& (&& (&& (! (< row (length base ) ) ) (> (length base ) 1 ) ) (equal? (length base ) (length active ) ) ) (equal? (length (list-list-ref-noerr base 0 ) ) (length (list-list-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active agg.result base col div32 double_base pixel row row_vec) ) (&& (&& (&& (&& (&& (! true ) (! (< row (length base ) ) ) ) (> (length base ) 1 ) ) (equal? (length base ) (length active ) ) ) (equal? (length (list-list-ref-noerr base 0 ) ) (length (list-list-ref-noerr active 0 ) ) ) ) (overlay_blend_8_inv0 active agg.result base col div32 double_base pixel row row_vec) ) ) (overlay_blend_8_ps base active agg.result) ) )))
