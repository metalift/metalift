...
from ir import Choose, And, Ge, Eq, Le, Sub, Synth, Call, Int, IntLit, FnDecl, Var, Add, Ite, List, Gt, Bool, Lt
...
def targetLang():
  ...
  data = Var("l", List(Int()))
  select_func = FnDecl("Select", List(Int()), Ite(Eq(Call("list_length",Int(),data),IntLit(0)), Call("list_empty",List(Int())), Ite(Call("Select-pred",Bool(),Call("list_get", Int(), data, IntLit(0))),Call("list_append",List(Int()),Call("Select",List(Int()),Call("list_tail", List(Int()),data, IntLit(1))), Call("list_get", Int(),data, IntLit(0)),),Call("Select",List(Int()),Call("list_tail",List(Int()),data,IntLit(1))))),data)
  select_func1 = FnDecl("Select1", List(Int()), Ite(Eq(Call("list_length",Int(),data),IntLit(0)), Call("list_empty",List(Int())), Ite(Call("Select-pred1",Bool(),Call("list_get", Int(), data, IntLit(0))),Call("list_append",List(Int()),Call("Select1",List(Int()),Call("list_tail", List(Int()),data, IntLit(1))), Call("list_get", Int(),data, IntLit(0)),),Call("Select1",List(Int()),Call("list_tail",List(Int()),data,IntLit(1))))),data)
  select_func2 = FnDecl("Select2", List(Int()), Ite(Eq(Call("list_length",Int(),data),IntLit(0)), Call("list_empty",List(Int())), Ite(Call("Select-pred2",Bool(),Call("list_get", Int(), data, IntLit(0))),Call("list_append",List(Int()),Call("Select2",List(Int()),Call("list_tail", List(Int()),data, IntLit(1))), Call("list_get", Int(),data, IntLit(0)),),Call("Select2",List(Int()),Call("list_tail",List(Int()),data,IntLit(1))))),data)

  
  return [select_pred,select_pred1, select_pred2, select_func, select_func1, select_func2]
