...
(= bb2 (=> (and (and (= tmp3 tmp1_1) (= tmp4 (< tmp1_1 3))) (inv0 tmp_0 tmp1_1)) (and bb11 bb5))) 

(= bb5 (=> (and (and (= tmp6 tmp_0) (= tmp7 tmp1_1) (= tmp9 tmp1_1)) (and (inv0 tmp_0 tmp1_1) (< tmp1_1 3))) (inv0 (+ tmp_0 tmp1_1) (+ tmp1_1 1)))) 

(= bb11 (=> (and (= tmp12 tmp_0) (and (inv0 tmp_0 tmp1_1) (not (< tmp1_1 3)))) (ps tmp_0)))
