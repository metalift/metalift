...
bb9:                                              ; preds = %bb4
  ...
  %tmp13 = call i32 @_Z7listGetIiET_P4listIS0_Ei(%struct.list* %tmp11, i32 %tmp12)
  %tmp14 = call %struct.list* @_Z10listAppendIiEP4listIT_ES3_S1_(%struct.list* %tmp10, i32 %tmp13)
...
bb:
  ...
  %tmp13 = call %struct.list* @_Z10listAppendIiEP4listIT_ES3_S1_(%struct.list* %tmp12, i32 2)
