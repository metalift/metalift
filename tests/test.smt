...
(assert (not (=> (and 
(= bb (and bb3 (inv0 0 0 0 0))) 

(= bb3 (=> (and (and (= tmp4 tmp1_3) (= tmp5 (< tmp1_3 3))) (inv0 tmp2_2 tmp_1 tmp2_2 tmp1_3)) (and bb18 bb6)))

(= bb6 (=> (and (inv0 tmp2_2 tmp_1 tmp2_2 tmp1_3) (< tmp1_3 3)) (and bb7 (inv1 tmp_1 0)))) 

(= bb7 (=> (and (and (= tmp8 tmp2_5) (= tmp9 (< tmp2_5 5))) (and (inv0 tmp2_2 tmp_1 tmp2_2 tmp1_3) (< tmp1_3 3) (inv1 tmp_4 tmp2_5))) (and bb15 bb10))) 

(= bb10 (=> (and (and (= tmp11 tmp_4) (= tmp13 tmp2_5)) (and (inv0 tmp2_2 tmp_1 tmp2_2 tmp1_3) (< tmp1_3 3) (inv1 tmp_4 tmp2_5) (< tmp2_5 5))) (inv1 (+ tmp_4 2) (+ tmp2_5 1)))) 

(= bb15 (=> (and (= tmp16 tmp1_3) (and (inv0 tmp2_2 tmp_1 tmp2_2 tmp1_3) (< tmp1_3 3) (inv1 tmp_4 tmp2_5) (not (< tmp2_5 5)))) (inv0 tmp2_5 tmp_4 tmp2_5 (+ tmp1_3 1)))) 

(= bb18 (=> (and (= tmp19 tmp_1) (and (inv0 tmp2_2 tmp_1 tmp2_2 tmp1_3) (not (< tmp1_3 3)))) (ps tmp_1)))
