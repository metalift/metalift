...
bb9:                                              ; preds = %bb4
  ...
  %tmp12 = call i32 @_Z7listGetP4listi(%struct.list* %tmp10, i32 %tmp11)
...
bb14:                                             ; preds = %bb9
  ...
  %tmp18 = call i32 @_Z7listGetP4listi(%struct.list* %tmp16, i32 %tmp17)
  %tmp19 = call %struct.list* @_Z10listAppendP4listi(%struct.list* %tmp15, i32 %tmp18)
...
bb:
  ...
  %tmp13 = call %struct.list* @_Z10listAppendP4listi(%struct.list* %tmp12, i32 20)
