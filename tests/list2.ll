...
bb14:                                             ; preds = %bb9
  %tmp15 = load %struct.list*, %struct.list** %tmp1, align 8
  %tmp16 = load %struct.list*, %struct.list** %tmp, align 8
  %tmp17 = load i32, i32* %tmp2, align 4
  %tmp18 = call i32 @_Z7listGetIiET_P4listIS0_Ei(%struct.list* %tmp16, i32 %tmp17)
  %tmp19 = call %struct.list* @_Z10listAppendIiEP4listIT_ES3_S1_(%struct.list* %tmp15, i32 %tmp18)
  store %struct.list* %tmp19, %struct.list** %tmp1, align 8
  br label %bb20
...
bb24:                                             ; preds = %bb4
  %tmp25 = load %struct.list*, %struct.list** %tmp1, align 8
  ret %struct.list* %tmp25
}

; Function Attrs: noinline optnone ssp uwtable
define linkonce_odr %struct.list* @_Z7newListIiEP4listIT_Ev() #0 {
bb:
  %tmp = call i8* @_Znwm(i64 24) #11
  %tmp1 = bitcast i8* %tmp to %struct.list*
  %tmp2 = bitcast %struct.list* %tmp1 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 16 %tmp2, i8 0, i64 24, i1 false)
  call void @_ZN4listIiEC1Ev(%struct.list* %tmp1) #12
...
bb:
  ...
  %tmp3 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector"* %tmp2) #12
...
bb:
  ...
  %tmp7 = call dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %tmp4, i64 %tmp6) #12
...
bb:
  ...
  store %struct.list* %arg, %struct.list** %tmp, align 8
  store i32 %arg1, i32* %tmp2, align 4
  %tmp6 = call %struct.list* @_Z7newListIiEP4listIT_Ev()
...
bb7:                                              ; preds = %bb18, %bb
  ...
  %tmp10 = call i32 @_Z10listLengthIiEiP4listIT_E(%struct.list* %tmp9)
...
bb12:                                             ; preds = %bb7
  ...
  %tmp17 = call i32 @_Z7listGetIiET_P4listIS0_Ei(%struct.list* %tmp15, i32 %tmp16)
...
bb:
  ...
  call void @_ZNSt3__111__wrap_iterIPKiEC1IPiEERKNS0_IT_EEPNS_9enable_ifIXsr14is_convertibleIS6_S2_EE5valueEvE4typeE(%"class.std::__1::__wrap_iter"* %tmp6, %"class.std::__1::__wrap_iter.1"* dereferenceable(8) %tmp7, i8* null) #12
  br label %bb20

bb20:                                             ; preds = %bb31, %bb
  %tmp21 = load %struct.list*, %struct.list** %tmp5, align 8
  %tmp22 = getelementptr inbounds %struct.list, %struct.list* %tmp21, i32 0, i32 0
  %tmp23 = call i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEE3endEv(%"class.std::__1::vector"* %tmp22) #12
  ...
  %tmp25 = call zeroext i1 @_ZNSt3__1neIPKiPiEEbRKNS_11__wrap_iterIT_EERKNS4_IT0_EE(%"class.std::__1::__wrap_iter"* dereferenceable(8) %tmp6, %"class.std::__1::__wrap_iter.1"* dereferenceable(8) %tmp8) #12
  br i1 %tmp25, label %bb26, label %bb33

bb26:                                             ; preds = %bb20
  %tmp27 = call dereferenceable(4) i32* @_ZNKSt3__111__wrap_iterIPKiEdeEv(%"class.std::__1::__wrap_iter"* %tmp6) #12
...
bb31:                                             ; preds = %bb26
  %tmp32 = call dereferenceable(8) %"class.std::__1::__wrap_iter"* @_ZNSt3__111__wrap_iterIPKiEppEv(%"class.std::__1::__wrap_iter"* %tmp6) #12
  br label %bb20
...
bb:
  ...
  %tmp6 = call i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEE11__make_iterEPi(%"class.std::__1::vector"* %tmp2, i32* %tmp5) #12
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr void @_ZNSt3__111__wrap_iterIPKiEC1IPiEERKNS0_IT_EEPNS_9enable_ifIXsr14is_convertibleIS6_S2_EE5valueEvE4typeE(%"class.std::__1::__wrap_iter"* %arg, %"class.std::__1::__wrap_iter.1"* dereferenceable(8) %arg1, i8* %arg2) unnamed_addr #1 align 2 {
bb:
  ...
  call void @_ZNSt3__111__wrap_iterIPKiEC2IPiEERKNS0_IT_EEPNS_9enable_ifIXsr14is_convertibleIS6_S2_EE5valueEvE4typeE(%"class.std::__1::__wrap_iter"* %tmp5, %"class.std::__1::__wrap_iter.1"* dereferenceable(8) %tmp6, i8* %tmp7) #12
  ret void
}

; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr hidden zeroext i1 @_ZNSt3__1neIPKiPiEEbRKNS_11__wrap_iterIT_EERKNS4_IT0_EE(%"class.std::__1::__wrap_iter"* dereferenceable(8) %arg, %"class.std::__1::__wrap_iter.1"* dereferenceable(8) %arg1) #1 {
bb:
  %tmp = alloca %"class.std::__1::__wrap_iter"*, align 8
  ...
  %tmp5 = call zeroext i1 @_ZNSt3__1eqIPKiPiEEbRKNS_11__wrap_iterIT_EERKNS4_IT0_EE(%"class.std::__1::__wrap_iter"* dereferenceable(8) %tmp3, %"class.std::__1::__wrap_iter.1"* dereferenceable(8) %tmp4) #12
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr hidden dereferenceable(4) i32* @_ZNKSt3__111__wrap_iterIPKiEdeEv(%"class.std::__1::__wrap_iter"* %arg) #1 align 2 {
bb:
  %tmp = alloca %"class.std::__1::__wrap_iter"*, align 8
  store %"class.std::__1::__wrap_iter"* %arg, %"class.std::__1::__wrap_iter"** %tmp, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr hidden dereferenceable(8) %"class.std::__1::__wrap_iter"* @_ZNSt3__111__wrap_iterIPKiEppEv(%"class.std::__1::__wrap_iter"* %arg) #1 align 2 {
bb:
  %tmp = alloca %"class.std::__1::__wrap_iter"*, align 8
  store %"class.std::__1::__wrap_iter"* %arg, %"class.std::__1::__wrap_iter"** %tmp, align 8
  %tmp1 = load %"class.std::__1::__wrap_iter"*, %"class.std::__1::__wrap_iter"** %tmp, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr void @_ZNSt3__111__wrap_iterIPKiEC2IPiEERKNS0_IT_EEPNS_9enable_ifIXsr14is_convertibleIS6_S2_EE5valueEvE4typeE(%"class.std::__1::__wrap_iter"* %arg, %"class.std::__1::__wrap_iter.1"* dereferenceable(8) %arg1, i8* %arg2) unnamed_addr #1 align 2 {
bb:
  %tmp = alloca %"class.std::__1::__wrap_iter"*, align 8
  %tmp3 = alloca %"class.std::__1::__wrap_iter.1"*, align 8
  %tmp4 = alloca i8*, align 8
  ...
  %tmp8 = call i32* @_ZNKSt3__111__wrap_iterIPiE4baseEv(%"class.std::__1::__wrap_iter.1"* %tmp7) #12
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr hidden zeroext i1 @_ZNSt3__1eqIPKiPiEEbRKNS_11__wrap_iterIT_EERKNS4_IT0_EE(%"class.std::__1::__wrap_iter"* dereferenceable(8) %arg, %"class.std::__1::__wrap_iter.1"* dereferenceable(8) %arg1) #1 {
bb:
  %tmp = alloca %"class.std::__1::__wrap_iter"*, align 8
  %tmp2 = alloca %"class.std::__1::__wrap_iter.1"*, align 8
  store %"class.std::__1::__wrap_iter"* %arg, %"class.std::__1::__wrap_iter"** %tmp, align 8
  store %"class.std::__1::__wrap_iter.1"* %arg1, %"class.std::__1::__wrap_iter.1"** %tmp2, align 8
  %tmp3 = load %"class.std::__1::__wrap_iter"*, %"class.std::__1::__wrap_iter"** %tmp, align 8
  %tmp4 = call i32* @_ZNKSt3__111__wrap_iterIPKiE4baseEv(%"class.std::__1::__wrap_iter"* %tmp3) #12
  %tmp5 = load %"class.std::__1::__wrap_iter.1"*, %"class.std::__1::__wrap_iter.1"** %tmp2, align 8
  %tmp6 = call i32* @_ZNKSt3__111__wrap_iterIPiE4baseEv(%"class.std::__1::__wrap_iter.1"* %tmp5) #12
...
bb:
  ...
  store %struct.list* %arg, %struct.list** %tmp, align 8
  %tmp1 = load %struct.list*, %struct.list** %tmp, align 8
  call void @_ZN4listIiEC2Ev(%struct.list* %tmp1) #12
  ret void
}
...
bb:
  ...
  %tmp1 = load %struct.list*, %struct.list** %tmp, align 8
  %tmp2 = getelementptr inbounds %struct.list, %struct.list* %tmp1, i32 0, i32 0
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEEC1Ev(%"class.std::__1::vector"* %tmp2) #12
  ret void
}
...
bb:
  ...
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEEC2Ev(%"class.std::__1::vector"* %tmp1) #12
  ret void
}
...
bb:
  ...
  call void @_ZNSt3__113__vector_baseIiNS_9allocatorIiEEEC2Ev(%"class.std::__1::__vector_base"* %tmp2) #12
  ret void
}
...
bb:
  %tmp = call i8* @__cxa_begin_catch(i8* %arg) #12
...
bb:
  ...
  %tmp9 = call dereferenceable(8) i8** @_ZNSt3__17forwardIDnEEOT_RNS_16remove_referenceIS1_E4typeE(i8** dereferenceable(8) %tmp8) #12
  ...
  %tmp12 = call dereferenceable(1) %"struct.std::__1::__default_init_tag"* @_ZNSt3__17forwardINS_18__default_init_tagEEEOT_RNS_16remove_referenceIS2_E4typeE(%"struct.std::__1::__default_init_tag"* dereferenceable(1) %tmp11) #12
...
bb:
  ...
  %tmp6 = call dereferenceable(8) i8** @_ZNSt3__17forwardIDnEEOT_RNS_16remove_referenceIS1_E4typeE(i8** dereferenceable(8) %tmp5) #12
...
bb:
  ...
  call void @_ZNSt3__19allocatorIiEC2Ev(%"class.std::__1::allocator"* %tmp3) #12
  ret void
}
...
bb:
  ...
  %tmp8 = call dereferenceable(8) i32** @_ZNSt3__113__vector_baseIiNS_9allocatorIiEEE9__end_capEv(%"class.std::__1::__vector_base"* %tmp7) #12
  %tmp9 = load i32*, i32** %tmp8, align 8
...
bb11:                                             ; preds = %bb
  ...
  %tmp13 = call dereferenceable(4) i32* @_ZNSt3__14moveIRiEEONS_16remove_referenceIT_E4typeEOS3_(i32* dereferenceable(4) %tmp12) #12
...
bb14:                                             ; preds = %bb
  ...
  %tmp16 = call dereferenceable(4) i32* @_ZNSt3__14moveIRiEEONS_16remove_referenceIT_E4typeEOS3_(i32* dereferenceable(4) %tmp15) #12
...
bb:
  ...
  %tmp3 = call dereferenceable(8) i32** @_ZNSt3__117__compressed_pairIPiNS_9allocatorIiEEE5firstEv(%"class.std::__1::__compressed_pair"* %tmp2) #12
  ret i32** %tmp3
}
...
bb:
  ...
  %tmp8 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__113__vector_baseIiNS_9allocatorIiEEE7__allocEv(%"class.std::__1::__vector_base"* %tmp7) #12
  ...
  %tmp11 = call i32* @_ZNSt3__112__to_addressIiEEPT_S2_(i32* %tmp10) #12
  %tmp12 = load i32*, i32** %tmp2, align 8
  %tmp13 = call dereferenceable(4) i32* @_ZNSt3__17forwardIiEEOT_RNS_16remove_referenceIS1_E4typeE(i32* dereferenceable(4) %tmp12) #12
...
bb14:                                             ; preds = %bb
  ...
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE21_ConstructTransactionD1Ev(%"struct.std::__1::vector<int, std::__1::allocator<int> >::_ConstructTransaction"* %tmp3) #12
  ret void
}

; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr hidden dereferenceable(4) i32* @_ZNSt3__14moveIRiEEONS_16remove_referenceIT_E4typeEOS3_(i32* dereferenceable(4) %arg) #1 {
bb:
...
bb:
  ...
  %tmp9 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__113__vector_baseIiNS_9allocatorIiEEE7__allocEv(%"class.std::__1::__vector_base"* %tmp8) #12
  store %"class.std::__1::allocator"* %tmp9, %"class.std::__1::allocator"** %tmp3, align 8
  %tmp10 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector"* %tmp7) #12
  ...
  %tmp13 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector"* %tmp7) #12
  ...
  %tmp18 = call i32* @_ZNSt3__112__to_addressIiEEPT_S2_(i32* %tmp17) #12
  %tmp19 = load i32*, i32** %tmp2, align 8
  %tmp20 = call dereferenceable(4) i32* @_ZNSt3__17forwardIiEEOT_RNS_16remove_referenceIS1_E4typeE(i32* dereferenceable(4) %tmp19) #12
...
bb25:                                             ; preds = %bb21
  call void @_ZNSt3__114__split_bufferIiRNS_9allocatorIiEEED1Ev(%"struct.std::__1::__split_buffer"* %tmp4) #12
  ret void
}
...
bb:
  ...
  %tmp3 = call dereferenceable(8) i32** @_ZNSt3__122__compressed_pair_elemIPiLi0ELb0EE5__getEv(%"struct.std::__1::__compressed_pair_elem"* %tmp2) #12
  ret i32** %tmp3
}
...
bb:
  ...
  %tmp11 = call dereferenceable(4) i32* @_ZNSt3__17forwardIiEEOT_RNS_16remove_referenceIS1_E4typeE(i32* dereferenceable(4) %tmp10) #12
...
bb:
  ...
  %tmp1 = load %"class.std::__1::__vector_base"*, %"class.std::__1::__vector_base"** %tmp, align 8
  %tmp2 = getelementptr inbounds %"class.std::__1::__vector_base", %"class.std::__1::__vector_base"* %tmp1, i32 0, i32 2
  %tmp3 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__117__compressed_pairIPiNS_9allocatorIiEEE6secondEv(%"class.std::__1::__compressed_pair"* %tmp2) #12
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr hidden dereferenceable(4) i32* @_ZNSt3__17forwardIiEEOT_RNS_16remove_referenceIS1_E4typeE(i32* dereferenceable(4) %arg) #1 {
bb:
  %tmp = alloca i32*, align 8
  store i32* %arg, i32** %tmp, align 8
  %tmp1 = load i32*, i32** %tmp, align 8
...
bb:
  ...
  call void @_ZNSt3__16vectorIiNS_9allocatorIiEEE21_ConstructTransactionD2Ev(%"struct.std::__1::vector<int, std::__1::allocator<int> >::_ConstructTransaction"* %tmp1) #12
  ret void
}
...
bb:
  ...
  %tmp9 = call dereferenceable(4) i32* @_ZNSt3__17forwardIiEEOT_RNS_16remove_referenceIS1_E4typeE(i32* dereferenceable(4) %tmp8) #12
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr void @_ZNSt3__19allocatorIiE9constructIiJiEEEvPT_DpOT0_(%"class.std::__1::allocator"* %arg, i32* %arg1, i32* dereferenceable(4) %arg2) #1 align 2 {
bb:
  %tmp = alloca %"class.std::__1::allocator"*, align 8
  %tmp3 = alloca i32*, align 8
  %tmp4 = alloca i32*, align 8
  ...
  %tmp10 = call dereferenceable(4) i32* @_ZNSt3__17forwardIiEEOT_RNS_16remove_referenceIS1_E4typeE(i32* dereferenceable(4) %tmp9) #12
...
bb:
  ...
  %tmp3 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__122__compressed_pair_elemINS_9allocatorIiEELi1ELb1EE5__getEv(%"struct.std::__1::__compressed_pair_elem.0"* %tmp2) #12
  ret %"class.std::__1::allocator"* %tmp3
}
...
bb:
  ...
  %tmp8 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE8max_sizeEv(%"class.std::__1::vector"* %tmp7) #12
...
bb14:                                             ; preds = %bb
  %tmp15 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE8capacityEv(%"class.std::__1::vector"* %tmp7) #12
...
bb:
  ...
  %tmp3 = load %"class.std::__1::vector"*, %"class.std::__1::vector"** %tmp, align 8
  call void @_ZNKSt3__16vectorIiNS_9allocatorIiEEE17__annotate_deleteEv(%"class.std::__1::vector"* %tmp3) #12
  %tmp4 = bitcast %"class.std::__1::vector"* %tmp3 to %"class.std::__1::__vector_base"*
  %tmp5 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__113__vector_baseIiNS_9allocatorIiEEE7__allocEv(%"class.std::__1::__vector_base"* %tmp4) #12
  ...
  call void @_ZNSt3__14swapIPiEENS_9enable_ifIXaasr21is_move_constructibleIT_EE5valuesr18is_move_assignableIS3_EE5valueEvE4typeERS3_S6_(i32** dereferenceable(8) %tmp15, i32** dereferenceable(8) %tmp17) #12
  ...
  call void @_ZNSt3__14swapIPiEENS_9enable_ifIXaasr21is_move_constructibleIT_EE5valuesr18is_move_assignableIS3_EE5valueEvE4typeERS3_S6_(i32** dereferenceable(8) %tmp19, i32** dereferenceable(8) %tmp21) #12
  %tmp22 = bitcast %"class.std::__1::vector"* %tmp3 to %"class.std::__1::__vector_base"*
  %tmp23 = call dereferenceable(8) i32** @_ZNSt3__113__vector_baseIiNS_9allocatorIiEEE9__end_capEv(%"class.std::__1::__vector_base"* %tmp22) #12
  %tmp24 = load %"struct.std::__1::__split_buffer"*, %"struct.std::__1::__split_buffer"** %tmp2, align 8
  %tmp25 = call dereferenceable(8) i32** @_ZNSt3__114__split_bufferIiRNS_9allocatorIiEEE9__end_capEv(%"struct.std::__1::__split_buffer"* %tmp24) #12
  call void @_ZNSt3__14swapIPiEENS_9enable_ifIXaasr21is_move_constructibleIT_EE5valuesr18is_move_assignableIS3_EE5valueEvE4typeERS3_S6_(i32** dereferenceable(8) %tmp23, i32** dereferenceable(8) %tmp25) #12
  ...
  %tmp31 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector"* %tmp3) #12
  call void @_ZNKSt3__16vectorIiNS_9allocatorIiEEE14__annotate_newEm(%"class.std::__1::vector"* %tmp3, i64 %tmp31) #12
...
bb:
  ...
  call void @_ZNSt3__114__split_bufferIiRNS_9allocatorIiEEED2Ev(%"struct.std::__1::__split_buffer"* %tmp1) #12
  ret void
}
...
bb:
  ...
  %tmp3 = load %"class.std::__1::vector"*, %"class.std::__1::vector"** %tmp, align 8
  %tmp4 = bitcast %"class.std::__1::vector"* %tmp3 to %"class.std::__1::__vector_base"*
  %tmp5 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNKSt3__113__vector_baseIiNS_9allocatorIiEEE7__allocEv(%"class.std::__1::__vector_base"* %tmp4) #12
  %tmp6 = call i64 @_ZNSt3__116allocator_traitsINS_9allocatorIiEEE8max_sizeERKS2_(%"class.std::__1::allocator"* dereferenceable(1) %tmp5) #12
  store i64 %tmp6, i64* %tmp1, align 8
  %tmp7 = call i64 @_ZNSt3__114numeric_limitsIlE3maxEv() #12
...
bb:
  ...
  %tmp1 = load %"class.std::__1::vector"*, %"class.std::__1::vector"** %tmp, align 8
  %tmp2 = bitcast %"class.std::__1::vector"* %tmp1 to %"class.std::__1::__vector_base"*
  %tmp3 = call i64 @_ZNKSt3__113__vector_baseIiNS_9allocatorIiEEE8capacityEv(%"class.std::__1::__vector_base"* %tmp2) #12
  ret i64 %tmp3
}
...
bb:
  ...
  %tmp5 = call i64 @_ZNSt3__116allocator_traitsINS_9allocatorIiEEE10__max_sizeENS_17integral_constantIbLb1EEERKS2_(%"class.std::__1::allocator"* dereferenceable(1) %tmp4) #12
  ret i64 %tmp5
}
...
bb:
  ...
  %tmp1 = load %"class.std::__1::__vector_base"*, %"class.std::__1::__vector_base"** %tmp, align 8
  %tmp2 = getelementptr inbounds %"class.std::__1::__vector_base", %"class.std::__1::__vector_base"* %tmp1, i32 0, i32 2
  %tmp3 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNKSt3__117__compressed_pairIPiNS_9allocatorIiEEE6secondEv(%"class.std::__1::__compressed_pair"* %tmp2) #12
  ret %"class.std::__1::allocator"* %tmp3
}
...
bb:
  %tmp = call i64 @_ZNSt3__123__libcpp_numeric_limitsIlLb1EE3maxEv() #12
  ret i64 %tmp
}
...
bb:
  ...
  %tmp3 = call i64 @_ZNKSt3__19allocatorIiE8max_sizeEv(%"class.std::__1::allocator"* %tmp2) #12
  ret i64 %tmp3
}
...
bb:
  ...
  %tmp1 = load %"class.std::__1::__compressed_pair"*, %"class.std::__1::__compressed_pair"** %tmp, align 8
  %tmp2 = bitcast %"class.std::__1::__compressed_pair"* %tmp1 to %"struct.std::__1::__compressed_pair_elem.0"*
  %tmp3 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNKSt3__122__compressed_pair_elemINS_9allocatorIiEELi1ELb1EE5__getEv(%"struct.std::__1::__compressed_pair_elem.0"* %tmp2) #12
  ret %"class.std::__1::allocator"* %tmp3
}
...
bb:
  ...
  store %"class.std::__1::__vector_base"* %arg, %"class.std::__1::__vector_base"** %tmp, align 8
  %tmp1 = load %"class.std::__1::__vector_base"*, %"class.std::__1::__vector_base"** %tmp, align 8
  %tmp2 = call dereferenceable(8) i32** @_ZNKSt3__113__vector_baseIiNS_9allocatorIiEEE9__end_capEv(%"class.std::__1::__vector_base"* %tmp1) #12
  %tmp3 = load i32*, i32** %tmp2, align 8
...
bb:
  ...
  %tmp1 = load %"class.std::__1::__vector_base"*, %"class.std::__1::__vector_base"** %tmp, align 8
  %tmp2 = getelementptr inbounds %"class.std::__1::__vector_base", %"class.std::__1::__vector_base"* %tmp1, i32 0, i32 2
  %tmp3 = call dereferenceable(8) i32** @_ZNKSt3__117__compressed_pairIPiNS_9allocatorIiEEE5firstEv(%"class.std::__1::__compressed_pair"* %tmp2) #12
  ret i32** %tmp3
}
...
bb:
  ...
  %tmp1 = load %"class.std::__1::__compressed_pair"*, %"class.std::__1::__compressed_pair"** %tmp, align 8
  %tmp2 = bitcast %"class.std::__1::__compressed_pair"* %tmp1 to %"struct.std::__1::__compressed_pair_elem"*
  %tmp3 = call dereferenceable(8) i32** @_ZNKSt3__122__compressed_pair_elemIPiLi0ELb0EE5__getEv(%"struct.std::__1::__compressed_pair_elem"* %tmp2) #12
  ret i32** %tmp3
}
...
bb14:                                             ; preds = %bb
  %tmp15 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__114__split_bufferIiRNS_9allocatorIiEEE7__allocEv(%"struct.std::__1::__split_buffer"* %tmp8) #12
...
bb19:                                             ; preds = %bb18, %bb14
  ...
  %tmp32 = call dereferenceable(8) i32** @_ZNSt3__114__split_bufferIiRNS_9allocatorIiEEE9__end_capEv(%"struct.std::__1::__split_buffer"* %tmp8) #12
...
bb:
  ...
  %tmp3 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__117__compressed_pairIPiRNS_9allocatorIiEEE6secondEv(%"class.std::__1::__compressed_pair.2"* %tmp2) #12
  ret %"class.std::__1::allocator"* %tmp3
}
...
bb:
  ...
  %tmp1 = load %"struct.std::__1::__split_buffer"*, %"struct.std::__1::__split_buffer"** %tmp, align 8
  %tmp2 = getelementptr inbounds %"struct.std::__1::__split_buffer", %"struct.std::__1::__split_buffer"* %tmp1, i32 0, i32 3
  %tmp3 = call dereferenceable(8) i32** @_ZNSt3__117__compressed_pairIPiRNS_9allocatorIiEEE5firstEv(%"class.std::__1::__compressed_pair.2"* %tmp2) #12
  ret i32** %tmp3
}
...
bb:
  ...
  %tmp8 = call dereferenceable(8) i8** @_ZNSt3__17forwardIDnEEOT_RNS_16remove_referenceIS1_E4typeE(i8** dereferenceable(8) %tmp7) #12
  ...
  %tmp13 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__17forwardIRNS_9allocatorIiEEEEOT_RNS_16remove_referenceIS4_E4typeE(%"class.std::__1::allocator"* dereferenceable(1) %tmp12) #12
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr void @_ZNSt3__122__compressed_pair_elemIRNS_9allocatorIiEELi1ELb0EEC2IS3_vEEOT_(%"struct.std::__1::__compressed_pair_elem.3"* %arg, %"class.std::__1::allocator"* dereferenceable(1) %arg1) unnamed_addr #1 align 2 {
bb:
  ...
  %tmp6 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__17forwardIRNS_9allocatorIiEEEEOT_RNS_16remove_referenceIS4_E4typeE(%"class.std::__1::allocator"* dereferenceable(1) %tmp5) #12
...
bb:
  ...
  %tmp5 = load %"class.std::__1::allocator"*, %"class.std::__1::allocator"** %tmp, align 8
  %tmp6 = load i64, i64* %tmp3, align 8
  %tmp7 = call i64 @_ZNKSt3__19allocatorIiE8max_sizeEv(%"class.std::__1::allocator"* %tmp5) #12
...
bb:
  ...
  %tmp2 = alloca i32
  store i8* %arg, i8** %tmp, align 8
  %tmp3 = call i8* @__cxa_allocate_exception(i64 16) #12
...
bb:
  ...
  %tmp4 = call i8* @_Znwm(i64 %tmp3) #11
  ret i8* %tmp4
}
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr hidden dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__117__compressed_pairIPiRNS_9allocatorIiEEE6secondEv(%"class.std::__1::__compressed_pair.2"* %arg) #1 align 2 {
bb:
  %tmp = alloca %"class.std::__1::__compressed_pair.2"*, align 8
  store %"class.std::__1::__compressed_pair.2"* %arg, %"class.std::__1::__compressed_pair.2"** %tmp, align 8
  ...
  %tmp5 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__122__compressed_pair_elemIRNS_9allocatorIiEELi1ELb0EE5__getEv(%"struct.std::__1::__compressed_pair_elem.3"* %tmp4) #12
  ret %"class.std::__1::allocator"* %tmp5
}

; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr hidden dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__122__compressed_pair_elemIRNS_9allocatorIiEELi1ELb0EE5__getEv(%"struct.std::__1::__compressed_pair_elem.3"* %arg) #1 align 2 {
bb:
  %tmp = alloca %"struct.std::__1::__compressed_pair_elem.3"*, align 8
  store %"struct.std::__1::__compressed_pair_elem.3"* %arg, %"struct.std::__1::__compressed_pair_elem.3"** %tmp, align 8
...
; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr hidden dereferenceable(8) i32** @_ZNSt3__117__compressed_pairIPiRNS_9allocatorIiEEE5firstEv(%"class.std::__1::__compressed_pair.2"* %arg) #1 align 2 {
bb:
  %tmp = alloca %"class.std::__1::__compressed_pair.2"*, align 8
  store %"class.std::__1::__compressed_pair.2"* %arg, %"class.std::__1::__compressed_pair.2"** %tmp, align 8
  %tmp1 = load %"class.std::__1::__compressed_pair.2"*, %"class.std::__1::__compressed_pair.2"** %tmp, align 8
...
bb:
  ...
  store %"class.std::__1::vector"* %arg, %"class.std::__1::vector"** %tmp, align 8
  %tmp1 = load %"class.std::__1::vector"*, %"class.std::__1::vector"** %tmp, align 8
  %tmp2 = call i32* @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4dataEv(%"class.std::__1::vector"* %tmp1) #12
  %tmp3 = bitcast i32* %tmp2 to i8*
  %tmp4 = call i32* @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4dataEv(%"class.std::__1::vector"* %tmp1) #12
  %tmp5 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE8capacityEv(%"class.std::__1::vector"* %tmp1) #12
  %tmp6 = getelementptr inbounds i32, i32* %tmp4, i64 %tmp5
  %tmp7 = bitcast i32* %tmp6 to i8*
  %tmp8 = call i32* @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4dataEv(%"class.std::__1::vector"* %tmp1) #12
  %tmp9 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4sizeEv(%"class.std::__1::vector"* %tmp1) #12
  %tmp10 = getelementptr inbounds i32, i32* %tmp8, i64 %tmp9
  %tmp11 = bitcast i32* %tmp10 to i8*
  %tmp12 = call i32* @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4dataEv(%"class.std::__1::vector"* %tmp1) #12
  %tmp13 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE8capacityEv(%"class.std::__1::vector"* %tmp1) #12
  %tmp14 = getelementptr inbounds i32, i32* %tmp12, i64 %tmp13
  %tmp15 = bitcast i32* %tmp14 to i8*
  call void @_ZNKSt3__16vectorIiNS_9allocatorIiEEE31__annotate_contiguous_containerEPKvS5_S5_S5_(%"class.std::__1::vector"* %tmp1, i8* %tmp3, i8* %tmp7, i8* %tmp11, i8* %tmp15) #12
  ret void
}
...
bb:
  ...
  %tmp5 = call dereferenceable(8) i32** @_ZNSt3__14moveIRPiEEONS_16remove_referenceIT_E4typeEOS4_(i32** dereferenceable(8) %tmp4) #12
  %tmp6 = load i32*, i32** %tmp5, align 8
  store i32* %tmp6, i32** %tmp3, align 8
  %tmp7 = load i32**, i32*** %tmp2, align 8
  %tmp8 = call dereferenceable(8) i32** @_ZNSt3__14moveIRPiEEONS_16remove_referenceIT_E4typeEOS4_(i32** dereferenceable(8) %tmp7) #12
  %tmp9 = load i32*, i32** %tmp8, align 8
  %tmp10 = load i32**, i32*** %tmp, align 8
  store i32* %tmp9, i32** %tmp10, align 8
  %tmp11 = call dereferenceable(8) i32** @_ZNSt3__14moveIRPiEEONS_16remove_referenceIT_E4typeEOS4_(i32** dereferenceable(8) %tmp3) #12
  %tmp12 = load i32*, i32** %tmp11, align 8
...
bb:
  ...
  store i64 %arg1, i64* %tmp2, align 8
  %tmp3 = load %"class.std::__1::vector"*, %"class.std::__1::vector"** %tmp, align 8
  %tmp4 = call i32* @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4dataEv(%"class.std::__1::vector"* %tmp3) #12
  %tmp5 = bitcast i32* %tmp4 to i8*
  %tmp6 = call i32* @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4dataEv(%"class.std::__1::vector"* %tmp3) #12
  %tmp7 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE8capacityEv(%"class.std::__1::vector"* %tmp3) #12
  %tmp8 = getelementptr inbounds i32, i32* %tmp6, i64 %tmp7
  %tmp9 = bitcast i32* %tmp8 to i8*
  %tmp10 = call i32* @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4dataEv(%"class.std::__1::vector"* %tmp3) #12
  %tmp11 = call i64 @_ZNKSt3__16vectorIiNS_9allocatorIiEEE8capacityEv(%"class.std::__1::vector"* %tmp3) #12
  %tmp12 = getelementptr inbounds i32, i32* %tmp10, i64 %tmp11
  %tmp13 = bitcast i32* %tmp12 to i8*
  %tmp14 = call i32* @_ZNKSt3__16vectorIiNS_9allocatorIiEEE4dataEv(%"class.std::__1::vector"* %tmp3) #12
  %tmp15 = load i64, i64* %tmp2, align 8
  %tmp16 = getelementptr inbounds i32, i32* %tmp14, i64 %tmp15
  %tmp17 = bitcast i32* %tmp16 to i8*
  call void @_ZNKSt3__16vectorIiNS_9allocatorIiEEE31__annotate_contiguous_containerEPKvS5_S5_S5_(%"class.std::__1::vector"* %tmp3, i8* %tmp5, i8* %tmp9, i8* %tmp13, i8* %tmp17) #12
  ret void
}
...
bb:
  ...
  %tmp4 = load i32*, i32** %tmp3, align 8
  %tmp5 = call i32* @_ZNSt3__112__to_addressIiEEPT_S2_(i32* %tmp4) #12
  ret i32* %tmp5
}
...
bb:
  ...
  store %"struct.std::__1::__split_buffer"* %arg, %"struct.std::__1::__split_buffer"** %tmp, align 8
  %tmp1 = load %"struct.std::__1::__split_buffer"*, %"struct.std::__1::__split_buffer"** %tmp, align 8
  call void @_ZNSt3__114__split_bufferIiRNS_9allocatorIiEEE5clearEv(%"struct.std::__1::__split_buffer"* %tmp1) #12
...
bb5:                                              ; preds = %bb
  %tmp6 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__114__split_bufferIiRNS_9allocatorIiEEE7__allocEv(%"struct.std::__1::__split_buffer"* %tmp1) #12
...
bb10:                                             ; preds = %bb5
  call void @_ZNSt3__116allocator_traitsINS_9allocatorIiEEE10deallocateERS2_Pim(%"class.std::__1::allocator"* dereferenceable(1) %tmp6, i32* %tmp8, i64 %tmp9) #12
  br label %bb11
...
bb:
  ...
  %tmp3 = load i32*, i32** %tmp2, align 8
  call void @_ZNSt3__114__split_bufferIiRNS_9allocatorIiEEE17__destruct_at_endEPi(%"struct.std::__1::__split_buffer"* %tmp1, i32* %tmp3) #12
  ret void
}
...
bb:
  ...
  %tmp6 = load i32*, i32** %tmp3, align 8
  %tmp7 = load i64, i64* %tmp4, align 8
  call void @_ZNSt3__19allocatorIiE10deallocateEPim(%"class.std::__1::allocator"* %tmp5, i32* %tmp6, i64 %tmp7) #12
  ret void
}
...
bb:
  ...
  store %"struct.std::__1::__split_buffer"* %arg, %"struct.std::__1::__split_buffer"** %tmp, align 8
  %tmp1 = load %"struct.std::__1::__split_buffer"*, %"struct.std::__1::__split_buffer"** %tmp, align 8
  %tmp2 = call dereferenceable(8) i32** @_ZNKSt3__114__split_bufferIiRNS_9allocatorIiEEE9__end_capEv(%"struct.std::__1::__split_buffer"* %tmp1) #12
  %tmp3 = load i32*, i32** %tmp2, align 8
...
bb:
  ...
  call void @_ZNSt3__114__split_bufferIiRNS_9allocatorIiEEE17__destruct_at_endEPiNS_17integral_constantIbLb0EEE(%"struct.std::__1::__split_buffer"* %tmp4, i32* %tmp5) #12
  ret void
}
...
bb10:                                             ; preds = %bb5
  %tmp11 = call dereferenceable(1) %"class.std::__1::allocator"* @_ZNSt3__114__split_bufferIiRNS_9allocatorIiEEE7__allocEv(%"struct.std::__1::__split_buffer"* %tmp4) #12
  ...
  %tmp15 = call i32* @_ZNSt3__112__to_addressIiEEPT_S2_(i32* %tmp14) #12
...
bb:
  ...
  %tmp1 = load %"struct.std::__1::__split_buffer"*, %"struct.std::__1::__split_buffer"** %tmp, align 8
  %tmp2 = getelementptr inbounds %"struct.std::__1::__split_buffer", %"struct.std::__1::__split_buffer"* %tmp1, i32 0, i32 3
  %tmp3 = call dereferenceable(8) i32** @_ZNKSt3__117__compressed_pairIPiRNS_9allocatorIiEEE5firstEv(%"class.std::__1::__compressed_pair.2"* %tmp2) #12
  ret i32** %tmp3
}

; Function Attrs: noinline nounwind optnone ssp uwtable
define linkonce_odr hidden dereferenceable(8) i32** @_ZNKSt3__117__compressed_pairIPiRNS_9allocatorIiEEE5firstEv(%"class.std::__1::__compressed_pair.2"* %arg) #1 align 2 {
bb:
  %tmp = alloca %"class.std::__1::__compressed_pair.2"*, align 8
  store %"class.std::__1::__compressed_pair.2"* %arg, %"class.std::__1::__compressed_pair.2"** %tmp, align 8
  %tmp1 = load %"class.std::__1::__compressed_pair.2"*, %"class.std::__1::__compressed_pair.2"** %tmp, align 8
...
bb:
  ...
  %tmp11 = call i32* @_ZNSt3__112__to_addressIiEEPT_S2_(i32* %tmp10) #12
  %tmp12 = load i32*, i32** %tmp2, align 8
  %tmp13 = call dereferenceable(4) i32* @_ZNSt3__17forwardIRKiEEOT_RNS_16remove_referenceIS3_E4typeE(i32* dereferenceable(4) %tmp12) #12
...
bb:
  ...
  %tmp18 = call i32* @_ZNSt3__112__to_addressIiEEPT_S2_(i32* %tmp17) #12
  %tmp19 = load i32*, i32** %tmp2, align 8
  %tmp20 = call dereferenceable(4) i32* @_ZNSt3__17forwardIRKiEEOT_RNS_16remove_referenceIS3_E4typeE(i32* dereferenceable(4) %tmp19) #12
...
bb:
  ...
  %tmp9 = load i32*, i32** %tmp3, align 8
  %tmp10 = load i32*, i32** %tmp4, align 8
  %tmp11 = call dereferenceable(4) i32* @_ZNSt3__17forwardIRKiEEOT_RNS_16remove_referenceIS3_E4typeE(i32* dereferenceable(4) %tmp10) #12
...
bb:
  ...
  %tmp7 = load i32*, i32** %tmp4, align 8
  %tmp8 = load i32*, i32** %tmp5, align 8
  %tmp9 = call dereferenceable(4) i32* @_ZNSt3__17forwardIRKiEEOT_RNS_16remove_referenceIS3_E4typeE(i32* dereferenceable(4) %tmp8) #12
...
bb:
  ...
  %tmp8 = bitcast i8* %tmp7 to i32*
  %tmp9 = load i32*, i32** %tmp4, align 8
  %tmp10 = call dereferenceable(4) i32* @_ZNSt3__17forwardIRKiEEOT_RNS_16remove_referenceIS3_E4typeE(i32* dereferenceable(4) %tmp9) #12
  %tmp11 = load i32, i32* %tmp10, align 4
  store i32 %tmp11, i32* %tmp8, align 4
  ret void
}
...
bb:
  ...
  %tmp5 = load i32*, i32** %tmp3, align 8
  call void @_ZNSt3__111__wrap_iterIPiEC1ES1_(%"class.std::__1::__wrap_iter.1"* %tmp, i32* %tmp5) #12
...
bb:
  ...
  call void @_ZNSt3__111__wrap_iterIPiEC2ES1_(%"class.std::__1::__wrap_iter.1"* %tmp3, i32* %tmp4) #12
  ret void
}
...
bb12:                                             ; preds = %bb9
  call void @_ZNSt3__16localeD1Ev(%"class.std::__1::locale"* %tmp3) #12
  ret i8 %tmp11
}
...
attributes #4 = { nobuiltin "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #5 = { argmemonly nounwind willreturn }
attributes #6 = { noinline noreturn nounwind }
attributes #7 = { noreturn "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #8 = { noinline noreturn optnone ssp uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #9 = { nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
attributes #10 = { nobuiltin nounwind "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="all" "less-precise-fpmad"="false" "no-infs-fp-math"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="false" "stack-protector-buffer-size"="8" "target-cpu"="penryn" "target-features"="+cx16,+cx8,+fxsr,+mmx,+sahf,+sse,+sse2,+sse3,+sse4.1,+ssse3,+x87" "unsafe-fp-math"="false" "use-soft-float"="false" }
