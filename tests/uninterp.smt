...
(assert (not (=> (and (= test_bb (=> (and (and (= test_tmp3 test_arg) (= test_tmp4 test_arg) (= test_tmp8 (uninterp test_arg1 test_arg1)) (= test_tmp6 test_arg1) (= test_tmp7 test_arg1) (= test_tmp5 (uninterp test_arg test_arg))) (and true true)) (test (+ (uninterp test_arg test_arg) (uninterp test_arg1 test_arg1)) test_arg test_arg1)))) test_bb)))
