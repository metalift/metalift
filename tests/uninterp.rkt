...
(current-bitwidth 6)
(define (assertions)
 (assert (=> (&& (equal? test_bb (=> (&& (&& (equal? test_tmp3 test_arg ) (equal? test_tmp4 test_arg ) (equal? test_tmp8 (uninterp test_arg1 test_arg1) ) (equal? test_tmp6 test_arg1 ) (equal? test_tmp7 test_arg1 ) (equal? test_tmp5 (uninterp test_arg test_arg) ) ) (&& true true ) ) (test (+ (uninterp test_arg test_arg) (uninterp test_arg1 test_arg1) ) test_arg test_arg1) ) ) ) test_bb )))

(define sol
 (synthesize
 #:forall (list test_arg test_tmp3 test_tmp8 test_tmp4 test_arg1 test_tmp6 test_tmp7 test_tmp5 test_bb)
