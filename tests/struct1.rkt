...
(current-bitwidth 6)
(define (assertions)
 (assert (=> (&& (equal? test_bb (=> (&& (&& (equal? test_i4 test_arg ) (equal? test_i6 test_arg ) (equal? test_i5 test_arg1 ) (equal? test_i7 test_arg1 ) ) (&& true true true ) ) (test (+ test_arg test_arg1 ) test_arg test_arg1) ) ) ) test_bb )))

(define sol
 (synthesize
 #:forall (list test_arg1 test_i6 test_i4 test_i5 test_arg test_i7 test_bb)
