...
(define-grammar (fixed_select_two_args_gram int_x int_y)
 [rv (choose (if (< int_x int_y ) int_y int_x ))]
...
(define lighten_blend_8_rv (take (list lighten_blend_8_rv_BOUNDEDSET-0 lighten_blend_8_rv_BOUNDEDSET-1 lighten_blend_8_rv_BOUNDEDSET-2) lighten_blend_8_rv_BOUNDEDSET-len))
