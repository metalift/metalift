...
[v0 (choose (reduce_sum (list-slice-noerr input 1 i )) (reduce_mul (list-slice-noerr input 1 i )) (reduce_max (list-slice-noerr input 1 i )))]
)
...
[v1 (choose (list-slice-noerr input 1 max_pos ))]
)
