...
[v2 (choose (reduce_sum (list-slice-noerr input (v0) i )) (reduce_mul (list-slice-noerr input (v0) i )) (reduce_max (list-slice-noerr input (v0) i )))]
)

(define-grammar (softmax_part1_ps_gram input max_pos softmax_part1_rv)
 [rv (choose (equal? softmax_part1_rv (v0) ))]
[v0 (choose (reduce_sum (list-slice-noerr input (v1) (v2) )) (reduce_mul (list-slice-noerr input (v1) (v2) )) (reduce_max (list-slice-noerr input (v1) (v2) )))]
[v1 (choose 0 1 2)]
[v2 (choose max_pos (- max_pos 1 ) (+ max_pos 1 ))]
)
