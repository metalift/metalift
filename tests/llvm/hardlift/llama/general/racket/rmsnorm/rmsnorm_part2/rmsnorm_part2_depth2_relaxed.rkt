...
[v6 (choose 0 (length input ) i 1 ss)]
[v7 (choose (integer-sqrt-noerr (v5) ) (integer-exp-noerr (v5) ) (+ (v5) (v5) ) (- (v5) (v5) ) (* (v5) (v5) ) (quotient-noerr (v5) (v5) ))]
[v8 (choose (integer-sqrt-noerr (v7) ) (integer-exp-noerr (v7) ) (+ (v7) (v5) ) (- (v7) (v5) ) (* (v7) (v5) ) (quotient-noerr (v7) (v5) ) (- (v5) (v7) ) (quotient-noerr (v5) (v7) ) (+ (v7) (v7) ) (- (v7) (v7) ) (* (v7) (v7) ) (quotient-noerr (v7) (v7) ))]
[v9 (choose (v10) (vec_elemwise_add (v3) (v3)) (vec_elemwise_sub (v3) (v3)) (vec_elemwise_mul (v3) (v3)) (vec_elemwise_div (v3) (v3)) (vec_scalar_add (v11) (v3)) (vec_scalar_sub (v11) (v3)) (vec_scalar_mul (v11) (v3)) (vec_scalar_div (v11) (v3)) (scalar_vec_sub (v11) (v3)) (scalar_vec_div (v11) (v3)))]
[v10 (choose (vec_map (v3) map_int_to_int))]
[v11 (choose 1 ss (length input ))]
[v12 (choose (v13) (vec_elemwise_add (v9) (v3)) (vec_elemwise_sub (v9) (v3)) (vec_elemwise_mul (v9) (v3)) (vec_elemwise_div (v9) (v3)) (vec_scalar_add (v11) (v9)) (vec_scalar_sub (v11) (v9)) (vec_scalar_mul (v11) (v9)) (vec_scalar_div (v11) (v9)) (scalar_vec_sub (v11) (v9)) (scalar_vec_div (v11) (v9)) (vec_elemwise_sub (v3) (v9)) (vec_elemwise_div (v3) (v9)) (vec_scalar_add (v14) (v3)) (vec_scalar_sub (v14) (v3)) (vec_scalar_mul (v14) (v3)) (vec_scalar_div (v14) (v3)) (scalar_vec_sub (v14) (v3)) (scalar_vec_div (v14) (v3)) (vec_elemwise_add (v9) (v9)) (vec_elemwise_sub (v9) (v9)) (vec_elemwise_mul (v9) (v9)) (vec_elemwise_div (v9) (v9)) (vec_scalar_add (v14) (v9)) (vec_scalar_sub (v14) (v9)) (vec_scalar_mul (v14) (v9)) (vec_scalar_div (v14) (v9)) (scalar_vec_sub (v14) (v9)) (scalar_vec_div (v14) (v9)))]
[v13 (choose (vec_map (v9) map_int_to_int))]
[v14 (choose (integer-sqrt-noerr (v11) ) (integer-exp-noerr (v11) ) (+ (v11) (v11) ) (- (v11) (v11) ) (* (v11) (v11) ) (quotient-noerr (v11) (v11) ))]
)
...
[v6 (choose (integer-sqrt-noerr (v5) ) (integer-exp-noerr (v5) ) (+ (v5) (v3) ) (- (v5) (v3) ) (* (v5) (v3) ) (quotient-noerr (v5) (v3) ) (- (v3) (v5) ) (quotient-noerr (v3) (v5) ) (+ (v5) (v5) ) (- (v5) (v5) ) (* (v5) (v5) ) (quotient-noerr (v5) (v5) ))]
[v7 (choose (v8) (vec_elemwise_add (v1) (v1)) (vec_elemwise_sub (v1) (v1)) (vec_elemwise_mul (v1) (v1)) (vec_elemwise_div (v1) (v1)) (vec_scalar_add (v9) (v1)) (vec_scalar_sub (v9) (v1)) (vec_scalar_mul (v9) (v1)) (vec_scalar_div (v9) (v1)) (scalar_vec_sub (v9) (v1)) (scalar_vec_div (v9) (v1)))]
[v8 (choose (vec_map (v1) map_int_to_int))]
[v9 (choose 1 ss (length input ))]
[v10 (choose (v11) (vec_elemwise_add (v7) (v1)) (vec_elemwise_sub (v7) (v1)) (vec_elemwise_mul (v7) (v1)) (vec_elemwise_div (v7) (v1)) (vec_scalar_add (v9) (v7)) (vec_scalar_sub (v9) (v7)) (vec_scalar_mul (v9) (v7)) (vec_scalar_div (v9) (v7)) (scalar_vec_sub (v9) (v7)) (scalar_vec_div (v9) (v7)) (vec_elemwise_sub (v1) (v7)) (vec_elemwise_div (v1) (v7)) (vec_scalar_add (v12) (v1)) (vec_scalar_sub (v12) (v1)) (vec_scalar_mul (v12) (v1)) (vec_scalar_div (v12) (v1)) (scalar_vec_sub (v12) (v1)) (scalar_vec_div (v12) (v1)) (vec_elemwise_add (v7) (v7)) (vec_elemwise_sub (v7) (v7)) (vec_elemwise_mul (v7) (v7)) (vec_elemwise_div (v7) (v7)) (vec_scalar_add (v12) (v7)) (vec_scalar_sub (v12) (v7)) (vec_scalar_mul (v12) (v7)) (vec_scalar_div (v12) (v7)) (scalar_vec_sub (v12) (v7)) (scalar_vec_div (v12) (v7)))]
[v11 (choose (vec_map (v7) map_int_to_int))]
[v12 (choose (integer-sqrt-noerr (v9) ) (integer-exp-noerr (v9) ) (+ (v9) (v9) ) (- (v9) (v9) ) (* (v9) (v9) ) (quotient-noerr (v9) (v9) ))]
)
