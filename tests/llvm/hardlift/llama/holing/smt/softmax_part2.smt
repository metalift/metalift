...
(define-fun-rec softmax_part2_inv0 ((agg.result (MLList Int)) (cur Int) (i Int) (input (MLList Int)) (max_pos Int) (max_val Int)) Bool
(and (and (>= i 0) (<= i max_pos)) (= agg.result (vec_map (vec_scalar_sub max_val (list_take input i))))))



(define-fun-rec softmax_part2_ps ((input (MLList Int)) (max_pos Int) (max_val Int) (softmax_part2_rv (MLList Int))) Bool
(= softmax_part2_rv (vec_map (vec_scalar_sub max_val (list_take input max_pos)))))
...
(declare-const i Int)
(declare-const softmax_part2_rv (MLList Int))
(declare-const max_val Int)



(assert (not (and (and (=> (and (and (> (list_length input) 0) (<= max_pos (list_length input))) (>= max_pos 1)) (softmax_part2_inv0 list_empty 0 0 input max_pos max_val)) (=> (and (and (and (and (< i max_pos) (> (list_length input) 0)) (<= max_pos (list_length input))) (>= max_pos 1)) (softmax_part2_inv0 agg.result cur i input max_pos max_val)) (softmax_part2_inv0 (list_append agg.result (integer_exp (- (list_get input i) max_val))) (integer_exp (- (list_get input i) max_val)) (+ i 1) input max_pos max_val))) (=> (or (and (and (and (and (not (< i max_pos)) (> (list_length input) 0)) (<= max_pos (list_length input))) (>= max_pos 1)) (softmax_part2_inv0 agg.result cur i input max_pos max_val)) (and (and (and (and (and (not true) (not (< i max_pos))) (> (list_length input) 0)) (<= max_pos (list_length input))) (>= max_pos 1)) (softmax_part2_inv0 agg.result cur i input max_pos max_val))) (softmax_part2_ps input max_pos max_val agg.result)))))
