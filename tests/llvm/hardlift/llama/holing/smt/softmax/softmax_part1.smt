...
(define-fun-rec reduce_max ((x (MLList Int))) Int
(ite (<= (list_length x) 1) (list_get x 0) (ite (> (list_get x 0) (reduce_max (list_tail x 1))) (list_get x 0) (reduce_max (list_tail x 1)))))

(define-fun-rec softmax_part1_ps ((input (MLList Int)) (max_pos Int) (softmax_part1_rv Int)) Bool
(= softmax_part1_rv (reduce_max (list_slice input 0 max_pos))))



(define-fun-rec softmax_part1_inv0 ((i Int) (input (MLList Int)) (max_pos Int) (max_val Int)) Bool
(and (and (>= i 1) (<= i max_pos)) (= max_val (reduce_max (list_slice input 0 i)))))

(declare-const max_pos Int)
(declare-const input (MLList Int))
(declare-const max_val Int)
(declare-const softmax_part1_rv Int)
(declare-const i Int)



(assert (not (and (and (=> (and (and (> (list_length input) 0) (<= max_pos (list_length input))) (>= max_pos 1)) (softmax_part1_inv0 1 input max_pos (list_get input 0))) (=> (or (and (and (and (and (< i max_pos) (> (list_length input) 0)) (<= max_pos (list_length input))) (>= max_pos 1)) (softmax_part1_inv0 i input max_pos max_val)) (and (and (and (and (and (> (list_get input i) max_val) (< i max_pos)) (> (list_length input) 0)) (<= max_pos (list_length input))) (>= max_pos 1)) (softmax_part1_inv0 i input max_pos max_val))) (softmax_part1_inv0 (+ i 1) input max_pos (ite (and (and (and (and (and (> (list_get input i) max_val) (< i max_pos)) (> (list_length input) 0)) (<= max_pos (list_length input))) (>= max_pos 1)) (softmax_part1_inv0 i input max_pos max_val)) (list_get input i) max_val)))) (=> (and (and (and (and (not (< i max_pos)) (> (list_length input) 0)) (<= max_pos (list_length input))) (>= max_pos 1)) (softmax_part1_inv0 i input max_pos max_val)) (softmax_part1_ps input max_pos max_val)))))
