...
(define-fun-rec rmsnorm_part2_inv0 ((agg.result (MLList Int)) (i Int) (input (MLList Int)) (ref.tmp Int) (ss Int) (weight (MLList Int))) Bool
(and (and (>= i 0) (<= i (list_length input))) (= agg.result (vec_scalar_mul (div 1 (integer_sqrt (+ (div ss ss) 1))) (vec_elemwise_mul (list_take input i) (list_take weight i))))))



(define-fun-rec rmsnorm_part2_ps ((input (MLList Int)) (weight (MLList Int)) (ss Int) (rmsnorm_part2_rv (MLList Int))) Bool
(= rmsnorm_part2_rv (vec_scalar_mul (div 1 (integer_sqrt (+ (div ss ss) 1))) (vec_elemwise_mul input weight))))
...
(declare-const rmsnorm_part2_rv (MLList Int))



(assert (not (and (and (=> (and (= (list_length input) (list_length weight)) (> (list_length input) 0)) (rmsnorm_part2_inv0 list_empty 0 input 0 ss weight)) (=> (and (and (and (< i (list_length input)) (= (list_length input) (list_length weight))) (> (list_length input) 0)) (rmsnorm_part2_inv0 agg.result i input ref.tmp ss weight)) (rmsnorm_part2_inv0 (list_append agg.result (* (* (div 1 (integer_sqrt (+ (div ss (list_length input)) 1))) (list_get input i)) (list_get weight i))) (+ i 1) input (* (* (div 1 (integer_sqrt (+ (div ss (list_length input)) 1))) (list_get input i)) (list_get weight i)) ss weight))) (=> (or (and (and (and (not (< i (list_length input))) (= (list_length input) (list_length weight))) (> (list_length input) 0)) (rmsnorm_part2_inv0 agg.result i input ref.tmp ss weight)) (and (and (and (and (not true) (not (< i (list_length input)))) (= (list_length input) (list_length weight))) (> (list_length input) 0)) (rmsnorm_part2_inv0 agg.result i input ref.tmp ss weight))) (rmsnorm_part2_ps input weight ss agg.result)))))
