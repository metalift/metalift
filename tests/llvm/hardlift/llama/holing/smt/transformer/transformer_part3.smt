...
(define-fun-rec map_int_to_int ((int_x Int)) Int
(integer_exp int_x))

(define-fun-rec vec_map ((x (MLList Int))) (MLList Int)
(ite (< (list_length x) 1) list_empty (list_prepend (map_int_to_int (list_get x 0)) (vec_map (list_tail x 1)))))

(define-fun-rec transformer_part3_inv0 ((agg.result (MLList Int)) (curr Int) (hidden_dim Int) (i Int) (input (MLList Int))) Bool
(and (and (>= i 0) (<= i hidden_dim)) (= agg.result (vec_elemwise_mul (list_take input i) (scalar_vec_div 1 (vec_scalar_add 1 (vec_map (scalar_vec_sub 0 (list_take input i)))))))))



(define-fun-rec transformer_part3_ps ((input (MLList Int)) (hidden_dim Int) (transformer_part3_rv (MLList Int))) Bool
(= transformer_part3_rv (vec_elemwise_mul (list_take input hidden_dim) (scalar_vec_div 1 (vec_scalar_add 1 (vec_map (scalar_vec_sub 0 (list_take input hidden_dim))))))))
...
(declare-const transformer_part3_rv (MLList Int))



(assert (not (and (and (=> (and (>= hidden_dim 0) (>= (list_length input) hidden_dim)) (transformer_part3_inv0 list_empty 0 hidden_dim 0 input)) (=> (and (and (and (< i hidden_dim) (>= hidden_dim 0)) (>= (list_length input) hidden_dim)) (transformer_part3_inv0 agg.result curr hidden_dim i input)) (transformer_part3_inv0 (list_append agg.result (* (list_get input i) (div 1 (+ 1 (integer_exp (- 0 (list_get input i))))))) (* (list_get input i) (div 1 (+ 1 (integer_exp (- 0 (list_get input i)))))) hidden_dim (+ i 1) input))) (=> (or (and (and (and (not (< i hidden_dim)) (>= hidden_dim 0)) (>= (list_length input) hidden_dim)) (transformer_part3_inv0 agg.result curr hidden_dim i input)) (and (and (and (and (not true) (not (< i hidden_dim))) (>= hidden_dim 0)) (>= (list_length input) hidden_dim)) (transformer_part3_inv0 agg.result curr hidden_dim i input))) (transformer_part3_ps input hidden_dim agg.result)))))
