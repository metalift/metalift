...
(define-symbolic output_BOUNDEDSET-2 integer?)
(define-symbolic output_BOUNDEDSET-3 integer?)
(define-symbolic output_BOUNDEDSET-4 integer?)
(define output (take (list output_BOUNDEDSET-0 output_BOUNDEDSET-1 output_BOUNDEDSET-2 output_BOUNDEDSET-3 output_BOUNDEDSET-4) output_BOUNDEDSET-len))
...
(define (assertions)
 (assert (&& (&& (=> (&& (&& (> (length output ) 0 ) (<= max_pos (length output ) ) ) (>= max_pos 1 ) ) (softmax_part3_inv0 0 max_pos output 0) ) (=> (&& (&& (&& (&& (< i max_pos ) (> (length output ) 0 ) ) (<= max_pos (length output ) ) ) (>= max_pos 1 ) ) (softmax_part3_inv0 i max_pos output sum) ) (softmax_part3_inv0 (+ i 1 ) max_pos output (+ sum (list-ref-noerr output i ) )) ) ) (=> (&& (&& (&& (&& (! (< i max_pos ) ) (> (length output ) 0 ) ) (<= max_pos (length output ) ) ) (>= max_pos 1 ) ) (softmax_part3_inv0 i max_pos output sum) ) (softmax_part3_ps output max_pos sum) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list i max_pos output_BOUNDEDSET-len output_BOUNDEDSET-0 output_BOUNDEDSET-1 output_BOUNDEDSET-2 output_BOUNDEDSET-3 output_BOUNDEDSET-4 softmax_part3_rv sum)
