...
(define-symbolic transformer_part3_rv_BOUNDEDSET-4 integer?)
(define transformer_part3_rv (take (list transformer_part3_rv_BOUNDEDSET-0 transformer_part3_rv_BOUNDEDSET-1 transformer_part3_rv_BOUNDEDSET-2 transformer_part3_rv_BOUNDEDSET-3 transformer_part3_rv_BOUNDEDSET-4) transformer_part3_rv_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
 (assert (&& (&& (=> (&& (>= hidden_dim 0 ) (>= (length input ) hidden_dim ) ) (transformer_part3_inv0 (list-empty ) 0 hidden_dim 0 input) ) (=> (&& (&& (&& (< i hidden_dim ) (>= hidden_dim 0 ) ) (>= (length input ) hidden_dim ) ) (transformer_part3_inv0 agg.result curr hidden_dim i input) ) (transformer_part3_inv0 (list-append agg.result (* (list-ref-noerr input i ) (quotient-noerr 1 (+ 1 (integer-exp-noerr (- 0 (list-ref-noerr input i ) ) ) ) ) ) ) (* (list-ref-noerr input i ) (quotient-noerr 1 (+ 1 (integer-exp-noerr (- 0 (list-ref-noerr input i ) ) ) ) ) ) hidden_dim (+ i 1 ) input) ) ) (=> (or (&& (&& (&& (! (< i hidden_dim ) ) (>= hidden_dim 0 ) ) (>= (length input ) hidden_dim ) ) (transformer_part3_inv0 agg.result curr hidden_dim i input) ) (&& (&& (&& (&& (! true ) (! (< i hidden_dim ) ) ) (>= hidden_dim 0 ) ) (>= (length input ) hidden_dim ) ) (transformer_part3_inv0 agg.result curr hidden_dim i input) ) ) (transformer_part3_ps input hidden_dim agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 agg.result_BOUNDEDSET-4 curr hidden_dim i input_BOUNDEDSET-len input_BOUNDEDSET-0 input_BOUNDEDSET-1 input_BOUNDEDSET-2 input_BOUNDEDSET-3 input_BOUNDEDSET-4 transformer_part3_rv_BOUNDEDSET-len transformer_part3_rv_BOUNDEDSET-0 transformer_part3_rv_BOUNDEDSET-1 transformer_part3_rv_BOUNDEDSET-2 transformer_part3_rv_BOUNDEDSET-3 transformer_part3_rv_BOUNDEDSET-4)
