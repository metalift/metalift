...
(define input1 (take (list input1_BOUNDEDSET-0 input1_BOUNDEDSET-1 input1_BOUNDEDSET-2 input1_BOUNDEDSET-3) input1_BOUNDEDSET-len))
...
(define input2 (take (list input2_BOUNDEDSET-0 input2_BOUNDEDSET-1 input2_BOUNDEDSET-2 input2_BOUNDEDSET-3) input2_BOUNDEDSET-len))
...
(define transformer_part4_rv (take (list transformer_part4_rv_BOUNDEDSET-0 transformer_part4_rv_BOUNDEDSET-1 transformer_part4_rv_BOUNDEDSET-2 transformer_part4_rv_BOUNDEDSET-3) transformer_part4_rv_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
 (assert (&& (&& (=> (&& (&& (>= hidden_dim 0 ) (>= (length input1 ) hidden_dim ) ) (>= (length input2 ) hidden_dim ) ) (transformer_part4_inv0 (list-empty ) hidden_dim 0 input1 input2 0) ) (=> (&& (&& (&& (&& (< i hidden_dim ) (>= hidden_dim 0 ) ) (>= (length input1 ) hidden_dim ) ) (>= (length input2 ) hidden_dim ) ) (transformer_part4_inv0 agg.result hidden_dim i input1 input2 ref.tmp) ) (transformer_part4_inv0 (list-append agg.result (* (list-ref-noerr input1 i ) (list-ref-noerr input2 i ) ) ) hidden_dim (+ i 1 ) input1 input2 (* (list-ref-noerr input1 i ) (list-ref-noerr input2 i ) )) ) ) (=> (or (&& (&& (&& (&& (! (< i hidden_dim ) ) (>= hidden_dim 0 ) ) (>= (length input1 ) hidden_dim ) ) (>= (length input2 ) hidden_dim ) ) (transformer_part4_inv0 agg.result hidden_dim i input1 input2 ref.tmp) ) (&& (&& (&& (&& (&& (! true ) (! (< i hidden_dim ) ) ) (>= hidden_dim 0 ) ) (>= (length input1 ) hidden_dim ) ) (>= (length input2 ) hidden_dim ) ) (transformer_part4_inv0 agg.result hidden_dim i input1 input2 ref.tmp) ) ) (transformer_part4_ps input1 input2 hidden_dim agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 hidden_dim i input1_BOUNDEDSET-len input1_BOUNDEDSET-0 input1_BOUNDEDSET-1 input1_BOUNDEDSET-2 input1_BOUNDEDSET-3 input2_BOUNDEDSET-len input2_BOUNDEDSET-0 input2_BOUNDEDSET-1 input2_BOUNDEDSET-2 input2_BOUNDEDSET-3 ref.tmp transformer_part4_rv_BOUNDEDSET-len transformer_part4_rv_BOUNDEDSET-0 transformer_part4_rv_BOUNDEDSET-1 transformer_part4_rv_BOUNDEDSET-2 transformer_part4_rv_BOUNDEDSET-3)
