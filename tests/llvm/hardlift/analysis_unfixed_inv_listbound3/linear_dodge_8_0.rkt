...
(define-grammar (linear_dodge_8_inv1_gram active base col pixel row_vec agg.result row)
 [rv (choose (&& (&& (&& (&& (&& (v0) (v2) ) (v4) ) (v5) ) (equal? row_vec (v6) ) ) (equal? agg.result (v8) ) ))]
[v0 (choose (>= row (v1) ) (> row (v1) ) (equal? row (v1) ) (< row (v1) ) (<= row (v1) ))]
[v1 (choose 0 1)]
[v2 (choose (>= row (v3) ) (> row (v3) ) (equal? row (v3) ) (< row (v3) ) (<= row (v3) ))]
[v3 (choose (length base ) (length (list-list-ref-noerr base 0 ) ))]
...
[v7 (choose (list-take-noerr (list-list-ref-noerr base 0 ) col ) (list-take-noerr (list-list-ref-noerr base row ) col ) (list-take-noerr (list-list-ref-noerr base col ) row ) (list-take-noerr (list-list-ref-noerr base 0 ) row ) (list-take-noerr (list-list-ref-noerr active 0 ) col ) (list-take-noerr (list-list-ref-noerr active row ) col ) (list-take-noerr (list-list-ref-noerr active col ) row ) (list-take-noerr (list-list-ref-noerr active 0 ) row ) row_vec)]
[v8 (choose (v9) (nested_list_elemwise_add (v9) (v9)))]
[v9 (choose base (list-take-noerr base row ) (list-take-noerr base col ) active (list-take-noerr active row ) (list-take-noerr active col ))]
)
...
(define linear_dodge_8_rv (take (list linear_dodge_8_rv_BOUNDEDSET-0 linear_dodge_8_rv_BOUNDEDSET-1 linear_dodge_8_rv_BOUNDEDSET-2) linear_dodge_8_rv_BOUNDEDSET-len))
