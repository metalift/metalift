...
(ite (or (< (list_list_length matrix_x) 1) (not (= (list_list_length matrix_x) (list_list_length matrix_y)))) list_list_empty (list_list_prepend (dissolve_selection_two_args (list_list_get matrix_x 0) (list_list_get matrix_y 0) opacity rand_cons) (dissolve_matrix_selection_two_args (list_list_tail matrix_x 1) (list_list_tail matrix_y 1) opacity rand_cons))))
...
(and (and (>= row 0) (<= row (list_list_length base))) (= agg.result (dissolve_matrix_selection_two_args (ite OUTER_LOOP_INDEX_FIRST (list_list_take base row) (list_list_col_slice active 0 row)) (ite OUTER_LOOP_INDEX_FIRST (list_list_take active row) (list_list_col_slice active 0 row)) opacity rand_cons))))
...
(and (and (and (and (and (>= row 0) (<= row (list_list_length base))) (>= col 0)) (<= col (list_length (list_list_get base 0)))) (= row_vec (dissolve_selection_two_args (ite OUTER_LOOP_INDEX_FIRST (list_take (list_list_get base row) col) (list_list_get (matrix_transpose (list_list_col_slice_with_length (list_list_take active col) row 1)) 0)) (ite OUTER_LOOP_INDEX_FIRST (list_take (list_list_get active row) col) (list_list_get (matrix_transpose (list_list_col_slice_with_length (list_list_take active col) row 1)) 0)) opacity rand_cons))) (= agg.result (dissolve_matrix_selection_two_args (ite OUTER_LOOP_INDEX_FIRST (list_list_take base row) (list_list_col_slice active 0 row)) (ite OUTER_LOOP_INDEX_FIRST (list_list_take active row) (list_list_col_slice active 0 row)) opacity rand_cons))))
...
(assert (not (and (and (and (and (=> (and (and (> (list_list_length base) 1) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (dissolve_blend_8_inv0 active list_list_empty base 0 opacity 0 rand_cons 0 0 list_empty)) (=> (and (and (and (and (< row (list_list_length base)) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (dissolve_blend_8_inv0 active agg.result base col opacity pixel rand_cons rand_val row row_vec)) (dissolve_blend_8_inv1 active base 0 opacity pixel rand_cons rand_val list_empty agg.result row))) (=> (or (and (and (and (and (and (and (and (>= (- opacity (div (+ (mod rand_cons 100) 1) 100)) 0) (< col (list_length (list_list_get base 0)))) (< row (list_list_length base))) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (dissolve_blend_8_inv0 active agg.result base col opacity pixel rand_cons rand_val row row_vec)) (dissolve_blend_8_inv1 active base col opacity pixel rand_cons rand_val row_vec agg.result row)) (and (and (and (and (and (and (and (not (>= (- opacity (div (+ (mod rand_cons 100) 1) 100)) 0)) (< col (list_length (list_list_get base 0)))) (< row (list_list_length base))) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (dissolve_blend_8_inv0 active agg.result base col opacity pixel rand_cons rand_val row row_vec)) (dissolve_blend_8_inv1 active base col opacity pixel rand_cons rand_val row_vec agg.result row))) (dissolve_blend_8_inv1 active base (+ col 1) opacity (ite (and (and (and (and (and (and (and (not (>= (- opacity (div (+ (mod rand_cons 100) 1) 100)) 0)) (< col (list_length (list_list_get base 0)))) (< row (list_list_length base))) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (dissolve_blend_8_inv0 active agg.result base col opacity pixel rand_cons rand_val row row_vec)) (dissolve_blend_8_inv1 active base col opacity pixel rand_cons rand_val row_vec agg.result row)) (list_get (list_list_get base row) col) (list_get (list_list_get active row) col)) rand_cons (div (+ (mod rand_cons 100) 1) 100) (list_append row_vec (ite (and (and (and (and (and (and (and (not (>= (- opacity (div (+ (mod rand_cons 100) 1) 100)) 0)) (< col (list_length (list_list_get base 0)))) (< row (list_list_length base))) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (dissolve_blend_8_inv0 active agg.result base col opacity pixel rand_cons rand_val row row_vec)) (dissolve_blend_8_inv1 active base col opacity pixel rand_cons rand_val row_vec agg.result row)) (list_get (list_list_get base row) col) (list_get (list_list_get active row) col))) agg.result row))) (=> (and (and (and (and (and (and (not (< col (list_length (list_list_get base 0)))) (< row (list_list_length base))) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (dissolve_blend_8_inv0 active agg.result base col opacity pixel rand_cons rand_val row row_vec)) (dissolve_blend_8_inv1 active base col opacity pixel rand_cons rand_val row_vec agg.result row)) (dissolve_blend_8_inv0 active (list_list_append agg.result row_vec) base col opacity pixel rand_cons rand_val (+ row 1) row_vec))) (=> (or (and (and (and (and (not (< row (list_list_length base))) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (dissolve_blend_8_inv0 active agg.result base col opacity pixel rand_cons rand_val row row_vec)) (and (and (and (and (and (not true) (not (< row (list_list_length base)))) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (dissolve_blend_8_inv0 active agg.result base col opacity pixel rand_cons rand_val row row_vec))) (dissolve_blend_8_ps base active opacity rand_cons agg.result)))))
