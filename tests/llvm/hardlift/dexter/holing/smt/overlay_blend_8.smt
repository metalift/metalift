...
(and (and (>= row 0) (<= row (list_list_length base))) (= agg.result (matrix_selection_two_args (ite OUTER_LOOP_INDEX_FIRST (list_list_take base row) (list_list_col_slice active 0 row)) (ite OUTER_LOOP_INDEX_FIRST (list_list_take base row) (list_list_col_slice active 0 row))))))
