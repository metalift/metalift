...
(and (and (>= row 0) (<= row (list_list_length base))) (= agg.result (matrix_scalar_div 32 (matrix_elemwise_mul (ite OUTER_LOOP_INDEX_FIRST (list_list_take base row) (list_list_col_slice base 0 row)) (ite OUTER_LOOP_INDEX_FIRST (list_list_take active row) (list_list_col_slice base 0 row)))))))
