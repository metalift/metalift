...
(define normal_blend_f_rv (take (list normal_blend_f_rv_BOUNDEDSET-0 normal_blend_f_rv_BOUNDEDSET-1 normal_blend_f_rv_BOUNDEDSET-2 normal_blend_f_rv_BOUNDEDSET-3) normal_blend_f_rv_BOUNDEDSET-len))
