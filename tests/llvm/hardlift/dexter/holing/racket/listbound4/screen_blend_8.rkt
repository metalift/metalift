...
(define screen_blend_8_rv (take (list screen_blend_8_rv_BOUNDEDSET-0 screen_blend_8_rv_BOUNDEDSET-1 screen_blend_8_rv_BOUNDEDSET-2 screen_blend_8_rv_BOUNDEDSET-3) screen_blend_8_rv_BOUNDEDSET-len))
(current-bitwidth 6)
(define (assertions)
