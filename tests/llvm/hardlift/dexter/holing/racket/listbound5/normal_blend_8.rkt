...
(define-symbolic normal_blend_8_rv_BOUNDEDSET-4 integer?)
(define normal_blend_8_rv (take (list normal_blend_8_rv_BOUNDEDSET-0 normal_blend_8_rv_BOUNDEDSET-1 normal_blend_8_rv_BOUNDEDSET-2 normal_blend_8_rv_BOUNDEDSET-3 normal_blend_8_rv_BOUNDEDSET-4) normal_blend_8_rv_BOUNDEDSET-len))
...
(define (assertions)
 (assert (&& (&& (=> (&& (equal? (length base ) (length active ) ) (> (length base ) 0 ) ) (normal_blend_8_inv0 active (list-empty ) base 0 opacity 0) ) (=> (&& (&& (&& (< i (length base ) ) (equal? (length base ) (length active ) ) ) (> (length base ) 0 ) ) (normal_blend_8_inv0 active agg.result base i opacity ref.tmp) ) (normal_blend_8_inv0 active (list-append agg.result (+ (* opacity (list-ref-noerr active i ) ) (* (- 255 opacity ) (list-ref-noerr base i ) ) ) ) base (+ i 1 ) opacity (+ (* opacity (list-ref-noerr active i ) ) (* (- 255 opacity ) (list-ref-noerr base i ) ) )) ) ) (=> (or (&& (&& (&& (! (< i (length base ) ) ) (equal? (length base ) (length active ) ) ) (> (length base ) 0 ) ) (normal_blend_8_inv0 active agg.result base i opacity ref.tmp) ) (&& (&& (&& (&& (! true ) (! (< i (length base ) ) ) ) (equal? (length base ) (length active ) ) ) (> (length base ) 0 ) ) (normal_blend_8_inv0 active agg.result base i opacity ref.tmp) ) ) (normal_blend_8_ps base active opacity agg.result) ) )))
    ...
    (define sol0
        (synthesize
            #:forall (list active_BOUNDEDSET-len active_BOUNDEDSET-0 active_BOUNDEDSET-1 active_BOUNDEDSET-2 active_BOUNDEDSET-3 active_BOUNDEDSET-4 agg.result_BOUNDEDSET-len agg.result_BOUNDEDSET-0 agg.result_BOUNDEDSET-1 agg.result_BOUNDEDSET-2 agg.result_BOUNDEDSET-3 agg.result_BOUNDEDSET-4 base_BOUNDEDSET-len base_BOUNDEDSET-0 base_BOUNDEDSET-1 base_BOUNDEDSET-2 base_BOUNDEDSET-3 base_BOUNDEDSET-4 i normal_blend_8_rv_BOUNDEDSET-len normal_blend_8_rv_BOUNDEDSET-0 normal_blend_8_rv_BOUNDEDSET-1 normal_blend_8_rv_BOUNDEDSET-2 normal_blend_8_rv_BOUNDEDSET-3 normal_blend_8_rv_BOUNDEDSET-4 opacity ref.tmp)
