...
(define-grammar (linear_dodge_8_inv1_gram active base col pixel row_vec agg.result row)
 [rv (choose (&& (&& (&& (&& (&& (>= row 0 ) (<= row (list-list-length base ) ) ) (>= col 0 ) ) (<= col (length (list-list-ref-noerr base 0 ) ) ) ) (equal? row_vec (v0) ) ) (equal? agg.result (v7) ) ))]
[v0 (choose (list-list-ref-noerr (v1) (v3) ) (v4))]
[v1 (choose (list-list-col-slice-noerr (list-list-slice-noerr (v2) (v3) (v3) ) (v3) (v3) ) (matrix-transpose-noerr (list-list-col-slice-noerr (list-list-slice-noerr (v2) (v3) (v3) ) (v3) (v3) ) ))]
[v2 (choose base active)]
[v3 (choose 0 (list-list-length base ) (length (list-list-ref-noerr base 0 ) ) row col 0 1)]
[v4 (choose (v5) (vec_elemwise_add (list-list-ref-noerr (v1) (v3) ) (list-list-ref-noerr (v1) (v3) )) (vec_elemwise_sub (list-list-ref-noerr (v1) (v3) ) (list-list-ref-noerr (v1) (v3) )) (vec_elemwise_mul (list-list-ref-noerr (v1) (v3) ) (list-list-ref-noerr (v1) (v3) )) (vec_elemwise_div (list-list-ref-noerr (v1) (v3) ) (list-list-ref-noerr (v1) (v3) )) (vec_scalar_add (v6) (list-list-ref-noerr (v1) (v3) )) (vec_scalar_sub (v6) (list-list-ref-noerr (v1) (v3) )) (vec_scalar_mul (v6) (list-list-ref-noerr (v1) (v3) )) (vec_scalar_div (v6) (list-list-ref-noerr (v1) (v3) )) (scalar_vec_sub (v6) (list-list-ref-noerr (v1) (v3) )) (scalar_vec_div (v6) (list-list-ref-noerr (v1) (v3) )) (matrix_vec_mul (v1) (list-list-ref-noerr (v1) (v3) ) ))]
[v5 (choose (vec_map (list-list-ref-noerr (v1) (v3) ) map_int_to_int))]
[v6 (choose 0 1)]
[v7 (choose (v1) (v8))]
[v8 (choose (matrix_elemwise_add (v1) (v1) ) (matrix_elemwise_sub (v1) (v1) ) (matrix_elemwise_mul (v1) (v1) ) (matrix_elemwise_div (v1) (v1) ) (matrix_scalar_add (v6) (v1) ) (matrix_scalar_sub (v6) (v1) ) (matrix_scalar_mul (v6) (v1) ) (matrix_scalar_div (v6) (v1) ) (scalar_matrix_sub (v6) (v1)) (scalar_matrix_div (v6) (v1)))]
)
