...
[v4 (choose 32)]
[v5 (choose (matrix_elemwise_add (v3) (v1) ) (matrix_elemwise_sub (v3) (v1) ) (matrix_elemwise_mul (v3) (v1) ) (matrix_elemwise_div (v3) (v1) ) (matrix_scalar_add (v4) (v3) ) (matrix_scalar_sub (v4) (v3) ) (matrix_scalar_mul (v4) (v3) ) (matrix_scalar_div (v4) (v3) ) (scalar_matrix_sub (v4) (v3)) (scalar_matrix_div (v4) (v3)) (matrix_elemwise_sub (v1) (v3) ) (matrix_elemwise_div (v1) (v3) ) (matrix_elemwise_add (v3) (v3) ) (matrix_elemwise_sub (v3) (v3) ) (matrix_elemwise_mul (v3) (v3) ) (matrix_elemwise_div (v3) (v3) ))]
[v6 (choose (matrix_elemwise_add (v5) (v1) ) (matrix_elemwise_sub (v5) (v1) ) (matrix_elemwise_mul (v5) (v1) ) (matrix_elemwise_div (v5) (v1) ) (matrix_scalar_add (v4) (v5) ) (matrix_scalar_sub (v4) (v5) ) (matrix_scalar_mul (v4) (v5) ) (matrix_scalar_div (v4) (v5) ) (scalar_matrix_sub (v4) (v5)) (scalar_matrix_div (v4) (v5)) (matrix_elemwise_sub (v1) (v5) ) (matrix_elemwise_div (v1) (v5) ) (matrix_elemwise_add (v5) (v3) ) (matrix_elemwise_sub (v5) (v3) ) (matrix_elemwise_mul (v5) (v3) ) (matrix_elemwise_div (v5) (v3) ) (matrix_elemwise_sub (v3) (v5) ) (matrix_elemwise_div (v3) (v5) ) (matrix_elemwise_add (v5) (v5) ) (matrix_elemwise_sub (v5) (v5) ) (matrix_elemwise_mul (v5) (v5) ) (matrix_elemwise_div (v5) (v5) ))]
)

(define-grammar (screen_blend_8_inv1_gram active base col pixel row_vec agg.result row)
 [rv (choose (&& (&& (&& (&& (&& (>= row 0 ) (<= row (list-list-length base ) ) ) (>= col 0 ) ) (<= col (length (list-list-ref-noerr base 0 ) ) ) ) (equal? row_vec (v0) ) ) (equal? agg.result (v6) ) ))]
[v0 (choose (if (OUTER_LOOP_INDEX_FIRST) (list-take-noerr (list-list-ref-noerr (v1) row ) col ) (list-list-ref-noerr (matrix-transpose-noerr (list-list-col-slice-with-length-noerr (list-list-take-noerr (v1) col ) row 1 ) ) 0 ) ) (v2) (v4) (v5))]
