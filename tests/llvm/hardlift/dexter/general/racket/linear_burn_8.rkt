...
(define-grammar (linear_burn_8_inv1_gram active base col pixel row_vec agg.result row)
 [rv (choose (&& (&& (&& (&& (&& (>= row 0 ) (<= row (list-list-length base ) ) ) (>= col 0 ) ) (<= col (length (list-list-ref-noerr base 0 ) ) ) ) (equal? row_vec (v0) ) ) (equal? agg.result (v5) ) ))]
[v0 (choose (if (OUTER_LOOP_INDEX_FIRST) (list-take-noerr (list-list-ref-noerr (v1) row ) col ) (list-list-ref-noerr (matrix-transpose-noerr (list-list-col-slice-with-length-noerr (list-list-take-noerr (v1) col ) row 1 ) ) 0 ) ) (v2) (v4))]
...
[v5 (choose (v6) (v7) (v8))]
[v6 (choose (if (OUTER_LOOP_INDEX_FIRST) (list-list-take-noerr (v1) row ) (list-list-col-slice-noerr (v1) 0 row ) ) (matrix-transpose-noerr (if (OUTER_LOOP_INDEX_FIRST) (list-list-take-noerr (v1) row ) (list-list-col-slice-noerr (v1) 0 row ) ) ))]
[v7 (choose (matrix_elemwise_add (v6) (v6) ) (matrix_elemwise_sub (v6) (v6) ) (matrix_elemwise_mul (v6) (v6) ) (matrix_elemwise_div (v6) (v6) ) (matrix_scalar_add (v3) (v6) ) (matrix_scalar_sub (v3) (v6) ) (matrix_scalar_mul (v3) (v6) ) (matrix_scalar_div (v3) (v6) ) (scalar_matrix_sub (v3) (v6)) (scalar_matrix_div (v3) (v6)))]
[v8 (choose (matrix_elemwise_add (v7) (v6) ) (matrix_elemwise_sub (v7) (v6) ) (matrix_elemwise_mul (v7) (v6) ) (matrix_elemwise_div (v7) (v6) ) (matrix_scalar_add (v3) (v7) ) (matrix_scalar_sub (v3) (v7) ) (matrix_scalar_mul (v3) (v7) ) (matrix_scalar_div (v3) (v7) ) (scalar_matrix_sub (v3) (v7)) (scalar_matrix_div (v3) (v7)) (matrix_elemwise_sub (v6) (v7) ) (matrix_elemwise_div (v6) (v7) ) (matrix_elemwise_add (v7) (v7) ) (matrix_elemwise_sub (v7) (v7) ) (matrix_elemwise_mul (v7) (v7) ) (matrix_elemwise_div (v7) (v7) ))]
)
