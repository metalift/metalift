...
(define-grammar (linear_dodge_8_inv0_gram active agg.result base col pixel row row_vec)
                ...
                [v4 (choose (v5) (nested_list_elemwise_add (v5) (v5)))]
                [v5
                 (choose base
...
(define-grammar (linear_dodge_8_inv1_gram active base col pixel row_vec agg.result row)
                [rv
                 (choose (&& (&& (&& (&& (&& (v0) (v2)) (v4)) (v5)) (equal? row_vec (v6)))
                             (equal? agg.result (v8))))]
                [v0 (choose (>= row (v1)) (> row (v1)))]
                [v1 (choose 0 1)]
                [v2 (choose (< row (v3)) (<= row (v3)))]
                ...
                [v6 (choose (v7) (vec_elemwise_add (v7) (v7)))]
                [v7
                 (choose (list-take-noerr (list-list-ref-noerr base 0) col)
                         ...
                         row_vec)]
                [v8 (choose (v9) (nested_list_elemwise_add (v9) (v9)))]
                [v9
                 (choose base
                         (list-take-noerr base row)
                         (list-take-noerr base col)
...
(define-grammar (linear_dodge_8_ps_gram base active linear_dodge_8_rv)
                ...
                [v0 (choose (v1) (nested_list_elemwise_add (v1) (v1)))]
                [v1 (choose base active)])

(define (linear_dodge_8_inv0 active agg.result base col pixel row row_vec)
  (linear_dodge_8_inv0_gram active agg.result base col pixel row row_vec #:depth 10))
(define (linear_dodge_8_inv1 active base col pixel row_vec agg.result row)
  (linear_dodge_8_inv1_gram active base col pixel row_vec agg.result row #:depth 10))
(define (linear_dodge_8_ps base active linear_dodge_8_rv)
  (linear_dodge_8_ps_gram base active linear_dodge_8_rv #:depth 10))
...
(define linear_dodge_8_rv
  (take (list linear_dodge_8_rv_BOUNDEDSET-0 linear_dodge_8_rv_BOUNDEDSET-1)
        linear_dodge_8_rv_BOUNDEDSET-len))
...
(current-bitwidth 6)
(define (assertions)
  (assert (&& (&& (&& (&& (=> (&& (&& (> (length base) 1) (equal? (length base) (length active)))
                                  (equal? (length (list-list-ref-noerr base 0))
                                          (length (list-list-ref-noerr active 0))))
                              (linear_dodge_8_inv0 active (list-empty) base 0 0 0 (list-empty)))
                          (=> (&& (&& (&& (&& (< row (length base)) (> (length base) 1))
                                          (equal? (length base) (length active)))
                                      (equal? (length (list-list-ref-noerr base 0))
                                              (length (list-list-ref-noerr active 0))))
                                  (linear_dodge_8_inv0 active agg.result base col pixel row row_vec))
                              (linear_dodge_8_inv1 active base 0 pixel (list-empty) agg.result row)))
                      (=> (&& (&& (&& (&& (&& (&& (< col (length (list-list-ref-noerr base 0)))
                                      ...
                                      (equal? (length (list-list-ref-noerr base 0))
                                              (length (list-list-ref-noerr active 0))))
                                  (linear_dodge_8_inv0 active agg.result base col pixel row row_vec))
                              (linear_dodge_8_inv1 active base col pixel row_vec agg.result row))
                          (linear_dodge_8_inv1
                           active
                           base
                           (+ col 1)
                           ...
                           (list-list-append row_vec
                                             (+ (list-ref-noerr (list-list-ref-noerr base row) col)
                                                (list-ref-noerr (list-list-ref-noerr active row)
                                                                col)))
                           agg.result
                           row)))
                  (=> (&& (&& (&& (&& (&& (&& (! (< col (length (list-list-ref-noerr base 0))))
              ...
              (=> (or (&& (&& (&& (&& (! (< row (length base))) (> (length base) 1))
                      ...
                      (&& (&& (&& (&& (&& (! true) (! (< row (length base)))) (> (length base) 1))
                              ...
                              (equal? (length (list-list-ref-noerr base 0))
                                      (length (list-list-ref-noerr active 0))))
                          (linear_dodge_8_inv0 active agg.result base col pixel row row_vec)))
                  (linear_dodge_8_ps base active agg.result)))))
...
(define sol
  (synthesize #:forall (list active_BOUNDEDSET-len
                             ...
                             col
                             linear_dodge_8_rv_BOUNDEDSET-len
                             linear_dodge_8_rv_BOUNDEDSET-0
                             linear_dodge_8_rv_BOUNDEDSET-1
                             pixel
                             row
