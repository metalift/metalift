...
define i32 @uninterp(i32 %i, i32 %j) #0 {
entry:
...
entry:
  ...
  %call = call i32 @uninterp(i32 %i1, i32 %i2)
  %i3 = load i32, i32* %j.addr, align 4
  %i4 = load i32, i32* %j.addr, align 4
  %call1 = call i32 @uninterp(i32 %i3, i32 %i4)
