; ModuleID = 'uninterp.ll'
source_filename = "uninterp.c"
target datalayout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-apple-macosx11.0.0"

; Function Attrs: noinline nounwind optnone ssp uwtable
define i32 @uninterp(i32 %arg, i32 %arg1) #0 {
bb:
...
bb:
  ...
  %i5 = call i32 @uninterp(i32 %i3, i32 %i4)
  %i6 = load i32, i32* %i2, align 4
  %i7 = load i32, i32* %i2, align 4
  %i8 = call i32 @uninterp(i32 %i6, i32 %i7)
  %i9 = add nsw i32 %i5, %i8
  ret i32 %i9
}
