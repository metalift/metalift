...
(define-grammar (screen_blend_8_ps_gram base active screen_blend_8_rv)
 [rv (choose (equal? screen_blend_8_rv (nested_selection_two_args (v0) (v0) select_two_args) ))]
