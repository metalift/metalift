...
(define-fun-rec test_ps ((i Int) (j Int) (test_rv Int)) Bool
(= test_rv (+ (uninterp i i) (uninterp j j))))

(declare-const test_rv Int)
...
(assert (not (test_ps i j (+ (uninterp i i) (uninterp j j)))))
