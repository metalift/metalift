; ModuleID = 'gaudi/silu.ll'
source_filename = "gaudi/silu.cc"
...
define i32 @_Z9test_sqrti(i32 %x) #0 {
entry:
...
define void @_Z4siluNSt3__16vectorIiNS_9allocatorIiEEEEi(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %input, i32 %hidden_dim) #1 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 @_Z9test_sqrti(i32 %i5)
  br label %invoke.cont

invoke.cont:                                      ; preds = %for.body
  %add = add nsw i32 1, %call1
  %div = sdiv i32 1, %add
  store i32 %div, i32* %cons, align 4
  %i6 = load i32, i32* %cons, align 4
  %i7 = load i32, i32* %i, align 4
  %conv2 = sext i32 %i7 to i64
  %call3 = call nonnull align 4 dereferenceable(4) i32* @_ZNSt3__16vectorIiNS_9allocatorIiEEEixEm(%"class.std::__1::vector"* %input, i64 %conv2) #11
  %i8 = load i32, i32* %call3, align 4
  %mul = mul nsw i32 %i6, %i8
