...
g++ $FLAG $INCLUDE  utils.cc overlay_blend_8.cc $LINK -o overlay_blend_8_O2
./overlay_blend_8_O2

g++ $FLAG $INCLUDE utils.cc normal_blend_8.cc $LINK -o normal_blend_8_O2
./normal_blend_8_O2

g++ $FLAG $INCLUDE utils.cc normal_blend_f.cc $LINK -o normal_blend_f_O2
./normal_blend_f_O2
