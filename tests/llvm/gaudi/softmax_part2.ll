; ModuleID = 'gaudi/softmax_part2.ll'
source_filename = "gaudi/softmax_part2.cc"
...
define i32 @_Z12uninterp_expi(i32 %x) #0 {
entry:
...
define void @_Z13softmax_part2NSt3__16vectorIiNS_9allocatorIiEEEEii(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %input, i32 %max_pos, i32 %max_val) #1 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %call1 = call i32 @_Z12uninterp_expi(i32 %sub)
