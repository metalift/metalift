; ModuleID = 'gaudi/color_dodge_8.ll'
source_filename = "gaudi/color_dodge_8.cc"
...
define void @_Z13color_dodge_8NSt3__16vectorINS0_IiNS_9allocatorIiEEEENS1_IS3_EEEES5_(%"class.std::__1::vector"* noalias sret align 8 %agg.result, %"class.std::__1::vector"* %base, %"class.std::__1::vector"* %active) #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
entry:
...
for.body6:                                        ; preds = %for.cond4
  ...
  %cmp11 = icmp eq i32 %i7, 255
  br i1 %cmp11, label %if.then, label %if.else

if.then:                                          ; preds = %for.body6
  store i32 255, i32* %pixel, align 4
  br label %if.end
