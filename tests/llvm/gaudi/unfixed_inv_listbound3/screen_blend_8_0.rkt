...
[v4 (choose (v5) (nested_list_scalar_add (v8) (v5)) (nested_list_elemwise_add (v5) (v5)) (nested_list_scalar_sub (v8) (v5)) (nested_list_elemwise_sub (v5) (v5)) (nested_list_scalar_mul (v8) (v5)) (nested_list_elemwise_mul (v5) (v5)) (nested_list_scalar_div (v8) (v5)) (nested_list_elemwise_div (v5) (v5)))]
[v5 (choose (v6) (nested_list_scalar_add (v8) (v6)) (nested_list_elemwise_add (v6) (v6)) (nested_list_scalar_sub (v8) (v6)) (nested_list_elemwise_sub (v6) (v6)) (nested_list_scalar_mul (v8) (v6)) (nested_list_elemwise_mul (v6) (v6)) (nested_list_scalar_div (v8) (v6)) (nested_list_elemwise_div (v6) (v6)))]
[v6 (choose (v7) (nested_list_scalar_add (v8) (v7)) (nested_list_elemwise_add (v7) (v7)) (nested_list_scalar_sub (v8) (v7)) (nested_list_elemwise_sub (v7) (v7)) (nested_list_scalar_mul (v8) (v7)) (nested_list_elemwise_mul (v7) (v7)) (nested_list_scalar_div (v8) (v7)) (nested_list_elemwise_div (v7) (v7)))]
...
(define-grammar (screen_blend_8_inv1_gram active base col pixel row_vec agg.result row)
 [rv (choose (&& (&& (&& (&& (&& (v0) (v2) ) (v4) ) (v5) ) (equal? row_vec (v6) ) ) (equal? agg.result (v11) ) ))]
[v0 (choose (>= row (v1) ) (> row (v1) ) (equal? row (v1) ) (< row (v1) ) (<= row (v1) ))]
[v1 (choose 0 1)]
[v2 (choose (>= row (v3) ) (> row (v3) ) (equal? row (v3) ) (< row (v3) ) (<= row (v3) ))]
[v3 (choose (length base ) (length (list-list-ref-noerr base 0 ) ))]
...
[v6 (choose (v7) (vec_scalar_add (v10) (v7)) (vec_elemwise_add (v7) (v7)) (vec_scalar_sub (v10) (v7)) (vec_elemwise_sub (v7) (v7)) (vec_scalar_mul (v10) (v7)) (vec_elemwise_mul (v7) (v7)) (vec_scalar_div (v10) (v7)) (vec_elemwise_div (v7) (v7)))]
[v7 (choose (v8) (vec_scalar_add (v10) (v8)) (vec_elemwise_add (v8) (v8)) (vec_scalar_sub (v10) (v8)) (vec_elemwise_sub (v8) (v8)) (vec_scalar_mul (v10) (v8)) (vec_elemwise_mul (v8) (v8)) (vec_scalar_div (v10) (v8)) (vec_elemwise_div (v8) (v8)))]
[v8 (choose (v9) (vec_scalar_add (v10) (v9)) (vec_elemwise_add (v9) (v9)) (vec_scalar_sub (v10) (v9)) (vec_elemwise_sub (v9) (v9)) (vec_scalar_mul (v10) (v9)) (vec_elemwise_mul (v9) (v9)) (vec_scalar_div (v10) (v9)) (vec_elemwise_div (v9) (v9)))]
[v9 (choose (list-take-noerr (list-list-ref-noerr base 0 ) col ) (list-take-noerr (list-list-ref-noerr base row ) col ) (list-take-noerr (list-list-ref-noerr base col ) row ) (list-take-noerr (list-list-ref-noerr base 0 ) row ) (list-take-noerr (list-list-ref-noerr active 0 ) col ) (list-take-noerr (list-list-ref-noerr active row ) col ) (list-take-noerr (list-list-ref-noerr active col ) row ) (list-take-noerr (list-list-ref-noerr active 0 ) row ) row_vec)]
[v10 (choose 0 2 128 255)]
[v11 (choose (v12) (nested_list_scalar_add (v10) (v12)) (nested_list_elemwise_add (v12) (v12)) (nested_list_scalar_sub (v10) (v12)) (nested_list_elemwise_sub (v12) (v12)) (nested_list_scalar_mul (v10) (v12)) (nested_list_elemwise_mul (v12) (v12)) (nested_list_scalar_div (v10) (v12)) (nested_list_elemwise_div (v12) (v12)))]
[v12 (choose (v13) (nested_list_scalar_add (v10) (v13)) (nested_list_elemwise_add (v13) (v13)) (nested_list_scalar_sub (v10) (v13)) (nested_list_elemwise_sub (v13) (v13)) (nested_list_scalar_mul (v10) (v13)) (nested_list_elemwise_mul (v13) (v13)) (nested_list_scalar_div (v10) (v13)) (nested_list_elemwise_div (v13) (v13)))]
[v13 (choose (v14) (nested_list_scalar_add (v10) (v14)) (nested_list_elemwise_add (v14) (v14)) (nested_list_scalar_sub (v10) (v14)) (nested_list_elemwise_sub (v14) (v14)) (nested_list_scalar_mul (v10) (v14)) (nested_list_elemwise_mul (v14) (v14)) (nested_list_scalar_div (v10) (v14)) (nested_list_elemwise_div (v14) (v14)))]
[v14 (choose base (list-take-noerr base row ) (list-take-noerr base col ) active (list-take-noerr active row ) (list-take-noerr active col ))]
) 

(define-grammar (screen_blend_8_ps_gram base active screen_blend_8_rv)
 [rv (choose (equal? screen_blend_8_rv (v0) ))]
[v0 (choose (v1) (nested_list_scalar_add (v4) (v1)) (nested_list_elemwise_add (v1) (v1)) (nested_list_scalar_sub (v4) (v1)) (nested_list_elemwise_sub (v1) (v1)) (nested_list_scalar_mul (v4) (v1)) (nested_list_elemwise_mul (v1) (v1)) (nested_list_scalar_div (v4) (v1)) (nested_list_elemwise_div (v1) (v1)))]
[v1 (choose (v2) (nested_list_scalar_add (v4) (v2)) (nested_list_elemwise_add (v2) (v2)) (nested_list_scalar_sub (v4) (v2)) (nested_list_elemwise_sub (v2) (v2)) (nested_list_scalar_mul (v4) (v2)) (nested_list_elemwise_mul (v2) (v2)) (nested_list_scalar_div (v4) (v2)) (nested_list_elemwise_div (v2) (v2)))]
[v2 (choose (v3) (nested_list_scalar_add (v4) (v3)) (nested_list_elemwise_add (v3) (v3)) (nested_list_scalar_sub (v4) (v3)) (nested_list_elemwise_sub (v3) (v3)) (nested_list_scalar_mul (v4) (v3)) (nested_list_elemwise_mul (v3) (v3)) (nested_list_scalar_div (v4) (v3)) (nested_list_elemwise_div (v3) (v3)))]
[v3 (choose base active)]
[v4 (choose 0 2 128 255)]
) 
