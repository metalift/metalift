...
if __name__ == "__main__":
    ...
    # )
    fixed_inv0_grammar = get_nested_list_computation_with_counts_inv0_grammar(
        fixed_grammar=True,
        fixed_out_fn=nested_list_screen8x8_body
    )
    unfixed_inv0_grammar = get_nested_list_computation_with_counts_inv0_grammar(
        fixed_grammar=False,
        constants=[Int(32)],
        ordered_compute_ops=ordered_compute_ops,
        depth=3
    )
    fixed_inv1_grammar = get_nested_list_computation_with_counts_inv1_grammar(
        fixed_grammar=True,
        fixed_row_vec_fn=vec_screen8x8_body,
        fixed_out_fn=nested_list_screen8x8_body
    )
    unfixed_inv1_grammar = get_nested_list_computation_with_counts_inv1_grammar(
        fixed_grammar=False,
        constants=[Int(32)],
        ordered_compute_ops=ordered_compute_ops,
        depth=3
    ...
    screen_blend_8 = driver.analyze(
        ...
        inv_grammars={
            "screen_blend_8_inv0": unfixed_inv0_grammar,
            "screen_blend_8_inv1": unfixed_inv1_grammar
        },
