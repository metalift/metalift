...
(declare-fun test_exp (Int) Int)

(define-fun-rec map_test_exp ((x (MLList Int))) (MLList Int)
(ite (< (list_length x) 1) list_empty (list_prepend (test_exp (list_get x 0)) (map_test_exp (list_tail x 1)))))


(define-fun-rec softmax_part2_inv0 ((agg.result (MLList Int)) (cur Int) (i Int) (input (MLList Int)) (max_pos Int) (max_val Int)) Bool
(and (and (>= i 0) (<= i max_pos)) (= agg.result (map_test_exp (vec_scalar_div (- 0 max_val) (list_take input i))))))



(define-fun-rec softmax_part2_ps ((input (MLList Int)) (max_pos Int) (max_val Int) (softmax_part2_rv (MLList Int))) Bool
(= softmax_part2_rv (map_test_exp (vec_scalar_mul (- 0 max_val) (list_take input max_pos)))))
