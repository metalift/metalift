; ModuleID = 'ConditionalCount.ll'
source_filename = "ConditionalCount.cc"
...
define i32 @_Z4testP4listIiE(%struct.list* %data) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  %i3 = load %struct.list*, %struct.list** %data.addr, align 8
  %i4 = load i32, i32* %i, align 4
  %call1 = call i32 @_Z7listGetIiET_P4listIS0_Ei(%struct.list* %i3, i32 %i4)
  store i32 %call1, i32* %var, align 4
  %i5 = load i32, i32* %var, align 4
  %cmp2 = icmp slt i32 %i5, 100
  br i1 %cmp2, label %if.then, label %if.end

if.then:                                          ; preds = %for.body
  %i6 = load i32, i32* %count, align 4
  %inc = add i32 %i6, 1
