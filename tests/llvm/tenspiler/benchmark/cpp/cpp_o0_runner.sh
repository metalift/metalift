...
g++ $FLAG $INCLUDE  utils.cc overlay_blend_8.cc $LINK -o overlay_blend_8_O0
./overlay_blend_8_O0

g++ $FLAG $INCLUDE utils.cc normal_blend_8.cc $LINK -o normal_blend_8_O0
./normal_blend_8_O0

g++ $FLAG $INCLUDE utils.cc normal_blend_f.cc $LINK -o normal_blend_f_O0
./normal_blend_f_O0
