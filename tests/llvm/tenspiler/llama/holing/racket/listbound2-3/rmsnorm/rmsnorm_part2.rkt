...
(define-grammar (rmsnorm_part2_inv0_gram agg.result i input ref.tmp ss weight)
 [rv (choose (&& (&& (>= i 0 ) (<= i (length input ) ) ) (equal? agg.result (vec_scalar_mul (quotient-noerr (v0) (integer-sqrt (+ (quotient-noerr (v1) (v1) ) (v0) ) ) ) (vec_elemwise_mul (v2) (v2))) ) ))]
[v0 (choose 1)]
...
(define-grammar (rmsnorm_part2_ps_gram input weight ss rmsnorm_part2_rv)
 [rv (choose (equal? rmsnorm_part2_rv (vec_scalar_mul (quotient-noerr (v0) (integer-sqrt (+ (quotient-noerr (v1) (v1) ) (v0) ) ) ) (vec_elemwise_mul (v2) (v2))) ))]
[v0 (choose 1)]
[v1 (choose ss (length input ))]
