...
from tests.llvm.tenspiler.llama.holing.driver.transformer.utils import (
...
if __name__ == "__main__":
    ...
    transformer_part1 = driver.analyze(
        llvm_filepath="tests/llvm/tenspiler/llama/cpp/transformer/transformer_part1.ll",
        loops_filepath="tests/llvm/tenspiler/llama/cpp/transformer/transformer_part1.loops",
