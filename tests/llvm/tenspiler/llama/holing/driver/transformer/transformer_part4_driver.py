...
from tests.llvm.tenspiler.codegen.pytorch_codegen import pytorch_codegen
from tests.llvm.tenspiler.tenspiler_common import call_vec_elemwise_mul, vec_elemwise_mul
...
if __name__ == "__main__":
    ...
    transformer_part4 = driver.analyze(
        llvm_filepath="tests/llvm/tenspiler/llama/cpp/transformer/transformer_part4.ll",
        loops_filepath="tests/llvm/tenspiler/llama/cpp/transformer/transformer_part4.loops",
