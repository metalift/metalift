...
if __name__ == "__main__":
    ...
    transformer_part3 = driver.analyze(
        llvm_filepath="tests/llvm/tenspiler/llama/cpp/transformer/transformer_part3.ll",
        loops_filepath="tests/llvm/tenspiler/llama/cpp/transformer/transformer_part3.loops",
