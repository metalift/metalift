...
from tests.llvm.tenspiler.axioms import vec_elemwise_mul_axiom, vec_scalar_mul_axiom
...
if __name__ == "__main__":
    ...
    rmsnorm_part2 = driver.analyze(
        llvm_filepath="tests/llvm/tenspiler/rmsnorm_part2.ll",
        loops_filepath="tests/llvm/tenspiler/rmsnorm_part2.loops",
