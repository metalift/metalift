...
(define-grammar (overlay_blend_8_ps_gram base active overlay_blend_8_rv)
 [rv (choose (equal? overlay_blend_8_rv (matrix_selection_two_args (list-list-col-slice-noerr (list-list-slice-noerr (v0) (v2) (v2) ) (v2) (v2) ) (list-list-col-slice-noerr (list-list-slice-noerr (v0) (v2) (v2) ) (v2) (v2) ) select_two_args ) ))]
...
(define-symbolic overlay_blend_8_rv_BOUNDEDSET-4 integer?)
(define overlay_blend_8_rv (take (list overlay_blend_8_rv_BOUNDEDSET-0 overlay_blend_8_rv_BOUNDEDSET-1 overlay_blend_8_rv_BOUNDEDSET-2 overlay_blend_8_rv_BOUNDEDSET-3 overlay_blend_8_rv_BOUNDEDSET-4) overlay_blend_8_rv_BOUNDEDSET-len))
