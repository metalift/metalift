...
(and (and (>= row 0) (<= row (list_list_length base))) (= agg.result (matrix_elemwise_add (ite OUTER_LOOP_INDEX_FIRST (list_list_take base row) (list_list_col_slice base 0 row)) (ite OUTER_LOOP_INDEX_FIRST (list_list_take active row) (list_list_col_slice base 0 row))))))
...
(assert (not (and (and (and (and (=> (and (and (> (list_list_length base) 1) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (linear_dodge_8_inv0 active list_list_empty base 0 0 0 list_empty)) (=> (and (and (and (and (< row (list_list_length base)) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (linear_dodge_8_inv0 active agg.result base col pixel row row_vec)) (linear_dodge_8_inv1 active base 0 pixel list_empty agg.result row))) (=> (and (and (and (and (and (and (< col (list_length (list_list_get base 0))) (< row (list_list_length base))) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (linear_dodge_8_inv0 active agg.result base col pixel row row_vec)) (linear_dodge_8_inv1 active base col pixel row_vec agg.result row)) (linear_dodge_8_inv1 active base (+ col 1) (+ (list_get (list_list_get base row) col) (list_get (list_list_get active row) col)) (list_append row_vec (+ (list_get (list_list_get base row) col) (list_get (list_list_get active row) col))) agg.result row))) (=> (and (and (and (and (and (and (not (< col (list_length (list_list_get base 0)))) (< row (list_list_length base))) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (linear_dodge_8_inv0 active agg.result base col pixel row row_vec)) (linear_dodge_8_inv1 active base col pixel row_vec agg.result row)) (linear_dodge_8_inv0 active (list_list_append agg.result row_vec) base col pixel (+ row 1) row_vec))) (=> (or (and (and (and (and (not (< row (list_list_length base))) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (linear_dodge_8_inv0 active agg.result base col pixel row row_vec)) (and (and (and (and (and (not true) (not (< row (list_list_length base)))) (> (list_list_length base) 1)) (= (list_list_length base) (list_list_length active))) (= (list_length (list_list_get base 0)) (list_length (list_list_get active 0)))) (linear_dodge_8_inv0 active agg.result base col pixel row row_vec))) (linear_dodge_8_ps base active agg.result)))))
