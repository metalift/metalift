...
from metalift.utils.tenspiler.tenspiler_common import call_reduce_sum, reduce_sum
from metalift.vc_util import and_objects
from tests.llvm.tenspiler.axioms import reduce_sum_axiom
...
if __name__ == "__main__":
    ...
    softmax_part3 = driver.analyze(
        llvm_filepath="tests/llvm/tenspiler/softmax_part3.ll",
        loops_filepath="tests/llvm/tenspiler/softmax_part3.loops",
