...
(define-fun-rec my_add ((x Int) (y Int)) Int
(+ x y))
(define-fun-rec test ((i8 Int) (arg Int) (arg1 Int)) Bool
(= tmp18 (my_add arg arg1)))
...
(assert (not (=> (and (= test_bb (=> (and (and (= test_i4 test_arg) (= test_i6 test_arg) (= test_i5 test_arg1) (= test_i7 test_arg1)) (and true true true)) (test (+ test_arg test_arg1) test_arg test_arg1)))) test_bb)))
